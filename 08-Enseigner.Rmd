...
La documentation sur le site de RStudio[^801] est très claire et ne sera pas reprise ici: nous verrons seulement comment commencer et comment diffuser des tutoriels **rlearnr**.
...
Quand les étudiants rendront leur travail, tous les dépôts de toutes les tâches seront stockés dans l'organisation: le préfixage de leur nom est le meilleur moyen de les retrouver.
...
Ne pas donner de droit d'administration.
...
Ils pourront ensuite créer un nouveau projet RStudio à partir du dépôt GitHub créé sur leur compte automatiquement par GitHub Classrooms, modifier ce projet selon les consignes de travail et le pousser sur GitHub.
