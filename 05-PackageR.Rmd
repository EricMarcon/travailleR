...
```
- dans `DESCRIPTION`, **Rcpp** et **RcppParallel** si du code parallélisé est utilisé (supprimer ses références sinon) doivent être importés et déclarés dans `LinkingTo`:
```
