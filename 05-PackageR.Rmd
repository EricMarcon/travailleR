...
La bonne pratique est de ne rien importer (au sens de **roxygen2**) et de qualifier systématiquement les fonctions d'autres packages dans le code avec la syntaxe `package::fonction()`.
