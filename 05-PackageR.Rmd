...
Les références utilisées dans les fichiers RMarkdown (vignette, site produit par **pkgdown**) ne sont pas concernées.
...
`key` est la l'identifiant de la référence dans le fichier.
Exemple [^506]: documentation du package **SpatDiv** hébergé sur GitHub, fichier `.R` du package:
```{r}
#' SpatDiv
#'
...
[^506]: Package **SpatDiv** sur GitHub: https://github.com/EricMarcon/SpatDiv/blob/master/R/Project.R
