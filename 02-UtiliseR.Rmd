...
**targets** permet de visualiser les tâches obsolètes, d'intégrer le flux à un projet de document (voir section \@ref(sec:XXX)), et même de faire appel à un cluster de calcul pour traiter les tâches en parallèle.
