...
##  f1(X)  39.910  42.0900  64.53044  44.1990  50.4130
##  f2(X)  48.020  50.1415  75.19901  52.2955  56.9480
##  f3(X) 279.977 282.7765 315.01142 291.6250 311.5070
##  f4(X) 409.979 413.8995 458.30009 426.5905 449.9995
##       max neval
##  1594.557   100
##  1655.001   100
##  1721.901   100
...
##                                    expr   median
## 1                              sqrt(x1)   4.7160
## 2                lapply(x1, FUN = sqrt) 302.8105
## 3                sapply(x1, FUN = sqrt) 361.6725
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 294.6820
\end{verbatim}
...
\begin{verbatim}
##          expr   median
## 1  Boucle(x1) 831.7955
## 2 Boucle2(x1)  78.1120
\end{verbatim}
...
\begin{verbatim}
##                        expr  median
## 1 vapply(x1, FUN = sqrt, 0) 292.033
## 2                Boucle(x1)  78.081
\end{verbatim}
...
\begin{verbatim}
##                                               expr   median
## 1                        vapply(x1, FUN = sqrt, 0)  297.882
## 2 for (i in 1:length(x1)) Racine[i] <- sqrt(x1[i]) 3312.924
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 replicate(1000, runif(1)) 4450.648
## 2               runif(1000)   37.246
\end{verbatim}
...
\begin{verbatim}
##                              expr   median
## 1   BoucleSomme(diamonds[-(2:4)]) 3.846160
## 2 apply(diamonds[-(2:4)], 2, sum) 9.723473
## 3       colSums(diamonds[-(2:4)]) 2.594822
\end{verbatim}
...
##  1.099331 1.152153 1.740581 1.281893 2.192112 12.53682
##  neval
##    100
\end{verbatim}
...
Ce temps est à comparer à celui de la boucle for de référence, multiplié par 2500, soit \texttt{6585} secondes.
...
## Unit: nanoseconds
##                expr  min   lq     mean median     uq
##  triple.integer(2L)  326  336 24031.50  345.0  355.0
##   triple.numeric(2)  326  333 21780.31  344.0  360.5
##          triple(2L) 1321 1342  1497.58 1352.5 1409.5
##      max neval
##  2367610   100
##  2141728   100
##     6751   100
