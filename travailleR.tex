...
##  f1(X)   1.640   2.0090   7.86298   2.3575   6.0270 403.071
##  f2(X)   3.936   4.1820  10.06427   4.8380   7.8105 407.581
##  f3(X)  93.849  98.8305 107.00180 100.2450 103.6480 521.725
##  f4(X) 126.567 130.5645 140.91823 133.4140 136.8170 741.854
##  neval
##    100
##    100
##    100
...
## 3                sapply(x1, FUN = sqrt) 165.7835
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 136.4685
\end{verbatim}
...
\begin{verbatim}
##          expr   median
## 1  Boucle(x1) 328.1435
## 2 Boucle2(x1)  38.7860
\end{verbatim}
...
\begin{verbatim}
##                        expr  median
## 1 vapply(x1, FUN = sqrt, 0) 120.622
## 2                Boucle(x1)  38.704
\end{verbatim}
...
\begin{verbatim}
##                                               expr   median
## 1                        vapply(x1, FUN = sqrt, 0) 124.0865
## 2 for (i in 1:length(x1)) Racine[i] <- sqrt(x1[i]) 960.6710
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 replicate(1000, runif(1)) 657.9065
## 2               runif(1000)   5.5760
\end{verbatim}
...
\begin{verbatim}
##                              expr   median
## 1   BoucleSomme(diamonds[-(2:4)]) 1367.678
## 2 apply(diamonds[-(2:4)], 2, sum) 3051.630
## 3       colSums(diamonds[-(2:4)]) 1057.472
\end{verbatim}
...
##  234.807 244.0115 383.4529 251.658 264.7985 12131.41   100
\end{verbatim}
...
Ce temps est à comparer à celui de la boucle for de référence, multiplié par 2500, soit \texttt{2362} secondes.
...
## ● completed target NbPoints [0.702 seconds]
## ▶ dispatched target X
...
## ✔ skipped target d
## ✔ skipped target map
## ✔ skipped pipeline [0.038 seconds]
\end{verbatim}
...
## Unit: nanoseconds
##                expr min  lq     mean median    uq     max
##  triple.integer(2L) 123 123 30546.23    164 246.0 3031745
##   triple.numeric(2) 123 123 10905.59    164 287.0 1065713
##          triple(2L) 533 574   940.95    697 963.5    8938
##  neval
##    100
##    100
##    100
