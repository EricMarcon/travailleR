...
##  f1(X)  34.339  37.2675  51.31279  38.2320  39.8770 1239.612   100
##  f2(X)  43.395  44.9700  61.05289  45.7770  48.4010 1415.097   100
##  f3(X) 275.151 276.9180 293.82676 278.2520 280.3195 1590.474   100
##  f4(X) 404.453 408.1060 522.61423 409.2695 415.2120 9598.472   100
\end{verbatim}
...
##                                    expr   median
## 1                              sqrt(x1)   4.7530
## 2                lapply(x1, FUN = sqrt) 306.3535
## 3                sapply(x1, FUN = sqrt) 351.2390
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 302.0780
\end{verbatim}
...
\begin{verbatim}
##          expr   median
## 1  Boucle(x1) 773.6880
## 2 Boucle2(x1)  80.5425
\end{verbatim}
...
\begin{verbatim}
##                        expr  median
## 1 vapply(x1, FUN = sqrt, 0) 285.467
## 2                Boucle(x1)  78.258
\end{verbatim}
...
\begin{verbatim}
##                                               expr   median
## 1                        vapply(x1, FUN = sqrt, 0)  289.664
## 2 for (i in 1:length(x1)) Racine[i] <- sqrt(x1[i]) 3108.342
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 replicate(1000, runif(1)) 4154.292
## 2               runif(1000)   35.432
\end{verbatim}
...
\begin{verbatim}
##                              expr   median
## 1   BoucleSomme(diamonds[-(2:4)]) 3.455706
## 2 apply(diamonds[-(2:4)], 2, sum) 8.978746
## 3       colSums(diamonds[-(2:4)]) 2.353454
\end{verbatim}
...
La mise en place de la parallélisation a un coût d'environ \texttt{0.085} secondes ici.
...
## Unit: microseconds
##                                                      expr     min      lq
##  d <- TotalDistance(X$x, X$y)/NbPoints/(NbPoints - 1) * 2 761.263 766.385
##      mean  median       uq     max neval
##  998.6867 802.492 1228.235 2392.29   100
\end{verbatim}
...
Ce temps est à comparer à celui de la boucle for de référence, multiplié par 2500, soit \texttt{4522} secondes.
...
## Unit: nanoseconds
##                expr  min     lq     mean median     uq     max neval
##  triple.integer(2L)  289  308.5   357.07    318  374.0    1167   100
##   triple.numeric(2)  293  308.5 18127.23    319  374.5 1778478   100
##          triple(2L) 1266 1298.0 22624.70   1337 1379.0 2122647   100
\end{verbatim}
