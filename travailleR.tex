...
##  f1(X)  36.478  37.9930  62.33855  39.1500  41.4940
##  f2(X)  44.474  46.2775  77.09898  46.8990  49.3000
##  f3(X) 275.144 277.3015 325.37503 279.3095 284.9035
##  f4(X) 409.195 411.2385 523.86542 416.7510 436.4435
##       max neval
##  2049.489   100
##  2512.489   100
##  2788.715   100
...
##                                    expr   median
## 1                              sqrt(x1)   4.5920
## 2                lapply(x1, FUN = sqrt) 293.0840
## 3                sapply(x1, FUN = sqrt) 348.8230
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 296.6725
\end{verbatim}
...
\begin{verbatim}
##                        expr  median
## 1 vapply(x1, FUN = sqrt, 0) 306.450
## 2                Boucle(x1)  80.844
\end{verbatim}
...
\begin{verbatim}
##                                               expr   median
## 1                        vapply(x1, FUN = sqrt, 0)  294.434
## 2 for (i in 1:length(x1)) Racine[i] <- sqrt(x1[i]) 3184.010
\end{verbatim}
...
\begin{verbatim}
##                        expr    median
## 1 replicate(1000, runif(1)) 3801.8905
## 2               runif(1000)   32.6095
\end{verbatim}
...
\begin{verbatim}
##                              expr   median
## 1   BoucleSomme(diamonds[-(2:4)]) 3.480975
## 2 apply(diamonds[-(2:4)], 2, sum) 8.894807
## 3       colSums(diamonds[-(2:4)]) 2.326875
\end{verbatim}
...
##  2.09416 2.124682 2.504402 2.151012 2.188851 33.69927   100
\end{verbatim}
...
Ce temps est à comparer à celui de la boucle for de référence, multiplié par 2500, soit \texttt{5057} secondes.
...
## Unit: nanoseconds
##                expr  min     lq     mean median     uq
##  triple.integer(2L)  318  328.0 23172.81  338.0  354.5
##   triple.numeric(2)  320  331.5 19120.84  339.0  354.0
##          triple(2L) 1309 1352.5  1568.26 1375.5 1457.0
##      max neval
##  2274354   100
##  1875943   100
##     6597   100
