...
##  f1(X)  27.694  29.1230  40.37280  29.8430  31.6290
##  f2(X)  39.330  40.4895  52.93738  41.4325  43.2135
##  f3(X) 240.007 247.4125 258.78028 248.8560 250.2350
##  f4(X) 302.205 315.2855 329.07654 316.1000 318.2100
##       max neval
##   892.167   100
##   908.486   100
##  1211.403   100
...
##                                    expr   median
## 1                              sqrt(x1)   7.3420
## 2                lapply(x1, FUN = sqrt) 270.6170
## 3                sapply(x1, FUN = sqrt) 316.8565
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 282.7660
\end{verbatim}
...
\begin{verbatim}
##                        expr  median
## 1 vapply(x1, FUN = sqrt, 0) 277.987
## 2                Boucle(x1)  70.636
\end{verbatim}
...
\begin{verbatim}
##                                               expr   median
## 1                        vapply(x1, FUN = sqrt, 0)  284.495
## 2 for (i in 1:length(x1)) Racine[i] <- sqrt(x1[i]) 2403.855
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 replicate(1000, runif(1)) 2916.224
## 2               runif(1000)   17.142
\end{verbatim}
...
\begin{verbatim}
##                              expr    median
## 1   BoucleSomme(diamonds[-(2:4)])  4.918800
## 2 apply(diamonds[-(2:4)], 2, sum) 12.856546
## 3       colSums(diamonds[-(2:4)])  3.651624
\end{verbatim}
...
##  274.909 793.5715 753.5265 801.566 808.9345 1781.534   100
\end{verbatim}
...
Ce temps est à comparer à celui de la boucle for de référence, multiplié par 2500, soit \texttt{4352} secondes.
...
## ● completed target NbPoints [1.435 seconds]
## ▶ dispatched target X
...
## ▶ completed pipeline [1.668 seconds]
\end{verbatim}
...
\begin{verbatim}
## ▶ dispatched target NbPoints
## ● completed target NbPoints [1.424 seconds]
## ▶ dispatched target X
...
## ▶ completed pipeline [1.609 seconds]
\end{verbatim}
...
## Unit: nanoseconds
##                expr  min     lq     mean median     uq
##  triple.integer(2L)  288  299.5 17302.80  306.5  314.5
##   triple.numeric(2)  291  302.0 18347.18  316.0  327.5
##          triple(2L) 1054 1069.0  1179.13 1081.0 1138.5
##      max neval
##  1697772   100
##  1800311   100
##     6693   100
