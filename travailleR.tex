...
##  f1(X)  39.255  41.3320  75.66157  44.6265  49.6265
##  f2(X)  47.485  49.3320 100.57197  53.1265  56.7810
##  f3(X) 280.014 282.2055 345.90176 288.8240 308.1700
##  f4(X) 410.458 413.7840 483.00062 425.6995 462.5455
##       max neval
##  2750.397   100
##  4498.724   100
##  2885.393   100
...
##                                    expr   median
## 1                              sqrt(x1)   4.6640
## 2                lapply(x1, FUN = sqrt) 302.6435
## 3                sapply(x1, FUN = sqrt) 362.0075
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 297.2350
\end{verbatim}
...
\begin{verbatim}
##          expr   median
## 1  Boucle(x1) 876.7095
## 2 Boucle2(x1)  79.9875
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 vapply(x1, FUN = sqrt, 0) 320.8955
## 2                Boucle(x1)  82.0160
\end{verbatim}
...
\begin{verbatim}
##                                               expr   median
## 1                        vapply(x1, FUN = sqrt, 0)  340.200
## 2 for (i in 1:length(x1)) Racine[i] <- sqrt(x1[i]) 4470.038
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 replicate(1000, runif(1)) 4465.820
## 2               runif(1000)   35.531
\end{verbatim}
...
\begin{verbatim}
##                              expr   median
## 1   BoucleSomme(diamonds[-(2:4)]) 3.811208
## 2 apply(diamonds[-(2:4)], 2, sum) 9.666170
## 3       colSums(diamonds[-(2:4)]) 2.577028
\end{verbatim}
...
##  846.745 2086.451 2325.538 2154.215 2283.706 12383.4   100
\end{verbatim}
...
Ce temps est à comparer à celui de la boucle for de référence, multiplié par 2500, soit \texttt{4984} secondes.
...
## Unit: nanoseconds
##                expr  min     lq     mean median     uq
##  triple.integer(2L)  325  334.0 23995.25  343.5  355.5
##   triple.numeric(2)  324  333.5 20989.71  343.0  353.0
##          triple(2L) 1329 1359.0  1491.57 1370.0 1412.0
##      max neval
##  2363180   100
##  2063668   100
##     6324   100
