...
##  f1(X)  40.071  41.3900  56.41962  42.269  44.5775 1310.105
##  f2(X)  47.106  49.3030  66.26494  50.237  52.9030 1401.975
##  f3(X) 279.424 281.3325 302.88923 282.802 287.8030 1668.806
##  f4(X) 410.175 412.4385 434.94212 415.636 421.3430 1891.433
##  neval
##    100
##    100
##    100
...
##                                    expr  median
## 1                              sqrt(x1)   4.625
## 2                lapply(x1, FUN = sqrt) 303.034
## 3                sapply(x1, FUN = sqrt) 362.372
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 310.469
\end{verbatim}
...
\begin{verbatim}
##          expr   median
## 1  Boucle(x1) 789.7770
## 2 Boucle2(x1)  79.1985
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 vapply(x1, FUN = sqrt, 0) 301.1055
## 2                Boucle(x1)  76.1700
\end{verbatim}
...
\begin{verbatim}
##                        expr    median
## 1 replicate(1000, runif(1)) 2743.1375
## 2               runif(1000)   33.2045
\end{verbatim}
...
\begin{verbatim}
##                              expr   median
## 1   BoucleSomme(diamonds[-(2:4)]) 3.599959
## 2 apply(diamonds[-(2:4)], 2, sum) 9.266012
## 3       colSums(diamonds[-(2:4)]) 2.463216
\end{verbatim}
...
La mise en place de la parallélisation a un coût d'environ \texttt{0.015} secondes ici.
...
##  772.344 859.95 1168.127 1109.72 1270.409 2717.324   100
\end{verbatim}
...
Ce temps est à comparer à celui de la boucle for de référence, multiplié par 2500, soit \texttt{5097} secondes.
...
##  triple.integer(2L)  324  335.0 25402.44    342  361.5
##   triple.numeric(2)  320  334.5 19296.02    349  367.0
##          triple(2L) 1309 1347.0  1470.04   1372 1418.0
##      max neval
##  2505084   100
##  1893688   100
##     5804   100
