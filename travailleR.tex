...
##  f1(X)  29.964  31.7415  49.47781  33.4030  44.0875
##  f2(X)  40.358  43.0450  73.88354  44.8755  51.6395
##  f3(X) 241.226 248.6875 359.51512 251.0705 265.3095
##  f4(X) 304.576 317.1210 401.09886 319.5995 331.1430
##       max neval
##   939.765   100
##  1333.244   100
##  6570.242   100
...
##                                    expr   median
## 1                              sqrt(x1)   7.2470
## 2                lapply(x1, FUN = sqrt) 270.9950
## 3                sapply(x1, FUN = sqrt) 313.6065
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 282.8870
\end{verbatim}
...
\begin{verbatim}
##                        expr  median
## 1 vapply(x1, FUN = sqrt, 0) 282.487
## 2                Boucle(x1)  72.155
\end{verbatim}
...
\begin{verbatim}
##                        expr    median
## 1 replicate(1000, runif(1)) 2785.5905
## 2               runif(1000)   16.5055
\end{verbatim}
...
\begin{verbatim}
##                              expr   median
## 1   BoucleSomme(diamonds[-(2:4)]) 3.594725
## 2 apply(diamonds[-(2:4)], 2, sum) 9.185477
## 3       colSums(diamonds[-(2:4)]) 2.676975
\end{verbatim}
...
La mise en place de la parallélisation a un coût d'environ \texttt{0.084} secondes ici.
...
##  277.451 290.5855 381.6905 297.8495 321.3145 2450.62   100
\end{verbatim}
...
Ce temps est à comparer à celui de la boucle for de référence, multiplié par 2500, soit \texttt{4902} secondes.
...
## ● completed target NbPoints [1.716 seconds]
## ▶ dispatched target X
...
## ▶ completed pipeline [1.945 seconds]
\end{verbatim}
...
\begin{verbatim}
## ▶ dispatched target NbPoints
## ● completed target NbPoints [1.488 seconds]
## ▶ dispatched target X
## ● completed target X [0.005 seconds]
## ▶ dispatched target d
...
## ▶ completed pipeline [1.687 seconds]
\end{verbatim}
...
## Unit: nanoseconds
##                expr  min     lq     mean median     uq
##  triple.integer(2L)  289  295.0 14978.74    301  308.5
##   triple.numeric(2)  287  301.5 17208.24    312  330.0
##          triple(2L) 1045 1063.0  1162.26   1081 1150.0
##      max neval
##  1466006   100
##  1687699   100
##     5344   100
