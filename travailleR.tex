...
##  f1(X)  35.983  37.4725  52.99066  38.4170  40.1205
##  f2(X)  43.019  45.0370  62.49133  45.8375  46.6335
##  f3(X) 267.156 275.6600 293.84085 276.5175 282.3880
##  f4(X) 396.500 408.3310 431.91080 409.7650 415.4335
##       max neval
##  1373.599   100
##  1379.972   100
##  1613.861   100
...
##                                    expr   median
## 1                              sqrt(x1)   4.7710
## 2                lapply(x1, FUN = sqrt) 296.3310
## 3                sapply(x1, FUN = sqrt) 353.8260
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 308.0175
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 vapply(x1, FUN = sqrt, 0) 298.8965
## 2                Boucle(x1)  77.8610
\end{verbatim}
...
\begin{verbatim}
##                                               expr   median
## 1                        vapply(x1, FUN = sqrt, 0)  318.291
## 2 for (i in 1:length(x1)) Racine[i] <- sqrt(x1[i]) 3340.180
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 replicate(1000, runif(1)) 4208.158
## 2               runif(1000)   35.765
\end{verbatim}
...
\begin{verbatim}
##                              expr   median
## 1   BoucleSomme(diamonds[-(2:4)]) 3.647553
## 2 apply(diamonds[-(2:4)], 2, sum) 9.385158
## 3       colSums(diamonds[-(2:4)]) 2.476474
\end{verbatim}
...
##  790.828 962.081 1700.421 1061.952 2335.877 4616.921   100
\end{verbatim}
...
Ce temps est à comparer à celui de la boucle for de référence, multiplié par 2500, soit \texttt{4707} secondes.
...
Par exemple, le fichier \texttt{content/authors/admin/\_index.md} qui contient les informations sur le propriétaire du site est remplacé par \texttt{content/en/authors/admin/\_index.md} et \texttt{content/fr/authors/admin/\_index.md} si le site supporte l'Anglais et le Français.
...
## Unit: nanoseconds
##                expr  min     lq     mean median     uq
##  triple.integer(2L)  319  330.0   377.94  342.0  368.0
##   triple.numeric(2)  317  331.0 19102.23  348.5  369.0
##          triple(2L) 1277 1310.5 22741.82 1327.5 1359.5
##      max neval
##     1424   100
##  1874378   100
##  2133840   100
