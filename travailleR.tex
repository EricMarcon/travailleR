...
##  f1(X)  38.106  42.1725 146.41786  44.4255  51.5175
##  f2(X)  46.265  49.3200  79.09809  52.1945  61.8150
##  f3(X) 278.912 281.9645 355.54005 287.3960 317.4960
##  f4(X) 408.769 413.7010 640.15091 421.4590 510.1225
##       max neval
##  7539.660   100
##  1359.920   100
##  2105.475   100
...
##                                    expr   median
## 1                              sqrt(x1)   4.7245
## 2                lapply(x1, FUN = sqrt) 307.7275
## 3                sapply(x1, FUN = sqrt) 373.6390
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 294.3620
\end{verbatim}
...
\begin{verbatim}
##          expr   median
## 1  Boucle(x1) 881.1345
## 2 Boucle2(x1)  81.4545
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 vapply(x1, FUN = sqrt, 0) 289.7695
## 2                Boucle(x1)  80.7265
\end{verbatim}
...
\begin{verbatim}
##                        expr    median
## 1 replicate(1000, runif(1)) 4738.0870
## 2               runif(1000)   24.9655
\end{verbatim}
...
\begin{verbatim}
##                              expr    median
## 1   BoucleSomme(diamonds[-(2:4)])  4.014002
## 2 apply(diamonds[-(2:4)], 2, sum) 12.393483
## 3       colSums(diamonds[-(2:4)])  2.668944
\end{verbatim}
...
La mise en place de la parallélisation a un coût d'environ \texttt{0.075} secondes ici.
...
##  1.251754 1.481165 1.987481 1.591248 2.14267 9.448917   100
\end{verbatim}
...
Ce temps est à comparer à celui de la boucle for de référence, multiplié par 2500, soit \texttt{5667} secondes.
...
## ● completed target NbPoints [4.259 seconds]
## ▶ dispatched target X
## ● completed target X [0.015 seconds]
## ▶ dispatched target d
## ● completed target d [0.026 seconds]
## ▶ dispatched target map
## ● completed target map [0.035 seconds]
## ▶ ended pipeline [6.111 seconds]
\end{verbatim}
...
## ✔ skipped target d
## ✔ skipped target map
## ✔ skipped pipeline [0.576 seconds]
\end{verbatim}
...
\begin{verbatim}
## ▶ dispatched target NbPoints
## ● completed target NbPoints [2.371 seconds]
## ▶ dispatched target X
## ● completed target X [0.003 seconds]
## ▶ dispatched target d
## ● completed target d [0.026 seconds]
## ▶ dispatched target map
## ● completed target map [0.039 seconds]
## ▶ ended pipeline [3.944 seconds]
\end{verbatim}
...
## Unit: nanoseconds
##                expr  min     lq     mean median     uq
##  triple.integer(2L)  353  373.5 28128.47  394.0  409.5
##   triple.numeric(2)  353  374.5 27894.04  397.5  417.5
##          triple(2L) 1418 1441.5  1595.58 1462.5 1602.5
##      max neval
##  2772170   100
##  2747693   100
##     8704   100
