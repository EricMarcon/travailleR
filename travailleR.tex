...
##  f1(X)  36.817  38.802  56.59371  40.1535  43.7935 1316.711
##  f2(X)  44.734  46.467  65.14558  47.8925  50.4395 1561.447
##  f3(X) 276.422 278.309 327.76298 280.1130 292.9330 2508.913
##  f4(X) 410.064 412.127 498.35294 419.4055 442.3450 2573.264
##  neval
##    100
##    100
##    100
...
##                                    expr   median
## 1                              sqrt(x1)   4.8715
## 2                lapply(x1, FUN = sqrt) 302.3885
## 3                sapply(x1, FUN = sqrt) 359.5600
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 301.5520
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 vapply(x1, FUN = sqrt, 0) 290.5815
## 2                Boucle(x1)  77.1140
\end{verbatim}
...
\begin{verbatim}
##                        expr    median
## 1 replicate(1000, runif(1)) 4072.2480
## 2               runif(1000)   35.8245
\end{verbatim}
...
\begin{verbatim}
##                              expr   median
## 1   BoucleSomme(diamonds[-(2:4)]) 3.714660
## 2 apply(diamonds[-(2:4)], 2, sum) 9.716895
## 3       colSums(diamonds[-(2:4)]) 2.576465
\end{verbatim}
...
##  1.097505 2.106375 2.133046 2.13058 2.155784 3.962656   100
\end{verbatim}
...
Ce temps est à comparer à celui de la boucle for de référence, multiplié par 2500, soit \texttt{5719} secondes.
...
##  triple.integer(2L)  325  332.5 26649.73    341  360.5
##   triple.numeric(2)  321  332.0 20386.65    338  367.0
##          triple(2L) 1318 1354.5  1483.18   1367 1427.5
##      max neval
##  2629526   100
##  2002253   100
##     6870   100
