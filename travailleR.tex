...
##  f1(X)  36.164  37.2620  51.21505  38.0945  39.6135 1258.535   100
##  f2(X)  45.734  47.2075  61.03826  47.9460  48.9820 1228.554   100
##  f3(X) 268.531 269.9015 284.17128 271.1620 274.0780 1452.814   100
##  f4(X) 398.923 400.4475 419.04890 401.3930 406.9860 1850.202   100
\end{verbatim}
...
##                                    expr   median
## 1                              sqrt(x1)   4.8030
## 2                lapply(x1, FUN = sqrt) 303.3735
## 3                sapply(x1, FUN = sqrt) 360.6395
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 357.2860
\end{verbatim}
...
\begin{verbatim}
##          expr   median
## 1  Boucle(x1) 777.7790
## 2 Boucle2(x1)  80.1805
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 vapply(x1, FUN = sqrt, 0) 347.7660
## 2                Boucle(x1)  79.9375
\end{verbatim}
...
\begin{verbatim}
##                                               expr   median
## 1                        vapply(x1, FUN = sqrt, 0)  353.560
## 2 for (i in 1:length(x1)) Racine[i] <- sqrt(x1[i]) 3228.936
\end{verbatim}
...
\begin{verbatim}
##                        expr    median
## 1 replicate(1000, runif(1)) 2638.7545
## 2               runif(1000)   32.9665
\end{verbatim}
...
\begin{verbatim}
##                              expr   median
## 1   BoucleSomme(diamonds[-(2:4)]) 3.198307
## 2 apply(diamonds[-(2:4)], 2, sum) 8.007655
## 3       colSums(diamonds[-(2:4)]) 2.514736
\end{verbatim}
...
La mise en place de la parallélisation a un coût de l'ordre du temps de calcul au-delà du quart de seconde attendu: environ \texttt{0.37} secondes ici.
...
## Unit: microseconds
##                                                      expr     min       lq
##  d <- TotalDistance(X$x, X$y)/NbPoints/(NbPoints - 1) * 2 674.709 772.1115
##      mean   median      uq      max neval
##  828.2368 789.6005 830.932 2446.047   100
\end{verbatim}
...
## Unit: nanoseconds
##                expr  min     lq     mean median     uq     max neval
##  triple.integer(2L)  310  327.0 22946.53  332.0  372.5 2258745   100
##   triple.numeric(2)  311  321.0 17946.35  333.5  367.0 1760059   100
##          triple(2L) 1356 1387.5  1531.16 1419.5 1484.0    6423   100
\end{verbatim}
