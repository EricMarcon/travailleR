...
##  f1(X)  35.054  37.2120  52.02792  38.1845  39.9655
##  f2(X)  43.224  45.2815  60.43731  46.7750  50.6150
##  f3(X) 267.283 269.3000 289.45460 275.1830 282.3775
##  f4(X) 396.337 403.1610 428.57909 409.5625 419.3800
##       max neval
##  1248.279   100
##  1183.528   100
##  1409.043   100
...
##                                    expr   median
## 1                              sqrt(x1)   4.5670
## 2                lapply(x1, FUN = sqrt) 287.6315
## 3                sapply(x1, FUN = sqrt) 337.2345
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 298.6150
\end{verbatim}
...
\begin{verbatim}
##          expr   median
## 1  Boucle(x1) 826.3285
## 2 Boucle2(x1)  78.0820
\end{verbatim}
...
\begin{verbatim}
##                        expr  median
## 1 vapply(x1, FUN = sqrt, 0) 291.784
## 2                Boucle(x1)  75.854
\end{verbatim}
...
\begin{verbatim}
##                                               expr   median
## 1                        vapply(x1, FUN = sqrt, 0)  295.528
## 2 for (i in 1:length(x1)) Racine[i] <- sqrt(x1[i]) 3111.466
\end{verbatim}
...
\begin{verbatim}
##                        expr    median
## 1 replicate(1000, runif(1)) 3770.7150
## 2               runif(1000)   32.7495
\end{verbatim}
...
\begin{verbatim}
##                              expr   median
## 1   BoucleSomme(diamonds[-(2:4)]) 3.420556
## 2 apply(diamonds[-(2:4)], 2, sum) 8.889624
## 3       colSums(diamonds[-(2:4)]) 2.313397
\end{verbatim}
...
##  873.809 1089.359 1182.927 1170.986 1220.097 2657.608   100
\end{verbatim}
...
Ce temps est à comparer à celui de la boucle for de référence, multiplié par 2500, soit \texttt{4957} secondes.
...
## Unit: nanoseconds
##                expr  min     lq     mean median     uq
##  triple.integer(2L)  310  318.5 20976.77  329.0  351.5
##   triple.numeric(2)  312  322.0 18337.76  335.5  364.0
##          triple(2L) 1243 1288.5  1405.61 1313.5 1361.5
##      max neval
##  2063929   100
##  1798604   100
##     5547   100
