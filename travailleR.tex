...
##  f1(X)  37.317  38.7975  54.00993  39.762  42.2320 1337.734   100
##  f2(X)  47.267  48.6390  65.33404  49.935  52.6235 1240.900   100
##  f3(X) 269.564 271.6665 300.39280 273.929 288.4890 1608.833   100
##  f4(X) 399.663 402.4570 435.31557 408.724 421.4225 1861.552   100
\end{verbatim}
...
##                                    expr   median
## 1                              sqrt(x1)   4.6680
## 2                lapply(x1, FUN = sqrt) 317.8855
## 3                sapply(x1, FUN = sqrt) 372.9060
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 367.5215
\end{verbatim}
...
\begin{verbatim}
##          expr   median
## 1  Boucle(x1) 810.9545
## 2 Boucle2(x1)  81.4835
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 vapply(x1, FUN = sqrt, 0) 352.3105
## 2                Boucle(x1)  80.4325
\end{verbatim}
...
\begin{verbatim}
##                                               expr    median
## 1                        vapply(x1, FUN = sqrt, 0)  353.9495
## 2 for (i in 1:length(x1)) Racine[i] <- sqrt(x1[i]) 3258.6025
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 replicate(1000, runif(1)) 2911.043
## 2               runif(1000)   33.746
\end{verbatim}
...
\begin{verbatim}
##                              expr   median
## 1   BoucleSomme(diamonds[-(2:4)]) 3.224582
## 2 apply(diamonds[-(2:4)], 2, sum) 8.050492
## 3       colSums(diamonds[-(2:4)]) 2.475945
\end{verbatim}
...
La mise en place de la parallélisation a un coût d'environ \texttt{0.044} secondes ici.
...
## Unit: microseconds
##                                                      expr     min       lq
##  d <- TotalDistance(X$x, X$y)/NbPoints/(NbPoints - 1) * 2 667.385 671.4235
##      mean  median       uq      max neval
##  1113.828 685.563 1016.322 9680.917   100
\end{verbatim}
...
Ce temps est à comparer à celui de la boucle for de référence, multiplié par 2500, soit \texttt{4645} secondes.
...
## Unit: nanoseconds
##                expr  min     lq     mean median     uq     max neval
##  triple.integer(2L)  308  317.0   366.79  329.5  367.5    1204   100
##   triple.numeric(2)  309  324.5 18996.51  333.0  370.0 1864525   100
##          triple(2L) 1335 1360.0 23151.11 1390.5 1421.0 2170094   100
\end{verbatim}
...
Le fichier \texttt{DESCRIPTION} doit contenir les références au package \textbf{EcoFoG} si ses modèles sont utilisés:
