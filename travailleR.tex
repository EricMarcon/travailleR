...
##  f1(X)  32.264  36.5340  51.87103  37.3825  39.1990 1258.853   100
##  f2(X)  42.440  45.9495  61.43584  46.8890  49.7185 1205.334   100
##  f3(X) 259.032 262.7505 290.92280 265.0415 278.0045 1558.960   100
##  f4(X) 386.719 389.8570 420.08749 391.4630 398.5775 2516.145   100
\end{verbatim}
...
##                                    expr   median
## 1                              sqrt(x1)   4.5080
## 2                lapply(x1, FUN = sqrt) 295.0485
## 3                sapply(x1, FUN = sqrt) 350.0830
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 297.0825
\end{verbatim}
...
\begin{verbatim}
##          expr   median
## 1  Boucle(x1) 747.7365
## 2 Boucle2(x1)  76.6580
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 vapply(x1, FUN = sqrt, 0) 296.8685
## 2                Boucle(x1)  79.0155
\end{verbatim}
...
\begin{verbatim}
##                                               expr    median
## 1                        vapply(x1, FUN = sqrt, 0)  296.3795
## 2 for (i in 1:length(x1)) Racine[i] <- sqrt(x1[i]) 3093.2300
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 replicate(1000, runif(1)) 2591.347
## 2               runif(1000)   32.496
\end{verbatim}
...
\begin{verbatim}
##                              expr   median
## 1   BoucleSomme(diamonds[-(2:4)]) 2.966861
## 2 apply(diamonds[-(2:4)], 2, sum) 7.566579
## 3       colSums(diamonds[-(2:4)]) 2.315367
\end{verbatim}
...
## Unit: microseconds
##                                                      expr     min     lq
##  d <- TotalDistance(X$x, X$y)/NbPoints/(NbPoints - 1) * 2 648.444 651.93
##      mean  median      uq     max neval
##  693.9524 657.355 670.911 2220.47   100
\end{verbatim}
...
## Unit: nanoseconds
##                expr  min     lq     mean median     uq     max neval
##  triple.integer(2L)  310  325.0 20947.66  330.0  358.5 2058887   100
##   triple.numeric(2)  309  319.5 17640.53  326.5  346.0 1730634   100
##          triple(2L) 1299 1323.0  1462.31 1343.0 1396.5    6181   100
\end{verbatim}
