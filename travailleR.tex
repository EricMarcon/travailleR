...
\hyphenation{ac-com-pa-gne-ment do-cu-men-ta-tion}
\usepackage{booktabs}
...
##  f1(X)  36.208  38.6545  59.50451  40.0610  43.8275 1431.887   100
##  f2(X)  46.395  48.9050  71.72984  50.7345  56.3290 1452.493   100
##  f3(X) 269.112 271.6010 310.23526 279.3210 297.6835 1840.052   100
##  f4(X) 399.068 402.9660 449.20456 412.0155 441.6005 2018.466   100
\end{verbatim}
...
##                                    expr   median
## 1                              sqrt(x1)   4.6025
## 2                lapply(x1, FUN = sqrt) 306.5920
## 3                sapply(x1, FUN = sqrt) 362.1700
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 303.0955
\end{verbatim}
...
\begin{verbatim}
##          expr   median
## 1  Boucle(x1) 794.2365
## 2 Boucle2(x1)  82.1485
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 vapply(x1, FUN = sqrt, 0) 301.7845
## 2                Boucle(x1)  80.4645
\end{verbatim}
...
\begin{verbatim}
##                                               expr   median
## 1                        vapply(x1, FUN = sqrt, 0)  310.610
## 2 for (i in 1:length(x1)) Racine[i] <- sqrt(x1[i]) 3473.669
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 replicate(1000, runif(1)) 3681.968
## 2               runif(1000)   34.448
\end{verbatim}
...
\begin{verbatim}
##                              expr   median
## 1   BoucleSomme(diamonds[-(2:4)]) 3.162676
## 2 apply(diamonds[-(2:4)], 2, sum) 7.919830
## 3       colSums(diamonds[-(2:4)]) 2.442209
\end{verbatim}
...
La mise en place de la parallélisation a un coût d'environ \texttt{0.1} secondes ici.
...
## Unit: microseconds
##                                                      expr     min      lq
##  d <- TotalDistance(X$x, X$y)/NbPoints/(NbPoints - 1) * 2 667.049 684.039
##      mean  median       uq      max neval
##  776.0145 759.301 785.8765 2339.714   100
\end{verbatim}
...
Ce temps est à comparer à celui de la boucle for de référence, multiplié par 2500, soit \texttt{4647} secondes.
...
## Unit: nanoseconds
##                expr  min     lq     mean median     uq     max neval
##  triple.integer(2L)  308  314.0   391.40  331.5  365.0    1581   100
##   triple.numeric(2)  306  324.0 29552.38  332.5  355.5 2915860   100
##          triple(2L) 1305 1326.5 22332.64 1352.5 1465.5 2081588   100
\end{verbatim}
