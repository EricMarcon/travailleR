...
##  f1(X)  36.244  38.0705  51.95921  39.4615  41.0835
##  f2(X)  44.028  45.8295  60.59037  47.0895  49.7785
##  f3(X) 256.910 271.2345 284.37787 273.2645 279.2740
##  f4(X) 377.836 395.3585 417.71233 400.7730 405.6420
##       max neval
##  1207.256   100
##  1207.519   100
##  1401.426   100
...
##                                    expr   median
## 1                              sqrt(x1)   4.3985
## 2                lapply(x1, FUN = sqrt) 287.3080
## 3                sapply(x1, FUN = sqrt) 346.4930
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 287.6485
\end{verbatim}
...
\begin{verbatim}
##          expr   median
## 1  Boucle(x1) 800.9580
## 2 Boucle2(x1)  76.7995
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 vapply(x1, FUN = sqrt, 0) 283.1845
## 2                Boucle(x1)  73.6175
\end{verbatim}
...
\begin{verbatim}
##                        expr    median
## 1 replicate(1000, runif(1)) 4157.2525
## 2               runif(1000)   33.1065
\end{verbatim}
...
\begin{verbatim}
##                              expr   median
## 1   BoucleSomme(diamonds[-(2:4)]) 3.445710
## 2 apply(diamonds[-(2:4)], 2, sum) 8.915797
## 3       colSums(diamonds[-(2:4)]) 2.311136
\end{verbatim}
...
La mise en place de la parallélisation a un coût d'environ \texttt{0.062} secondes ici.
...
##  756.89 763.6485 847.0805 777.35 797.7465 2365.878   100
\end{verbatim}
...
Ce temps est à comparer à celui de la boucle for de référence, multiplié par 2500, soit \texttt{4367} secondes.
...
## • built target NbPoints [2.024 seconds]
## • start target X
## • built target X [0.004 seconds]
## • start target d
## • built target d [0.019 seconds]
## • start target map
## • built target map [0.017 seconds]
## • end pipeline [2.251 seconds]
\end{verbatim}
...
\begin{verbatim}
## • start target NbPoints
## • built target NbPoints [1.728 seconds]
## • start target X
...
## Unit: nanoseconds
##                expr  min     lq     mean median     uq
##  triple.integer(2L)  314  326.0 23683.06  335.0  347.0
##   triple.numeric(2)  314  325.5 19884.59  338.5  350.5
##          triple(2L) 1285 1310.0  1419.19 1327.0 1375.0
##      max neval
##  2334401   100
##  1953679   100
##     5390   100
