...
##  f1(X)  36.587  38.1940  55.31743  39.1105  41.7725 1392.859   100
##  f2(X)  46.439  48.3365  66.29225  49.0840  51.7190 1479.714   100
##  f3(X) 269.698 271.6090 293.96183 273.0070 279.1015 1663.427   100
##  f4(X) 399.934 401.6895 432.69814 403.5330 416.0575 1877.189   100
\end{verbatim}
...
##                                    expr   median
## 1                              sqrt(x1)   4.7860
## 2                lapply(x1, FUN = sqrt) 310.0060
## 3                sapply(x1, FUN = sqrt) 364.4715
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 305.2545
\end{verbatim}
...
\begin{verbatim}
##          expr   median
## 1  Boucle(x1) 780.0440
## 2 Boucle2(x1)  80.9595
\end{verbatim}
...
\begin{verbatim}
##                        expr  median
## 1 vapply(x1, FUN = sqrt, 0) 296.804
## 2                Boucle(x1)  79.697
\end{verbatim}
...
\begin{verbatim}
##                                               expr    median
## 1                        vapply(x1, FUN = sqrt, 0)  304.6835
## 2 for (i in 1:length(x1)) Racine[i] <- sqrt(x1[i]) 3392.2610
\end{verbatim}
...
\begin{verbatim}
##                        expr    median
## 1 replicate(1000, runif(1)) 3531.2810
## 2               runif(1000)   34.1805
\end{verbatim}
...
\begin{verbatim}
##                              expr   median
## 1   BoucleSomme(diamonds[-(2:4)]) 3.204665
## 2 apply(diamonds[-(2:4)], 2, sum) 7.937299
## 3       colSums(diamonds[-(2:4)]) 2.473495
\end{verbatim}
...
## Unit: microseconds
##                                                      expr     min      lq
##  d <- TotalDistance(X$x, X$y)/NbPoints/(NbPoints - 1) * 2 671.823 774.178
##      mean  median       uq      max neval
##  839.4045 804.099 851.5265 2385.966   100
\end{verbatim}
...
Ce temps est à comparer à celui de la boucle for de référence, multiplié par 2500, soit \texttt{4445} secondes.
...
## Unit: nanoseconds
##                expr  min     lq     mean median     uq     max neval
##  triple.integer(2L)  307  321.5   384.04  343.5  379.0    1058   100
##   triple.numeric(2)  309  324.0 18650.04  339.0  369.0 1828327   100
##          triple(2L) 1289 1327.5 22259.81 1372.5 1456.5 2070749   100
\end{verbatim}
