...
##  f1(X)  40.515  42.7090  58.37207  43.881  47.0175 1298.754
##  f2(X)  48.577  50.1035  67.83835  51.434  54.2665 1471.805
##  f3(X) 279.626 281.8320 303.95205 284.668 291.9405 1551.957
##  f4(X) 411.085 413.4525 447.30495 420.363 432.8855 1865.065
##  neval
##    100
##    100
##    100
...
##                                    expr   median
## 1                              sqrt(x1)   4.6090
## 2                lapply(x1, FUN = sqrt) 300.1090
## 3                sapply(x1, FUN = sqrt) 358.4015
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 308.5260
\end{verbatim}
...
\begin{verbatim}
##          expr   median
## 1  Boucle(x1) 832.9295
## 2 Boucle2(x1)  78.5185
\end{verbatim}
...
\begin{verbatim}
##                        expr  median
## 1 vapply(x1, FUN = sqrt, 0) 321.390
## 2                Boucle(x1)  78.171
\end{verbatim}
...
\begin{verbatim}
##                                               expr   median
## 1                        vapply(x1, FUN = sqrt, 0)  308.551
## 2 for (i in 1:length(x1)) Racine[i] <- sqrt(x1[i]) 3366.341
\end{verbatim}
...
\begin{verbatim}
##                        expr    median
## 1 replicate(1000, runif(1)) 4292.8155
## 2               runif(1000)   34.6645
\end{verbatim}
...
\begin{verbatim}
##                              expr   median
## 1   BoucleSomme(diamonds[-(2:4)]) 3.704026
## 2 apply(diamonds[-(2:4)], 2, sum) 9.545722
## 3       colSums(diamonds[-(2:4)]) 2.534546
\end{verbatim}
...
La mise en place de la parallélisation a un coût d'environ \texttt{0.11} secondes ici.
...
##  2.083815 2.119655 3.147925 2.156819 2.206638 44.2555   100
\end{verbatim}
...
Ce temps est à comparer à celui de la boucle for de référence, multiplié par 2500, soit \texttt{5519} secondes.
...
\begin{center}\includegraphics[width=0.8\linewidth]{travailleR_files/figure-latex/unnamed-chunk-57-1} \end{center}
...
\begin{center}\includegraphics[width=0.8\linewidth]{travailleR_files/figure-latex/unnamed-chunk-59-1} \end{center}
...
\begin{center}\includegraphics[width=0.8\linewidth]{travailleR_files/figure-latex/unnamed-chunk-60-1} \end{center}
...
\begin{verbatim}
## v Setting active project to '/Users/runner/work/travailleR/travailleR'
\end{verbatim}
...
\begin{center}\includegraphics[width=0.8\linewidth]{travailleR_files/figure-latex/unnamed-chunk-82-1} \end{center}
...
\begin{center}\includegraphics[width=0.8\linewidth]{travailleR_files/figure-latex/unnamed-chunk-83-1} \end{center}
...
##  triple.integer(2L)  323  334 22774.79  343.0  370.0
##   triple.numeric(2)  324  337 19537.82  354.5  383.0
##          triple(2L) 1321 1350  1479.11 1381.5 1434.5
##      max neval
##  2242370   100
##  1916862   100
##     6357   100
...
\NormalTok{    ggplot2}\SpecialCharTok{::}\FunctionTok{geom\_point}\NormalTok{(ggplot2}\SpecialCharTok{::}\FunctionTok{aes\_}\NormalTok{(}\AttributeTok{x =} \SpecialCharTok{\textasciitilde{}}\NormalTok{x, }\AttributeTok{y =} \SpecialCharTok{\textasciitilde{}}\NormalTok{y)) }\SpecialCharTok{+}
...
\begin{center}\includegraphics[width=0.8\linewidth]{travailleR_files/figure-latex/unnamed-chunk-118-1} \end{center}
...
\begin{center}\includegraphics[width=0.8\linewidth]{travailleR_files/figure-latex/unnamed-chunk-118-2} \end{center}
