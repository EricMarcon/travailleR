...
##  f1(X)  39.766  42.5105  57.91928  43.9155  48.5170
##  f2(X)  45.964  49.9040  85.11853  51.2280  55.2865
##  f3(X) 279.625 281.8515 311.86156 283.9120 295.8575
##  f4(X) 410.267 412.4185 462.43358 414.5690 429.4725
##       max neval
##  1270.895   100
##  1384.000   100
##  1554.440   100
...
##                                    expr   median
## 1                              sqrt(x1)   4.7335
## 2                lapply(x1, FUN = sqrt) 312.5785
## 3                sapply(x1, FUN = sqrt) 370.0920
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 320.7675
\end{verbatim}
...
\begin{verbatim}
##          expr   median
## 1  Boucle(x1) 832.5465
## 2 Boucle2(x1)  79.4465
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 vapply(x1, FUN = sqrt, 0) 324.1095
## 2                Boucle(x1)  81.5610
\end{verbatim}
...
\begin{verbatim}
##                                               expr   median
## 1                        vapply(x1, FUN = sqrt, 0)  316.232
## 2 for (i in 1:length(x1)) Racine[i] <- sqrt(x1[i]) 3422.124
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 replicate(1000, runif(1)) 4520.505
## 2               runif(1000)   35.632
\end{verbatim}
...
\begin{verbatim}
##                              expr   median
## 1   BoucleSomme(diamonds[-(2:4)]) 3.729438
## 2 apply(diamonds[-(2:4)], 2, sum) 9.701377
## 3       colSums(diamonds[-(2:4)]) 2.552092
\end{verbatim}
...
La mise en place de la parallélisation a un coût d'environ \texttt{0.029} secondes ici.
...
##  775.571 1105.756 1250.514 1195.955 1296.921 2761.362   100
\end{verbatim}
...
Ce temps est à comparer à celui de la boucle for de référence, multiplié par 2500, soit \texttt{5219} secondes.
...
##  triple.integer(2L)  325  338 29254.53  347.5  368 2889034
##   triple.numeric(2)  324  337 21002.19  350.5  376 2056364
##          triple(2L) 1321 1361  1513.82 1384.5 1439    6861
##  neval
##    100
##    100
##    100
