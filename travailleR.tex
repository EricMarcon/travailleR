...
##  f1(X)  42.038  43.9425  60.20860  45.3195  49.7340
##  f2(X)  48.919  51.3015  67.24685  52.4675  55.3960
##  f3(X) 275.638 278.1685 299.02780 283.0910 291.5135
##  f4(X) 402.546 405.0380 426.98251 408.0185 420.8065
##       max neval
##  1287.880   100
##  1236.409   100
##  1468.171   100
...
##                                    expr   median
## 1                              sqrt(x1)   4.5555
## 2                lapply(x1, FUN = sqrt) 295.9030
## 3                sapply(x1, FUN = sqrt) 352.1960
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 289.8480
\end{verbatim}
...
\begin{verbatim}
##          expr   median
## 1  Boucle(x1) 799.3545
## 2 Boucle2(x1)  76.1435
\end{verbatim}
...
\begin{verbatim}
##                        expr  median
## 1 vapply(x1, FUN = sqrt, 0) 284.754
## 2                Boucle(x1)  75.484
\end{verbatim}
...
\begin{verbatim}
##                                               expr   median
## 1                        vapply(x1, FUN = sqrt, 0)  298.028
## 2 for (i in 1:length(x1)) Racine[i] <- sqrt(x1[i]) 3223.204
\end{verbatim}
...
\begin{verbatim}
##                        expr    median
## 1 replicate(1000, runif(1)) 2716.8475
## 2               runif(1000)   32.4685
\end{verbatim}
...
\begin{verbatim}
##                              expr   median
## 1   BoucleSomme(diamonds[-(2:4)]) 3.750876
## 2 apply(diamonds[-(2:4)], 2, sum) 9.724779
## 3       colSums(diamonds[-(2:4)]) 2.572112
\end{verbatim}
...
La mise en place de la parallélisation a un coût d'environ \texttt{0.089} secondes ici.
...
##  755.545 780.623 827.8276 783.7135 790.0085 2413.994   100
\end{verbatim}
...
Ce temps est à comparer à celui de la boucle for de référence, multiplié par 2500, soit \texttt{5025} secondes.
...
## Unit: nanoseconds
##                expr  min   lq     mean median     uq
##  triple.integer(2L)  347  360 24004.87  401.5  434.0
##   triple.numeric(2)  341  359 25644.93  374.5  428.0
##          triple(2L) 1348 1397  1642.32 1468.5 1602.5
##      max neval
##  2359662   100
##  2522976   100
##     9174   100
