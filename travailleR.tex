...
##  f1(X)  37.631  40.4375  57.18981  42.1650  44.4425
##  f2(X)  45.998  48.3885  65.57374  49.8560  53.9030
##  f3(X) 286.302 288.5030 310.37528 290.1285 297.4845
##  f4(X) 416.815 428.5370 465.22781 431.1845 443.0545
##       max neval
##  1347.094   100
##  1307.288   100
##  1639.013   100
...
##                                    expr   median
## 1                              sqrt(x1)   4.8575
## 2                lapply(x1, FUN = sqrt) 322.7630
## 3                sapply(x1, FUN = sqrt) 392.8170
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 320.9955
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 vapply(x1, FUN = sqrt, 0) 340.4565
## 2                Boucle(x1)  93.4855
\end{verbatim}
...
\begin{verbatim}
##                                               expr   median
## 1                        vapply(x1, FUN = sqrt, 0)  313.028
## 2 for (i in 1:length(x1)) Racine[i] <- sqrt(x1[i]) 3874.436
\end{verbatim}
...
\begin{verbatim}
##                        expr    median
## 1 replicate(1000, runif(1)) 4510.5505
## 2               runif(1000)   24.5585
\end{verbatim}
...
\begin{verbatim}
##                              expr   median
## 1   BoucleSomme(diamonds[-(2:4)]) 3.832974
## 2 apply(diamonds[-(2:4)], 2, sum) 8.795942
## 3       colSums(diamonds[-(2:4)]) 2.592494
\end{verbatim}
...
La mise en place de la parallélisation a un coût d'environ \texttt{0.067} secondes ici.
...
##  763.36 820.47 1024.73 919.076 1154.628 2498.635   100
\end{verbatim}
...
Ce temps est à comparer à celui de la boucle for de référence, multiplié par 2500, soit \texttt{4734} secondes.
...
## ● built target NbPoints [2.143 seconds]
## ▶ start target X
## ● built target X [0.003 seconds]
## ▶ start target d
## ● built target d [0.028 seconds]
## ▶ start target map
## ● built target map [0.037 seconds]
## ▶ end pipeline [3.52 seconds]
\end{verbatim}
...
\begin{verbatim}
## ▶ start target NbPoints
## ● built target NbPoints [1.939 seconds]
## ▶ start target X
...
## Unit: nanoseconds
##                expr  min     lq     mean median     uq
##  triple.integer(2L)  815 1034.0 37540.57 1142.5 1260.5
##   triple.numeric(2)  833 1058.0 48113.59 1175.0 1282.5
##          triple(2L) 3129 3653.5  4088.94 3858.0 4085.0
##      max neval
##  3640258   100
##  4692958   100
##    11817   100
