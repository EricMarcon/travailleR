...
##  f1(X)  36.268  38.7105  66.61300  40.6040  45.7685 1591.115   100
##  f2(X)  44.086  46.3280  82.51763  48.1005  51.9890 1621.848   100
##  f3(X) 275.570 277.7475 330.05296 285.0505 306.0820 1729.641   100
##  f4(X) 408.724 411.6350 495.83909 426.4860 464.4600 2175.191   100
\end{verbatim}
...
##                                    expr   median
## 1                              sqrt(x1)   4.7030
## 2                lapply(x1, FUN = sqrt) 294.9905
## 3                sapply(x1, FUN = sqrt) 355.6745
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 292.7880
\end{verbatim}
...
\begin{verbatim}
##          expr   median
## 1  Boucle(x1) 936.1485
## 2 Boucle2(x1)  83.7125
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 vapply(x1, FUN = sqrt, 0) 294.3435
## 2                Boucle(x1)  79.4435
\end{verbatim}
...
\begin{verbatim}
##                                               expr    median
## 1                        vapply(x1, FUN = sqrt, 0)  293.9625
## 2 for (i in 1:length(x1)) Racine[i] <- sqrt(x1[i]) 3369.7375
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 replicate(1000, runif(1)) 4131.721
## 2               runif(1000)   34.308
\end{verbatim}
...
\begin{verbatim}
##                              expr   median
## 1   BoucleSomme(diamonds[-(2:4)]) 3.590105
## 2 apply(diamonds[-(2:4)], 2, sum) 9.161012
## 3       colSums(diamonds[-(2:4)]) 2.450522
\end{verbatim}
...
La mise en place de la parallélisation a un coût d'environ \texttt{0.024} secondes ici.
...
## Unit: microseconds
##                                                      expr     min      lq
##  d <- TotalDistance(X$x, X$y)/NbPoints/(NbPoints - 1) * 2 685.048 709.548
##     mean   median       uq      max neval
##  801.316 784.6595 802.2915 2402.251   100
\end{verbatim}
...
Ce temps est à comparer à celui de la boucle for de référence, multiplié par 2500, soit \texttt{4717} secondes.
...
## Unit: nanoseconds
##                expr  min     lq     mean median     uq     max neval
##  triple.integer(2L)  327  348.5   412.95  382.0  415.5    1346   100
##   triple.numeric(2)  327  346.0 20674.50  370.5  409.0 2029052   100
##          triple(2L) 1365 1402.0 23852.62 1434.5 1484.5 2218252   100
\end{verbatim}
