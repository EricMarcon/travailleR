...
##  f1(X)  39.498  41.176  56.13379  42.2210  44.2960 1270.285
##  f2(X)  47.530  48.761  65.50972  49.8805  52.2080 1239.996
##  f3(X) 277.088 279.152 296.17621 280.8150 285.2565 1483.333
##  f4(X) 409.311 411.826 434.45469 413.5390 419.4060 1831.515
##  neval
##    100
##    100
##    100
...
##                                    expr   median
## 1                              sqrt(x1)   4.5865
## 2                lapply(x1, FUN = sqrt) 304.1565
## 3                sapply(x1, FUN = sqrt) 361.6210
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 297.3750
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 vapply(x1, FUN = sqrt, 0) 292.3955
## 2                Boucle(x1)  75.7290
\end{verbatim}
...
\begin{verbatim}
##                        expr    median
## 1 replicate(1000, runif(1)) 4401.5725
## 2               runif(1000)   34.9795
\end{verbatim}
...
\begin{verbatim}
##                              expr   median
## 1   BoucleSomme(diamonds[-(2:4)]) 3.736499
## 2 apply(diamonds[-(2:4)], 2, sum) 9.492493
## 3       colSums(diamonds[-(2:4)]) 2.492657
\end{verbatim}
...
##  1.092654 2.082898 2.167623 2.111819 2.282066 3.89296   100
\end{verbatim}
...
Ce temps est à comparer à celui de la boucle for de référence, multiplié par 2500, soit \texttt{5069} secondes.
...
##  triple.integer(2L)  336  348.5 22992.88  357.0  374.5
##   triple.numeric(2)  335  347.5 22054.60  362.0  374.0
##          triple(2L) 1338 1371.5  1524.53 1382.5 1453.0
##      max neval
##  2262354   100
##  2166795   100
##     6271   100
