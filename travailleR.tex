...
##  f1(X)  36.263  38.5725  66.78098  40.8100  53.385 1359.660   100
##  f2(X)  44.644  46.6890  75.35730  48.0530  58.043 1319.023   100
##  f3(X) 275.174 279.8080 323.67161 286.5535 301.419 1778.661   100
##  f4(X) 408.637 415.3100 454.15197 427.8295 441.398 1918.217   100
\end{verbatim}
...
##                                    expr   median
## 1                              sqrt(x1)   4.6630
## 2                lapply(x1, FUN = sqrt) 304.5600
## 3                sapply(x1, FUN = sqrt) 356.1125
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 294.2050
\end{verbatim}
...
\begin{verbatim}
##          expr   median
## 1  Boucle(x1) 791.5465
## 2 Boucle2(x1)  78.2230
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 vapply(x1, FUN = sqrt, 0) 288.8435
## 2                Boucle(x1)  78.2775
\end{verbatim}
...
\begin{verbatim}
##                                               expr    median
## 1                        vapply(x1, FUN = sqrt, 0)  297.5575
## 2 for (i in 1:length(x1)) Racine[i] <- sqrt(x1[i]) 3589.4280
\end{verbatim}
...
\begin{verbatim}
##                        expr    median
## 1 replicate(1000, runif(1)) 3642.8620
## 2               runif(1000)   33.2665
\end{verbatim}
...
\begin{verbatim}
##                              expr   median
## 1   BoucleSomme(diamonds[-(2:4)]) 3.684368
## 2 apply(diamonds[-(2:4)], 2, sum) 9.594738
## 3       colSums(diamonds[-(2:4)]) 2.570578
\end{verbatim}
...
La mise en place de la parallélisation a un coût d'environ \texttt{0.031} secondes ici.
...
## Unit: microseconds
##                                                      expr     min       lq
##  d <- TotalDistance(X$x, X$y)/NbPoints/(NbPoints - 1) * 2 690.141 704.6275
##      mean   median       uq      max neval
##  973.4322 805.3895 1055.863 3239.549   100
\end{verbatim}
...
Ce temps est à comparer à celui de la boucle for de référence, multiplié par 2500, soit \texttt{4692} secondes.
...
## Unit: nanoseconds
##                expr  min     lq     mean median     uq     max neval
##  triple.integer(2L)  330  353.5  1028.95  384.5  422.0   34658   100
##   triple.numeric(2)  328  346.5 24352.72  383.0  418.0 2392946   100
##          triple(2L) 1371 1394.0 34102.11 1414.0 1483.5 3066596   100
\end{verbatim}
