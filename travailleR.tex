...
##  f1(X)  37.737  39.1595  55.13503  40.3485  44.2950
##  f2(X)  45.525  46.8230  63.59706  47.5020  51.1075
##  f3(X) 274.987 280.4675 315.70500 286.1665 294.5020
##  f4(X) 409.351 415.0615 466.32870 427.6615 446.0465
##       max neval
##  1285.419   100
##  1229.980   100
##  1504.358   100
...
##                                    expr   median
## 1                              sqrt(x1)   4.8320
## 2                lapply(x1, FUN = sqrt) 300.1760
## 3                sapply(x1, FUN = sqrt) 354.0545
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 312.3185
\end{verbatim}
...
\begin{verbatim}
##          expr   median
## 1  Boucle(x1) 963.3335
## 2 Boucle2(x1)  81.4370
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 vapply(x1, FUN = sqrt, 0) 306.9785
## 2                Boucle(x1)  80.1705
\end{verbatim}
...
\begin{verbatim}
##                                               expr   median
## 1                        vapply(x1, FUN = sqrt, 0)  308.546
## 2 for (i in 1:length(x1)) Racine[i] <- sqrt(x1[i]) 3736.276
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 replicate(1000, runif(1)) 4193.423
## 2               runif(1000)   34.913
\end{verbatim}
...
\begin{verbatim}
##                              expr   median
## 1   BoucleSomme(diamonds[-(2:4)]) 3.869603
## 2 apply(diamonds[-(2:4)], 2, sum) 9.813513
## 3       colSums(diamonds[-(2:4)]) 2.513715
\end{verbatim}
...
##  780.867 866.8925 930.8894 894.3825 913.8555 2811.554   100
\end{verbatim}
...
Ce temps est à comparer à celui de la boucle for de référence, multiplié par 2500, soit \texttt{5410} secondes.
...
## Unit: nanoseconds
##                expr  min   lq     mean median     uq
##  triple.integer(2L)  320  334 24941.95  347.5  391.5
##   triple.numeric(2)  318  330 22478.77  344.5  379.5
##          triple(2L) 1277 1318  2116.01 1357.0 1529.0
##      max neval
##  2456250   100
##  2209100   100
##    34818   100
