...
##  f1(X)   1.804   2.3985   9.61696   6.1705   7.8105 404.547
##  f2(X)   4.182   4.8585  12.17126   8.4870  10.1270 401.062
##  f3(X)  99.712 104.3655 113.49702 106.8665 110.3720 613.196
##  f4(X) 133.865 139.4205 152.85415 142.3520 146.4520 856.982
##  neval
##    100
##    100
##    100
...
##                                    expr   median
## 1                              sqrt(x1)   1.4760
## 2                lapply(x1, FUN = sqrt) 136.1405
## 3                sapply(x1, FUN = sqrt) 161.4785
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 133.1680
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 vapply(x1, FUN = sqrt, 0) 131.8765
## 2                Boucle(x1)  41.8200
\end{verbatim}
...
\begin{verbatim}
##                                               expr   median
## 1                        vapply(x1, FUN = sqrt, 0) 124.7835
## 2 for (i in 1:length(x1)) Racine[i] <- sqrt(x1[i]) 956.9810
\end{verbatim}
...
\begin{verbatim}
##                        expr  median
## 1 replicate(1000, runif(1)) 738.041
## 2               runif(1000)   6.314
\end{verbatim}
...
\begin{verbatim}
##                              expr   median
## 1   BoucleSomme(diamonds[-(2:4)]) 1615.995
## 2 apply(diamonds[-(2:4)], 2, sum) 3725.445
## 3       colSums(diamonds[-(2:4)]) 1283.320
\end{verbatim}
...
##  222.63 232.8185 283.0455 236.652 249.157 3955.885   100
\end{verbatim}
...
Ce temps est à comparer à celui de la boucle for de référence, multiplié par 2500, soit \texttt{2222} secondes.
...
## ● completed target NbPoints [0.694 seconds]
## ▶ dispatched target X
...
\begin{verbatim}
## ▶ dispatched target NbPoints
## ● completed target NbPoints [0.594 seconds]
## ▶ dispatched target X
## ● completed target X [0.001 seconds]
## ▶ dispatched target d
## ● completed target d [0.004 seconds]
## ▶ dispatched target map
## ● completed target map [0.011 seconds]
## ▶ ended pipeline [0.701 seconds]
\end{verbatim}
...
##  triple.integer(2L) 123 123 6668.24    123 164 646693   100
##   triple.numeric(2)  82 123 8772.36    123 246 856039   100
##          triple(2L) 492 533  756.86    656 779   2747   100
\end{verbatim}
