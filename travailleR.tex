...
##  f1(X)  36.200  38.9145  57.87257  40.6225  46.1585 1348.432   100
##  f2(X)  45.858  48.8780  94.50472  51.2965  57.0255 2148.510   100
##  f3(X) 268.768 272.9930 324.49337 280.7430 291.0760 1736.423   100
##  f4(X) 400.070 406.0510 495.68277 417.8310 514.6155 2495.866   100
\end{verbatim}
...
##                                    expr   median
## 1                              sqrt(x1)   4.8195
## 2                lapply(x1, FUN = sqrt) 308.8600
## 3                sapply(x1, FUN = sqrt) 371.0780
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 311.1005
\end{verbatim}
...
\begin{verbatim}
##          expr   median
## 1  Boucle(x1) 802.4150
## 2 Boucle2(x1)  82.1815
\end{verbatim}
...
\begin{verbatim}
##                        expr  median
## 1 vapply(x1, FUN = sqrt, 0) 297.267
## 2                Boucle(x1)  79.763
\end{verbatim}
...
\begin{verbatim}
##                                               expr    median
## 1                        vapply(x1, FUN = sqrt, 0)  309.2845
## 2 for (i in 1:length(x1)) Racine[i] <- sqrt(x1[i]) 3417.6055
\end{verbatim}
...
\begin{verbatim}
##                        expr    median
## 1 replicate(1000, runif(1)) 3747.4670
## 2               runif(1000)   35.3645
\end{verbatim}
...
\begin{verbatim}
##                              expr   median
## 1   BoucleSomme(diamonds[-(2:4)]) 3.210011
## 2 apply(diamonds[-(2:4)], 2, sum) 8.129441
## 3       colSums(diamonds[-(2:4)]) 2.467728
\end{verbatim}
...
## Unit: microseconds
##                                                      expr     min       lq
##  d <- TotalDistance(X$x, X$y)/NbPoints/(NbPoints - 1) * 2 669.633 808.8285
##      mean   median       uq      max neval
##  1090.555 1053.883 1262.312 2409.863   100
\end{verbatim}
...
Ce temps est à comparer à celui de la boucle for de référence, multiplié par 2500, soit \texttt{4510} secondes.
...
## Unit: nanoseconds
##                expr  min     lq     mean median     uq     max neval
##  triple.integer(2L)  310  320.5   364.40    331  358.0    1050   100
##   triple.numeric(2)  310  324.5 18602.07    330  356.0 1824586   100
##          triple(2L) 1308 1338.5 23231.73   1361 1421.5 2177755   100
\end{verbatim}
...
Certains de ces packages ont besoin de librairies extérieures à R: ici, \texttt{cairo} pour le package \textbf{gdtools} de R.
L'installation de \texttt{cairo} est la plupart du temps inutile, mais pendant les quelques jours suivant chaque mise à jour de \textbf{gdtools} sur CRAN, avant que le package binaire soit disponible, l'installation d'\textbf{EcoFoG} est impossible sans ce préalable.
