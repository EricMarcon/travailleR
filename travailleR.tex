...
##  f1(X)  36.353  38.6455  52.59937  39.2970  40.4385
##  f2(X)  44.622  45.9165  59.85204  46.8900  48.1155
##  f3(X) 278.055 286.3920 301.32665 287.3515 290.9340
##  f4(X) 413.528 427.0325 453.29303 428.7115 435.7290
##       max neval
##  1291.350   100
##  1218.351   100
##  1494.385   100
...
##                                    expr   median
## 1                              sqrt(x1)   4.6010
## 2                lapply(x1, FUN = sqrt) 292.5990
## 3                sapply(x1, FUN = sqrt) 341.2245
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 292.8585
\end{verbatim}
...
\begin{verbatim}
##          expr   median
## 1  Boucle(x1) 775.8905
## 2 Boucle2(x1)  75.6475
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 vapply(x1, FUN = sqrt, 0) 283.5375
## 2                Boucle(x1)  74.9495
\end{verbatim}
...
\begin{verbatim}
##                        expr    median
## 1 replicate(1000, runif(1)) 3957.2220
## 2               runif(1000)   33.9635
\end{verbatim}
...
\begin{verbatim}
##                              expr   median
## 1   BoucleSomme(diamonds[-(2:4)]) 3.471463
## 2 apply(diamonds[-(2:4)], 2, sum) 8.762839
## 3       colSums(diamonds[-(2:4)]) 2.313098
\end{verbatim}
...
La mise en place de la parallélisation a un coût d'environ \texttt{0.082} secondes ici.
...
##  742.263 765.063 803.4397 770.2235 777.1775 2427.941   100
\end{verbatim}
...
Ce temps est à comparer à celui de la boucle for de référence, multiplié par 2500, soit \texttt{4520} secondes.
...
## Unit: nanoseconds
##                expr  min     lq     mean median     uq
##  triple.integer(2L)  313  325.0 22139.47  333.0  348.5
##   triple.numeric(2)  313  324.0 18716.14  335.5  352.0
##          triple(2L) 1291 1317.5  1442.01 1334.5 1366.0
##      max neval
##  2179348   100
##  1836294   100
##     6144   100
