...
##  f1(X)  36.107  37.7440  53.66116  38.7170  42.8795 1244.221   100
##  f2(X)  43.617  45.1935  59.90310  46.2195  48.2285 1238.738   100
##  f3(X) 275.332 277.4610 295.84574 279.7410 291.1000 1476.685   100
##  f4(X) 406.245 408.6020 432.54468 415.2460 424.0065 1890.824   100
\end{verbatim}
...
##                                    expr   median
## 1                              sqrt(x1)   4.6805
## 2                lapply(x1, FUN = sqrt) 302.8430
## 3                sapply(x1, FUN = sqrt) 361.2510
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 294.0735
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 vapply(x1, FUN = sqrt, 0) 288.6300
## 2                Boucle(x1)  80.4125
\end{verbatim}
...
\begin{verbatim}
##                                               expr    median
## 1                        vapply(x1, FUN = sqrt, 0)  290.0555
## 2 for (i in 1:length(x1)) Racine[i] <- sqrt(x1[i]) 3186.3590
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 replicate(1000, runif(1)) 4021.068
## 2               runif(1000)   35.410
\end{verbatim}
...
\begin{verbatim}
##                              expr   median
## 1   BoucleSomme(diamonds[-(2:4)]) 3.496958
## 2 apply(diamonds[-(2:4)], 2, sum) 9.091192
## 3       colSums(diamonds[-(2:4)]) 2.397811
\end{verbatim}
...
## Unit: milliseconds
##                                                      expr      min       lq
##  d <- TotalDistance(X$x, X$y)/NbPoints/(NbPoints - 1) * 2 1.189955 1.567541
##      mean   median       uq      max neval
##  1.994458 2.036061 2.098402 5.694995   100
\end{verbatim}
...
Ce temps est à comparer à celui de la boucle for de référence, multiplié par 2500, soit \texttt{4699} secondes.
...
## Unit: nanoseconds
##                expr  min     lq     mean median     uq     max neval
##  triple.integer(2L)  318  334.0   398.17  351.0  420.0    1567   100
##   triple.numeric(2)  318  329.5 19050.52  340.0  408.0 1868126   100
##          triple(2L) 1328 1366.5 23292.06 1406.5 1452.5 2183818   100
\end{verbatim}
