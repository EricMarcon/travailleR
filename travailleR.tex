...
##  f1(X)  40.580  44.0750  63.89010  46.6830  50.5445
##  f2(X)  47.416  51.9285  75.76323  54.2440  62.7580
##  f3(X) 278.197 282.9430 323.96797 292.9770 319.2610
##  f4(X) 402.664 416.1370 472.49615 431.5345 475.6615
##       max neval
##  1402.590   100
##  1506.281   100
##  1712.581   100
...
##                                    expr   median
## 1                              sqrt(x1)   4.7700
## 2                lapply(x1, FUN = sqrt) 328.3500
## 3                sapply(x1, FUN = sqrt) 396.8530
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 323.3005
\end{verbatim}
...
\begin{verbatim}
##          expr   median
## 1  Boucle(x1) 821.4905
## 2 Boucle2(x1)  86.1640
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 vapply(x1, FUN = sqrt, 0) 318.5380
## 2                Boucle(x1)  83.2525
\end{verbatim}
...
\begin{verbatim}
##                                               expr   median
## 1                        vapply(x1, FUN = sqrt, 0)  325.184
## 2 for (i in 1:length(x1)) Racine[i] <- sqrt(x1[i]) 3591.253
\end{verbatim}
...
\begin{verbatim}
##                        expr    median
## 1 replicate(1000, runif(1)) 4587.5675
## 2               runif(1000)   22.2375
\end{verbatim}
...
\begin{verbatim}
##                              expr   median
## 1   BoucleSomme(diamonds[-(2:4)]) 3.901700
## 2 apply(diamonds[-(2:4)], 2, sum) 9.353990
## 3       colSums(diamonds[-(2:4)]) 2.780014
\end{verbatim}
...
##  771.959 813.4365 1046.081 835.141 863.445 5214.519   100
\end{verbatim}
...
Ce temps est à comparer à celui de la boucle for de référence, multiplié par 2500, soit \texttt{5437} secondes.
...
## ● built target NbPoints [2.274 seconds]
## ▶ start target X
...
\begin{verbatim}
## ▶ start target NbPoints
## ● built target NbPoints [2.18 seconds]
## ▶ start target X
...
## Unit: nanoseconds
##                expr  min     lq     mean median     uq
##  triple.integer(2L)  332  339.0 24933.78  348.5  388.5
##   triple.numeric(2)  329  342.5 23433.11  353.5  391.0
##          triple(2L) 1397 1439.5  1612.98 1467.0 1521.5
##      max neval
##  2456672   100
##  2305882   100
##     7285   100
