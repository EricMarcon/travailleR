...
##  f1(X)  35.756  39.0835  53.86901  40.0215  41.4290
##  f2(X)  42.843  46.4310  62.15868  47.6245  48.9755
##  f3(X) 268.188 276.3720 299.00896 278.1800 282.7230
##  f4(X) 397.877 410.3310 428.78500 412.1195 415.9410
##       max neval
##  1329.167   100
##  1376.008   100
##  1700.180   100
...
##                                    expr   median
## 1                              sqrt(x1)   4.6920
## 2                lapply(x1, FUN = sqrt) 296.8490
## 3                sapply(x1, FUN = sqrt) 350.9935
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 307.4650
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 vapply(x1, FUN = sqrt, 0) 299.6700
## 2                Boucle(x1)  77.7635
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 replicate(1000, runif(1)) 4109.716
## 2               runif(1000)   34.493
\end{verbatim}
...
\begin{verbatim}
##                              expr   median
## 1   BoucleSomme(diamonds[-(2:4)]) 3.733164
## 2 apply(diamonds[-(2:4)], 2, sum) 9.444744
## 3       colSums(diamonds[-(2:4)]) 2.551616
\end{verbatim}
...
##  2.094517 2.137704 3.667692 2.158936 2.294216 46.50302
##  neval
##    100
\end{verbatim}
...
Ce temps est à comparer à celui de la boucle for de référence, multiplié par 2500, soit \texttt{5000} secondes.
...
## Unit: nanoseconds
##                expr  min     lq     mean median   uq
##  triple.integer(2L)  321  331.5 22685.68  340.5  366
##   triple.numeric(2)  320  333.0 42666.58  344.5  366
##          triple(2L) 1282 1319.0  1516.99 1340.5 1438
##      max neval
##  2231993   100
##  4230007   100
##     7751   100
