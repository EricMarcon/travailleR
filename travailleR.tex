...
##  f1(X)  38.856  42.9055  70.70604  44.3080  50.4020
##  f2(X)  46.940  51.7890  85.26256  55.5310  58.0535
##  f3(X) 278.877 282.9520 380.49036 297.5225 333.6480
##  f4(X) 409.701 422.2470 536.77176 450.6655 492.4345
##       max neval
##  1456.129   100
##  1622.038   100
##  2181.725   100
...
##                                    expr   median
## 1                              sqrt(x1)   4.8035
## 2                lapply(x1, FUN = sqrt) 322.5160
## 3                sapply(x1, FUN = sqrt) 402.6935
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 325.2120
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 vapply(x1, FUN = sqrt, 0) 292.6065
## 2                Boucle(x1)  75.9765
\end{verbatim}
...
\begin{verbatim}
##                                               expr   median
## 1                        vapply(x1, FUN = sqrt, 0)  309.811
## 2 for (i in 1:length(x1)) Racine[i] <- sqrt(x1[i]) 4115.958
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 replicate(1000, runif(1)) 4003.795
## 2               runif(1000)   33.628
\end{verbatim}
...
\begin{verbatim}
##                              expr   median
## 1   BoucleSomme(diamonds[-(2:4)]) 3.852963
## 2 apply(diamonds[-(2:4)], 2, sum) 9.900164
## 3       colSums(diamonds[-(2:4)]) 2.604627
\end{verbatim}
...
##  784.078 788.3865 913.8448 793.5315 912.6985 2507.326   100
\end{verbatim}
...
Ce temps est à comparer à celui de la boucle for de référence, multiplié par 2500, soit \texttt{5072} secondes.
...
## Unit: nanoseconds
##                expr  min     lq     mean median     uq
##  triple.integer(2L)  334  345.5 23983.32  356.0  371.5
##   triple.numeric(2)  329  346.0 20072.43  360.0  383.5
##          triple(2L) 1346 1363.0  1500.75 1376.5 1435.5
##      max neval
##  2361452   100
##  1969661   100
##     6370   100
