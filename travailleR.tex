...
##  f1(X)  33.408  38.8975  80.69103  50.6640  63.9290
##  f2(X)  48.587  51.9545 107.31324  80.4310  91.5155
##  f3(X) 298.069 312.2715 526.03245 430.7760 460.5085
##  f4(X) 370.705 401.7040 724.82391 555.8315 602.5770
##       max neval
##  2019.021   100
##  2168.116   100
##  3472.755   100
...
##                                    expr   median
## 1                              sqrt(x1)   8.5860
## 2                lapply(x1, FUN = sqrt) 318.7380
## 3                sapply(x1, FUN = sqrt) 373.4830
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 328.1895
\end{verbatim}
...
\begin{verbatim}
##          expr   median
## 1  Boucle(x1) 717.5240
## 2 Boucle2(x1)  80.1205
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 vapply(x1, FUN = sqrt, 0) 378.6385
## 2                Boucle(x1)  89.0755
\end{verbatim}
...
\begin{verbatim}
##                                               expr   median
## 1                        vapply(x1, FUN = sqrt, 0)  387.693
## 2 for (i in 1:length(x1)) Racine[i] <- sqrt(x1[i]) 3300.853
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 replicate(1000, runif(1)) 3326.570
## 2               runif(1000)   20.716
\end{verbatim}
...
\begin{verbatim}
##                              expr   median
## 1   BoucleSomme(diamonds[-(2:4)]) 3.666290
## 2 apply(diamonds[-(2:4)], 2, sum) 9.969245
## 3       colSums(diamonds[-(2:4)]) 2.490531
\end{verbatim}
...
##  920.126 1014.46 1328.524 1325.329 1518.097 3850.576   100
\end{verbatim}
...
Ce temps est à comparer à celui de la boucle for de référence, multiplié par 2500, soit \texttt{6157} secondes.
...
## ● completed target NbPoints [1.944 seconds]
## ▶ dispatched target X
...
## ▶ completed pipeline [2.195 seconds]
\end{verbatim}
...
\begin{verbatim}
## ▶ dispatched target NbPoints
## ● completed target NbPoints [2.006 seconds]
## ▶ dispatched target X
## ● completed target X [0.005 seconds]
## ▶ dispatched target d
...
## ▶ completed pipeline [2.253 seconds]
\end{verbatim}
...
## Unit: nanoseconds
##                expr  min     lq      mean median     uq
##  triple.integer(2L)  496  634.5 189977.66  663.0  729.5
##   triple.numeric(2)  420  623.5 182260.21  662.0  762.0
##          triple(2L) 2081 2257.5   4091.96 2292.5 3299.0
##       max neval
##  18840831   100
##  18086758   100
##     25505   100
