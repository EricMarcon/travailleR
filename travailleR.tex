...
##  f1(X)  35.404  36.6625  55.46379  37.5465  39.2230 1735.900   100
##  f2(X)  44.094  46.1070  61.31290  47.0920  48.8130 1199.939   100
##  f3(X) 260.905 262.9730 281.22840 264.6965 270.5990 1432.511   100
##  f4(X) 386.839 390.2180 412.61331 395.7895 402.0695 1829.282   100
\end{verbatim}
...
##                                    expr   median
## 1                              sqrt(x1)   4.5315
## 2                lapply(x1, FUN = sqrt) 297.4225
## 3                sapply(x1, FUN = sqrt) 355.1820
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 295.4370
\end{verbatim}
...
\begin{verbatim}
##          expr   median
## 1  Boucle(x1) 763.7045
## 2 Boucle2(x1)  78.0185
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 vapply(x1, FUN = sqrt, 0) 294.3820
## 2                Boucle(x1)  78.2165
\end{verbatim}
...
\begin{verbatim}
##                                               expr    median
## 1                        vapply(x1, FUN = sqrt, 0)  296.8245
## 2 for (i in 1:length(x1)) Racine[i] <- sqrt(x1[i]) 3117.3055
\end{verbatim}
...
\begin{verbatim}
##                        expr    median
## 1 replicate(1000, runif(1)) 2493.8070
## 2               runif(1000)   31.1365
\end{verbatim}
...
\begin{verbatim}
##                              expr   median
## 1   BoucleSomme(diamonds[-(2:4)]) 2.958095
## 2 apply(diamonds[-(2:4)], 2, sum) 7.513386
## 3       colSums(diamonds[-(2:4)]) 2.298480
\end{verbatim}
...
La mise en place de la parallélisation a un coût de l'ordre du temps de calcul au-delà du quart de seconde attendu: environ \texttt{0.46} secondes ici.
...
## Unit: microseconds
##                                                      expr     min       lq
##  d <- TotalDistance(X$x, X$y)/NbPoints/(NbPoints - 1) * 2 651.676 680.8845
##      mean median       uq      max neval
##  985.5461 987.18 1017.128 2720.768   100
\end{verbatim}
...
## Unit: nanoseconds
##                expr  min     lq     mean median     uq     max neval
##  triple.integer(2L)  295  325.5 19953.91    349  420.5 1939765   100
##   triple.numeric(2)  304  318.0 19287.44    349  375.0 1887915   100
##          triple(2L) 1307 1369.5  2282.06   1455 1688.5   25470   100
\end{verbatim}
