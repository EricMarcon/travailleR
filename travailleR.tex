...
##  f1(X)  41.518  43.528  59.42872  44.7850  48.1025 1308.833
##  f2(X)  50.288  51.696  67.55504  53.2760  55.4160 1343.549
##  f3(X) 281.667 283.771 303.16838 285.8565 292.0070 1601.576
##  f4(X) 412.480 414.578 442.48940 416.6100 428.0965 1868.560
##  neval
##    100
##    100
##    100
...
##                                    expr   median
## 1                              sqrt(x1)   4.6780
## 2                lapply(x1, FUN = sqrt) 304.0830
## 3                sapply(x1, FUN = sqrt) 361.3545
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 298.5935
\end{verbatim}
...
\begin{verbatim}
##          expr   median
## 1  Boucle(x1) 948.8985
## 2 Boucle2(x1)  82.0645
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 vapply(x1, FUN = sqrt, 0) 300.9605
## 2                Boucle(x1)  78.1315
\end{verbatim}
...
\begin{verbatim}
##                                               expr   median
## 1                        vapply(x1, FUN = sqrt, 0)  300.658
## 2 for (i in 1:length(x1)) Racine[i] <- sqrt(x1[i]) 3478.837
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 replicate(1000, runif(1)) 3280.335
## 2               runif(1000)   33.522
\end{verbatim}
...
\begin{verbatim}
##                              expr    median
## 1   BoucleSomme(diamonds[-(2:4)])  3.857132
## 2 apply(diamonds[-(2:4)], 2, sum) 10.087797
## 3       colSums(diamonds[-(2:4)])  2.648178
\end{verbatim}
...
La mise en place de la parallélisation a un coût d'environ \texttt{0.02} secondes ici.
...
##  2.062969 2.08217 2.662455 2.15351 2.625782 12.4787   100
\end{verbatim}
...
Ce temps est à comparer à celui de la boucle for de référence, multiplié par 2500, soit \texttt{5627} secondes.
...
##  triple.integer(2L)  326  339.5 23581.37  362.5  405.5
##   triple.numeric(2)  324  333.0 20384.56  346.5  399.5
##          triple(2L) 1328 1367.0  1529.40 1436.5 1495.0
##      max neval
##  2319823   100
##  2001033   100
##     5533   100
