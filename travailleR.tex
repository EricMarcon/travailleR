...
##  f1(X)  36.177  38.0200  71.94909  39.6150  46.4390 1274.901   100
##  f2(X)  45.650  47.6730  71.20558  49.1275  53.7230 1298.309   100
##  f3(X) 268.560 270.7875 348.96494 276.3525 317.5860 1532.537   100
##  f4(X) 399.256 401.1815 489.66734 404.3505 428.1445 1945.793   100
\end{verbatim}
...
##                                    expr   median
## 1                              sqrt(x1)   4.8190
## 2                lapply(x1, FUN = sqrt) 301.6095
## 3                sapply(x1, FUN = sqrt) 356.8680
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 302.6605
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 vapply(x1, FUN = sqrt, 0) 303.5015
## 2                Boucle(x1)  80.7655
\end{verbatim}
...
\begin{verbatim}
##                                               expr    median
## 1                        vapply(x1, FUN = sqrt, 0)  300.7835
## 2 for (i in 1:length(x1)) Racine[i] <- sqrt(x1[i]) 3171.8375
\end{verbatim}
...
\begin{verbatim}
##                        expr    median
## 1 replicate(1000, runif(1)) 2924.4365
## 2               runif(1000)   32.9705
\end{verbatim}
...
\begin{verbatim}
##                              expr   median
## 1   BoucleSomme(diamonds[-(2:4)]) 3.100512
## 2 apply(diamonds[-(2:4)], 2, sum) 7.876457
## 3       colSums(diamonds[-(2:4)]) 2.422686
\end{verbatim}
...
La mise en place de la parallélisation a un coût de l'ordre du temps de calcul au-delà du quart de seconde attendu: environ \texttt{0.5} secondes ici.
...
## Unit: milliseconds
##                                                      expr     min      lq
##  d <- TotalDistance(X$x, X$y)/NbPoints/(NbPoints - 1) * 2 1.04757 1.98519
##      mean   median       uq     max neval
##  2.316966 2.001046 2.044088 12.6858   100
\end{verbatim}
...
## Unit: nanoseconds
##                expr  min     lq     mean median     uq     max neval
##  triple.integer(2L)  313  326.0 21561.97  338.0  359.0 2119970   100
##   triple.numeric(2)  310  324.0 17774.47  333.5  352.5 1743251   100
##          triple(2L) 1284 1317.5  1466.91 1342.0 1404.5    6354   100
\end{verbatim}
