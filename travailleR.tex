...
##  f1(X)   1.845   6.8470  59.93011   7.8515  12.5665
##  f2(X)   4.182   8.3025  39.85692   9.6555  13.3865
##  f3(X) 100.040 106.8050 143.10476 110.0645 122.3030
##  f4(X) 135.546 140.6505 228.85667 143.7665 163.5900
##       max neval
##  5004.952   100
##  2812.190   100
##  1850.986   100
...
##                                    expr   median
## 1                              sqrt(x1)   1.5580
## 2                lapply(x1, FUN = sqrt) 141.7780
## 3                sapply(x1, FUN = sqrt) 170.2730
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 136.5915
\end{verbatim}
...
\begin{verbatim}
##          expr   median
## 1  Boucle(x1) 363.1575
## 2 Boucle2(x1)  42.7630
\end{verbatim}
...
\begin{verbatim}
##                        expr  median
## 1 vapply(x1, FUN = sqrt, 0) 135.997
## 2                Boucle(x1)  42.271
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 replicate(1000, runif(1)) 743.8630
## 2               runif(1000)   6.3345
\end{verbatim}
...
\begin{verbatim}
##                              expr   median
## 1   BoucleSomme(diamonds[-(2:4)]) 1536.147
## 2 apply(diamonds[-(2:4)], 2, sum) 3427.088
## 3       colSums(diamonds[-(2:4)]) 1234.141
\end{verbatim}
...
##  302.744 316.274 487.2202 339.521 474.698 7300.87   100
\end{verbatim}
...
Ce temps est à comparer à celui de la boucle for de référence, multiplié par 2500, soit \texttt{3249} secondes.
...
## ● completed target NbPoints [0.797 seconds]
## ▶ dispatched target X
## ● completed target X [0.008 seconds]
## ▶ dispatched target d
## ● completed target d [0.026 seconds]
## ▶ dispatched target map
## ● completed target map [0.013 seconds]
## ▶ ended pipeline [0.979 seconds]
\end{verbatim}
...
\begin{verbatim}
## ▶ dispatched target NbPoints
## ● completed target NbPoints [0.771 seconds]
## ▶ dispatched target X
...
##  triple.integer(2L) 123 123 7234.86    164 164 708439   100
##   triple.numeric(2) 123 123 9896.99    164 164 966329   100
##          triple(2L) 533 574  610.90    574 574   3034   100
\end{verbatim}
