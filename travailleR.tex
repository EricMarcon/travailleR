...
##  f1(X)  36.284  38.6170  66.37786  41.5295  47.0690 1888.508   100
##  f2(X)  44.992  48.4895  76.37418  50.1255  55.9185 1428.444   100
##  f3(X) 269.588 272.4750 364.80454 301.8320 367.8700 1640.412   100
##  f4(X) 400.216 403.1690 510.76208 427.0995 506.1635 1978.979   100
\end{verbatim}
...
##                                    expr   median
## 1                              sqrt(x1)   4.8475
## 2                lapply(x1, FUN = sqrt) 309.5950
## 3                sapply(x1, FUN = sqrt) 374.1710
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 310.2640
\end{verbatim}
...
\begin{verbatim}
##          expr   median
## 1  Boucle(x1) 888.5065
## 2 Boucle2(x1)  83.5770
\end{verbatim}
...
\begin{verbatim}
##                        expr  median
## 1 vapply(x1, FUN = sqrt, 0) 296.666
## 2                Boucle(x1)  79.738
\end{verbatim}
...
\begin{verbatim}
##                                               expr    median
## 1                        vapply(x1, FUN = sqrt, 0)  314.3045
## 2 for (i in 1:length(x1)) Racine[i] <- sqrt(x1[i]) 3593.9530
\end{verbatim}
...
\begin{verbatim}
##                        expr    median
## 1 replicate(1000, runif(1)) 4150.0555
## 2               runif(1000)   35.7245
\end{verbatim}
...
\begin{verbatim}
##                              expr   median
## 1   BoucleSomme(diamonds[-(2:4)]) 3.240830
## 2 apply(diamonds[-(2:4)], 2, sum) 8.204076
## 3       colSums(diamonds[-(2:4)]) 2.533774
\end{verbatim}
...
## Unit: microseconds
##                                                      expr     min      lq
##  d <- TotalDistance(X$x, X$y)/NbPoints/(NbPoints - 1) * 2 650.272 669.304
##      mean   median       uq      max neval
##  760.3016 674.3565 707.9095 2261.137   100
\end{verbatim}
...
Ce temps est à comparer à celui de la boucle for de référence, multiplié par 2500, soit \texttt{4664} secondes.
...
## Unit: nanoseconds
##                expr  min     lq     mean median     uq     max neval
##  triple.integer(2L)  305  315.0   365.90  332.5  361.0    1012   100
##   triple.numeric(2)  307  320.5 17773.58  326.5  354.5 1742553   100
##          triple(2L) 1285 1322.5 22393.07 1337.5 1374.5 2098507   100
\end{verbatim}
