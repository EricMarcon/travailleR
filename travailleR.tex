...
##  f1(X)  35.401  37.6500  54.73783  39.6895  42.5595 1380.568   100
##  f2(X)  43.116  45.6480 104.30229  47.1150  50.2360 4065.934   100
##  f3(X) 274.262 276.8205 301.10260 278.8560 283.5920 1508.730   100
##  f4(X) 404.843 408.9010 452.14753 410.8750 418.1500 2285.774   100
\end{verbatim}
...
##                                    expr   median
## 1                              sqrt(x1)   4.6755
## 2                lapply(x1, FUN = sqrt) 294.9200
## 3                sapply(x1, FUN = sqrt) 348.6240
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 294.2695
\end{verbatim}
...
\begin{verbatim}
##          expr   median
## 1  Boucle(x1) 770.8915
## 2 Boucle2(x1)  81.5935
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 vapply(x1, FUN = sqrt, 0) 292.3725
## 2                Boucle(x1)  80.2930
\end{verbatim}
...
\begin{verbatim}
##                                               expr   median
## 1                        vapply(x1, FUN = sqrt, 0)  296.010
## 2 for (i in 1:length(x1)) Racine[i] <- sqrt(x1[i]) 3336.007
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 replicate(1000, runif(1)) 4191.822
## 2               runif(1000)   34.657
\end{verbatim}
...
\begin{verbatim}
##                              expr   median
## 1   BoucleSomme(diamonds[-(2:4)]) 3.536517
## 2 apply(diamonds[-(2:4)], 2, sum) 9.039155
## 3       colSums(diamonds[-(2:4)]) 2.397553
\end{verbatim}
...
## Unit: microseconds
##                                                      expr     min       lq
##  d <- TotalDistance(X$x, X$y)/NbPoints/(NbPoints - 1) * 2 779.892 1449.168
##      mean   median      uq      max neval
##  1953.118 2059.011 2347.28 7403.044   100
\end{verbatim}
...
Ce temps est à comparer à celui de la boucle for de référence, multiplié par 2500, soit \texttt{4799} secondes.
...
## Unit: nanoseconds
##                expr  min   lq     mean median     uq     max neval
##  triple.integer(2L)  307  317   369.35  330.5  384.0    1105   100
##   triple.numeric(2)  311  324 21527.51  342.0  383.5 2116464   100
##          triple(2L) 1297 1334 26339.62 1355.0 1403.5 2489860   100
\end{verbatim}
