...
##  f1(X)  41.924  45.5705  74.67828  49.1030  58.6660
##  f2(X)  49.315  52.7020  82.86950  56.3385  70.2550
##  f3(X) 281.281 287.2260 336.72999 307.1390 335.9295
##  f4(X) 414.053 418.6850 489.98049 451.8755 502.0090
##       max neval
##  1862.857   100
##  1924.523   100
##  2208.497   100
...
##                                    expr   median
## 1                              sqrt(x1)   4.6505
## 2                lapply(x1, FUN = sqrt) 306.2350
## 3                sapply(x1, FUN = sqrt) 364.6395
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 297.1170
\end{verbatim}
...
\begin{verbatim}
##          expr   median
## 1  Boucle(x1) 817.2610
## 2 Boucle2(x1)  78.7605
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 vapply(x1, FUN = sqrt, 0) 300.6650
## 2                Boucle(x1)  77.7185
\end{verbatim}
...
\begin{verbatim}
##                        expr    median
## 1 replicate(1000, runif(1)) 4391.2425
## 2               runif(1000)   35.8585
\end{verbatim}
...
\begin{verbatim}
##                              expr   median
## 1   BoucleSomme(diamonds[-(2:4)]) 3.870609
## 2 apply(diamonds[-(2:4)], 2, sum) 9.990844
## 3       colSums(diamonds[-(2:4)]) 2.630953
\end{verbatim}
...
La mise en place de la parallélisation a un coût d'environ \texttt{0.022} secondes ici.
...
##  773.832 777.908 908.7529 786.489 815.415 3551.169   100
\end{verbatim}
...
Ce temps est à comparer à celui de la boucle for de référence, multiplié par 2500, soit \texttt{5100} secondes.
...
##  triple.integer(2L)  325  330 23592.69  339.5  351 2324440
##   triple.numeric(2)  323  333 20337.73  340.0  350 1997869
##          triple(2L) 1339 1356  1486.21 1370.5 1444    6508
##  neval
##    100
##    100
##    100
