...
\newcommand{\MainTitlePage}[2]{
  ...
  \end{textblock*}
  \begin{textblock*}{\paperwidth*2/3}(\paperwidth/5, \paperheight/4)
    \flushright
    \begin{Spacing}{3}
...
##  f1(X)  36.002  37.5845  51.33206  38.1120  40.0490
##  f2(X)  43.311  45.1065  58.77057  45.7585  47.4625
##  f3(X) 273.924 275.7620 290.16639 276.8965 279.1465
##  f4(X) 406.203 408.4615 425.50323 409.4740 412.9260
##       max neval
##  1234.852   100
##  1178.179   100
##  1470.786   100
...
##                                    expr   median
## 1                              sqrt(x1)   4.7865
## 2                lapply(x1, FUN = sqrt) 307.3950
## 3                sapply(x1, FUN = sqrt) 361.4165
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 308.3355
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 vapply(x1, FUN = sqrt, 0) 307.0945
## 2                Boucle(x1)  78.7265
\end{verbatim}
...
\begin{verbatim}
##                                               expr   median
## 1                        vapply(x1, FUN = sqrt, 0)  302.977
## 2 for (i in 1:length(x1)) Racine[i] <- sqrt(x1[i]) 3230.695
\end{verbatim}
...
\begin{verbatim}
##                        expr    median
## 1 replicate(1000, runif(1)) 4046.3890
## 2               runif(1000)   34.4705
\end{verbatim}
...
\begin{verbatim}
##                              expr   median
## 1   BoucleSomme(diamonds[-(2:4)]) 3.568095
## 2 apply(diamonds[-(2:4)], 2, sum) 9.055384
## 3       colSums(diamonds[-(2:4)]) 2.417275
\end{verbatim}
...
La mise en place de la parallélisation a un coût d'environ \texttt{0.099} secondes ici.
...
##  770.883 776.2955 1027.319 781.761 1029.917 3771.849   100
\end{verbatim}
...
Ce temps est à comparer à celui de la boucle for de référence, multiplié par 2500, soit \texttt{4740} secondes.
...
## Unit: nanoseconds
##                expr  min     lq     mean median     uq
##  triple.integer(2L)  320  330.0 24617.13    337  359.5
##   triple.numeric(2)  318  331.0 22710.14    344  371.5
##          triple(2L) 1264 1302.5  1582.77   1321 1403.5
##      max neval
##  2426372   100
##  2233674   100
##    15748   100
