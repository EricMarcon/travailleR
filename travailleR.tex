...
##  f1(X)  36.702  37.8755  57.05417  38.7450  41.7275 1640.255   100
##  f2(X)  46.359  47.7630  62.50595  48.6295  50.2760 1227.233   100
##  f3(X) 268.879 270.8865 287.69809 271.7560 276.8245 1462.244   100
##  f4(X) 399.761 401.5545 429.98891 402.8450 410.4245 1905.921   100
\end{verbatim}
...
##                                    expr   median
## 1                              sqrt(x1)   4.6050
## 2                lapply(x1, FUN = sqrt) 300.5115
## 3                sapply(x1, FUN = sqrt) 355.5755
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 300.5120
\end{verbatim}
...
\begin{verbatim}
##          expr   median
## 1  Boucle(x1) 778.7800
## 2 Boucle2(x1)  80.6165
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 vapply(x1, FUN = sqrt, 0) 298.5050
## 2                Boucle(x1)  78.7975
\end{verbatim}
...
\begin{verbatim}
##                                               expr    median
## 1                        vapply(x1, FUN = sqrt, 0)  311.4225
## 2 for (i in 1:length(x1)) Racine[i] <- sqrt(x1[i]) 3590.8040
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 replicate(1000, runif(1)) 3837.977
## 2               runif(1000)   35.098
\end{verbatim}
...
\begin{verbatim}
##                              expr   median
## 1   BoucleSomme(diamonds[-(2:4)]) 3.216047
## 2 apply(diamonds[-(2:4)], 2, sum) 8.001591
## 3       colSums(diamonds[-(2:4)]) 2.492667
\end{verbatim}
...
## Unit: microseconds
##                                                      expr     min      lq
##  d <- TotalDistance(X$x, X$y)/NbPoints/(NbPoints - 1) * 2 705.007 998.298
##      mean  median       uq      max neval
##  1146.079 1178.82 1264.349 2576.304   100
\end{verbatim}
...
Ce temps est à comparer à celui de la boucle for de référence, multiplié par 2500, soit \texttt{4437} secondes.
...
## Unit: nanoseconds
##                expr  min     lq     mean median   uq     max neval
##  triple.integer(2L)  308  313.0   368.35  328.0  347    1050   100
##   triple.numeric(2)  307  323.0 22769.42  328.0  354 2241678   100
##          triple(2L) 1352 1385.5 24073.89 1406.5 1458 2255632   100
\end{verbatim}
