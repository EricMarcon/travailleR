...
##  f1(X)  35.875  37.4660  53.10341  38.1470  39.4935 1382.726   100
##  f2(X)  45.791  47.4165  74.52226  48.1335  49.3625 2541.507   100
##  f3(X) 262.031 268.7430 284.97282 271.3395 273.7825 1591.281   100
##  f4(X) 389.195 400.0755 421.45332 403.0220 408.6830 1886.454   100
\end{verbatim}
...
##                                    expr   median
## 1                              sqrt(x1)   4.7610
## 2                lapply(x1, FUN = sqrt) 302.3010
## 3                sapply(x1, FUN = sqrt) 358.5475
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 302.9070
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 vapply(x1, FUN = sqrt, 0) 295.8925
## 2                Boucle(x1)  77.8650
\end{verbatim}
...
\begin{verbatim}
##                                               expr   median
## 1                        vapply(x1, FUN = sqrt, 0)  311.026
## 2 for (i in 1:length(x1)) Racine[i] <- sqrt(x1[i]) 3232.565
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 replicate(1000, runif(1)) 2619.183
## 2               runif(1000)   32.520
\end{verbatim}
...
\begin{verbatim}
##                              expr   median
## 1   BoucleSomme(diamonds[-(2:4)]) 3.086902
## 2 apply(diamonds[-(2:4)], 2, sum) 7.833168
## 3       colSums(diamonds[-(2:4)]) 2.430625
\end{verbatim}
...
La mise en place de la parallélisation a un coût de l'ordre du temps de calcul au-delà du quart de seconde attendu: environ \texttt{0.38} secondes ici.
...
## Unit: microseconds
##                                                      expr     min       lq
##  d <- TotalDistance(X$x, X$y)/NbPoints/(NbPoints - 1) * 2 666.991 671.0855
##      mean   median       uq     max neval
##  1342.313 675.8175 688.8665 31737.6   100
\end{verbatim}
...
## Unit: nanoseconds
##                expr  min   lq     mean median     uq     max neval
##  triple.integer(2L)  311  327 21256.04  332.0  368.0 2089556   100
##   triple.numeric(2)  310  324 17693.50  332.5  360.0 1734824   100
##          triple(2L) 1341 1375  1504.37 1400.5 1475.5    5858   100
\end{verbatim}
