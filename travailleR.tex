...
##  f1(X)  38.535  41.4265  57.68406  43.2420  45.5965
##  f2(X)  46.549  50.0140 125.31252  51.5720  52.7190
##  f3(X) 271.814 279.1520 399.31427 283.7160 291.7360
##  f4(X) 399.320 403.7260 625.37734 414.6785 424.1400
##       max neval
##  1296.007   100
##  6124.902   100
##  9881.395   100
...
##                                    expr   median
## 1                              sqrt(x1)   4.7075
## 2                lapply(x1, FUN = sqrt) 302.0605
## 3                sapply(x1, FUN = sqrt) 361.4555
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 298.7145
\end{verbatim}
...
\begin{verbatim}
##          expr   median
## 1  Boucle(x1) 818.4205
## 2 Boucle2(x1)  76.8860
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 vapply(x1, FUN = sqrt, 0) 283.7635
## 2                Boucle(x1)  75.5015
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 replicate(1000, runif(1)) 4292.167
## 2               runif(1000)   35.443
\end{verbatim}
...
\begin{verbatim}
##                              expr    median
## 1   BoucleSomme(diamonds[-(2:4)])  4.035064
## 2 apply(diamonds[-(2:4)], 2, sum) 15.354553
## 3       colSums(diamonds[-(2:4)])  2.618761
\end{verbatim}
...
##  835.932 916.4865 1004.458 942.165 972.044 2708.176   100
\end{verbatim}
...
Ce temps est à comparer à celui de la boucle for de référence, multiplié par 2500, soit \texttt{4849} secondes.
...
## Unit: nanoseconds
##                expr  min     lq     mean median     uq
##  triple.integer(2L)  348  358.0 26298.83  370.0  393.5
##   triple.numeric(2)  344  352.0 24972.71  366.5  392.0
##          triple(2L) 1361 1392.5  1587.93 1406.5 1490.5
##      max neval
##  2591388   100
##  2451683   100
##     7852   100
