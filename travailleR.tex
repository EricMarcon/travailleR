...
##  f1(X)  34.613  38.3895  56.44076  39.6685  42.9935 1292.037   100
##  f2(X)  42.434  45.7535  61.10046  47.2310  48.8845 1297.380   100
##  f3(X) 273.947 277.1915 303.41685 279.2600 290.5710 1621.625   100
##  f4(X) 404.726 408.2100 433.46348 411.3765 425.7175 1893.823   100
\end{verbatim}
...
##                                    expr   median
## 1                              sqrt(x1)   4.6475
## 2                lapply(x1, FUN = sqrt) 313.8435
## 3                sapply(x1, FUN = sqrt) 365.0695
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 306.2185
\end{verbatim}
...
\begin{verbatim}
##          expr   median
## 1  Boucle(x1) 786.1560
## 2 Boucle2(x1)  81.6665
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 vapply(x1, FUN = sqrt, 0) 304.9605
## 2                Boucle(x1)  80.1470
\end{verbatim}
...
\begin{verbatim}
##                                               expr   median
## 1                        vapply(x1, FUN = sqrt, 0)  305.997
## 2 for (i in 1:length(x1)) Racine[i] <- sqrt(x1[i]) 3280.329
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 replicate(1000, runif(1)) 4205.910
## 2               runif(1000)   36.032
\end{verbatim}
...
\begin{verbatim}
##                              expr   median
## 1   BoucleSomme(diamonds[-(2:4)]) 3.577574
## 2 apply(diamonds[-(2:4)], 2, sum) 9.142450
## 3       colSums(diamonds[-(2:4)]) 2.409623
\end{verbatim}
...
## Unit: microseconds
##                                                      expr     min      lq
##  d <- TotalDistance(X$x, X$y)/NbPoints/(NbPoints - 1) * 2 767.855 933.337
##      mean   median       uq      max neval
##  1252.452 1171.438 1252.174 2480.661   100
\end{verbatim}
...
Ce temps est à comparer à celui de la boucle for de référence, multiplié par 2500, soit \texttt{4924} secondes.
...
## Unit: nanoseconds
##                expr  min   lq     mean median     uq     max neval
##  triple.integer(2L)  309  318   367.15  333.5  380.5    1041   100
##   triple.numeric(2)  312  326 19124.13  339.0  390.0 1874542   100
##          triple(2L) 1394 1428 23599.87 1453.5 1522.0 2197652   100
\end{verbatim}
