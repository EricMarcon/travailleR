...
##  f1(X)  37.218  39.2195  59.52688  41.7100  48.4300 1350.816   100
##  f2(X)  46.722  49.3675  72.54443  51.7270  59.7900 1540.887   100
##  f3(X) 269.706 273.6275 344.81873 283.6165 347.7385 1873.223   100
##  f4(X) 399.743 404.3030 521.14112 417.8300 534.0210 1913.290   100
\end{verbatim}
...
##                                    expr   median
## 1                              sqrt(x1)   4.9945
## 2                lapply(x1, FUN = sqrt) 338.7550
## 3                sapply(x1, FUN = sqrt) 404.3870
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 330.1425
\end{verbatim}
...
\begin{verbatim}
##          expr   median
## 1  Boucle(x1) 839.7835
## 2 Boucle2(x1)  84.5205
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 vapply(x1, FUN = sqrt, 0) 300.1045
## 2                Boucle(x1)  80.4735
\end{verbatim}
...
\begin{verbatim}
##                                               expr    median
## 1                        vapply(x1, FUN = sqrt, 0)  310.8675
## 2 for (i in 1:length(x1)) Racine[i] <- sqrt(x1[i]) 4032.3165
\end{verbatim}
...
\begin{verbatim}
##                        expr    median
## 1 replicate(1000, runif(1)) 4195.5135
## 2               runif(1000)   34.3715
\end{verbatim}
...
\begin{verbatim}
##                              expr   median
## 1   BoucleSomme(diamonds[-(2:4)]) 3.514143
## 2 apply(diamonds[-(2:4)], 2, sum) 9.037549
## 3       colSums(diamonds[-(2:4)]) 2.683566
\end{verbatim}
...
## Unit: microseconds
##                                                      expr     min       lq
##  d <- TotalDistance(X$x, X$y)/NbPoints/(NbPoints - 1) * 2 669.418 679.2285
##      mean   median      uq      max neval
##  769.7757 694.9945 791.288 2336.291   100
\end{verbatim}
...
## Unit: nanoseconds
##                expr  min     lq     mean median     uq     max neval
##  triple.integer(2L)  309  316.0   375.65    329  362.5    1350   100
##   triple.numeric(2)  308  323.5 23523.20    332  361.0 2316724   100
##          triple(2L) 1345 1368.5 26814.62   1400 1444.0 2528903   100
\end{verbatim}
