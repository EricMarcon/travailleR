...
##  f1(X)  39.802  41.5200  60.84938  43.8940  48.6005
##  f2(X)  48.019  49.4060  67.01033  51.1060  54.7130
##  f3(X) 282.264 290.4075 312.04737 293.8985 301.1990
##  f4(X) 416.750 430.6810 459.85550 435.2025 447.8455
##       max neval
##  1349.677   100
##  1434.844   100
##  1630.990   100
...
##                                    expr   median
## 1                              sqrt(x1)   4.6475
## 2                lapply(x1, FUN = sqrt) 302.3090
## 3                sapply(x1, FUN = sqrt) 361.1685
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 297.0640
\end{verbatim}
...
\begin{verbatim}
##          expr   median
## 1  Boucle(x1) 813.4665
## 2 Boucle2(x1)  78.7475
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 vapply(x1, FUN = sqrt, 0) 291.5385
## 2                Boucle(x1)  77.4650
\end{verbatim}
...
\begin{verbatim}
##                                               expr   median
## 1                        vapply(x1, FUN = sqrt, 0)  307.210
## 2 for (i in 1:length(x1)) Racine[i] <- sqrt(x1[i]) 3416.021
\end{verbatim}
...
\begin{verbatim}
##                        expr    median
## 1 replicate(1000, runif(1)) 3188.1525
## 2               runif(1000)   33.7565
\end{verbatim}
...
\begin{verbatim}
##                              expr   median
## 1   BoucleSomme(diamonds[-(2:4)]) 3.676977
## 2 apply(diamonds[-(2:4)], 2, sum) 9.522935
## 3       colSums(diamonds[-(2:4)]) 2.500803
\end{verbatim}
...
La mise en place de la parallélisation a un coût d'environ \texttt{0.057} secondes ici.
...
##  769.888 888.137 1124.572 959.886 1160.427 3473.887   100
\end{verbatim}
...
Ce temps est à comparer à celui de la boucle for de référence, multiplié par 2500, soit \texttt{5510} secondes.
...
## Unit: nanoseconds
##                expr  min     lq     mean median     uq
##  triple.integer(2L)  326  334.0 27219.93  340.5  355.0
##   triple.numeric(2)  326  331.0 20257.49  344.0  359.0
##          triple(2L) 1347 1358.5  1484.14 1375.5 1415.5
##      max neval
##  2686908   100
##  1989922   100
##     6726   100
