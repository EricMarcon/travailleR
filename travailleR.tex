...
##  f1(X)  38.321  41.6150  57.95106  43.6350  46.2780
##  f2(X)  47.596  49.8990  67.90378  51.4305  56.2845
##  f3(X) 276.623 281.2775 304.26661 285.8795 292.2925
##  f4(X) 411.144 415.0140 443.44620 421.8570 433.9420
##       max neval
##  1286.237   100
##  1420.475   100
##  1851.762   100
...
##                                    expr   median
## 1                              sqrt(x1)   4.6025
## 2                lapply(x1, FUN = sqrt) 305.9085
## 3                sapply(x1, FUN = sqrt) 366.0535
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 297.8595
\end{verbatim}
...
\begin{verbatim}
##          expr   median
## 1  Boucle(x1) 851.7015
## 2 Boucle2(x1)  78.6525
\end{verbatim}
...
\begin{verbatim}
##                        expr  median
## 1 vapply(x1, FUN = sqrt, 0) 303.924
## 2                Boucle(x1)  76.568
\end{verbatim}
...
\begin{verbatim}
##                                               expr   median
## 1                        vapply(x1, FUN = sqrt, 0)  308.978
## 2 for (i in 1:length(x1)) Racine[i] <- sqrt(x1[i]) 3610.893
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 replicate(1000, runif(1)) 4297.887
## 2               runif(1000)   33.781
\end{verbatim}
...
\begin{verbatim}
##                              expr   median
## 1   BoucleSomme(diamonds[-(2:4)]) 3.824472
## 2 apply(diamonds[-(2:4)], 2, sum) 9.798455
## 3       colSums(diamonds[-(2:4)]) 2.578881
\end{verbatim}
...
##  779.633 885.3555 1127.122 915.284 1281.08 2573.438   100
\end{verbatim}
...
Ce temps est à comparer à celui de la boucle for de référence, multiplié par 2500, soit \texttt{5024} secondes.
...
## Unit: nanoseconds
##                expr  min   lq     mean median     uq
##  triple.integer(2L)  333  346 23799.26  357.5  380.0
##   triple.numeric(2)  336  346 21341.21  366.0  393.5
##          triple(2L) 1353 1375  1506.29 1384.5 1435.0
##      max neval
##  2342942   100
##  2095442   100
##     6063   100
