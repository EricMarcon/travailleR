...
##  f1(X)  40.773  43.9460  61.41874  45.0390  48.8110
##  f2(X)  49.639  51.7440  71.18809  53.0065  56.2560
##  f3(X) 282.276 285.4755 307.38346 289.6260 299.5635
##  f4(X) 412.273 415.6545 439.50582 419.8730 431.2210
##       max neval
##  1447.984   100
##  1597.604   100
##  1625.892   100
...
##                                    expr   median
## 1                              sqrt(x1)   4.7370
## 2                lapply(x1, FUN = sqrt) 297.4555
## 3                sapply(x1, FUN = sqrt) 349.4520
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 307.6030
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 vapply(x1, FUN = sqrt, 0) 300.8145
## 2                Boucle(x1)  77.3400
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 replicate(1000, runif(1)) 4657.162
## 2               runif(1000)   33.254
\end{verbatim}
...
\begin{verbatim}
##                              expr   median
## 1   BoucleSomme(diamonds[-(2:4)]) 3.805960
## 2 apply(diamonds[-(2:4)], 2, sum) 9.824594
## 3       colSums(diamonds[-(2:4)]) 2.614542
\end{verbatim}
...
##  751.242 756.2265 885.8272 765.8185 786.207 3705.189   100
\end{verbatim}
...
Ce temps est à comparer à celui de la boucle for de référence, multiplié par 2500, soit \texttt{7122} secondes.
...
## Unit: nanoseconds
##                expr  min     lq     mean median     uq
##  triple.integer(2L)  324  331.5 22809.04  341.0  354.0
##   triple.numeric(2)  321  334.0 19678.49  342.0  362.0
##          triple(2L) 1310 1341.0  1476.47 1368.5 1419.5
##      max neval
##  2246122   100
##  1932207   100
##     6232   100
...
\begin{center}\includegraphics[width=0.8\linewidth]{travailleR_files/figure-latex/unnamed-chunk-115-1} \end{center}
...
\begin{center}\includegraphics[width=0.8\linewidth]{travailleR_files/figure-latex/unnamed-chunk-115-2} \end{center}
