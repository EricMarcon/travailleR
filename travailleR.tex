...
##  f1(X)  40.264  42.1050  59.83202  43.1590  45.5975
##  f2(X)  48.365  50.0405  66.01722  51.5000  55.9130
##  f3(X) 280.419 282.1300 303.93149 283.4980 289.9905
##  f4(X) 412.095 414.4700 435.81145 415.8605 420.5385
##       max neval
##  1306.227   100
##  1281.706   100
##  1597.531   100
...
##                                    expr   median
## 1                              sqrt(x1)   4.6015
## 2                lapply(x1, FUN = sqrt) 304.5755
## 3                sapply(x1, FUN = sqrt) 362.0145
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 297.4175
\end{verbatim}
...
\begin{verbatim}
##          expr   median
## 1  Boucle(x1) 820.5170
## 2 Boucle2(x1)  78.9525
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 vapply(x1, FUN = sqrt, 0) 291.3365
## 2                Boucle(x1)  77.4700
\end{verbatim}
...
\begin{verbatim}
##                                               expr   median
## 1                        vapply(x1, FUN = sqrt, 0)  297.002
## 2 for (i in 1:length(x1)) Racine[i] <- sqrt(x1[i]) 3359.762
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 replicate(1000, runif(1)) 3725.555
## 2               runif(1000)   34.500
\end{verbatim}
...
\begin{verbatim}
##                              expr   median
## 1   BoucleSomme(diamonds[-(2:4)]) 3.739100
## 2 apply(diamonds[-(2:4)], 2, sum) 9.793882
## 3       colSums(diamonds[-(2:4)]) 2.582662
\end{verbatim}
...
##  771.316 775.681 885.0431 777.2185 781.8505 3738.794   100
\end{verbatim}
...
Ce temps est à comparer à celui de la boucle for de référence, multiplié par 2500, soit \texttt{5444} secondes.
...
## Unit: nanoseconds
##                expr  min   lq     mean median     uq
##  triple.integer(2L)  327  336 35169.11    344  359.5
##   triple.numeric(2)  324  336 26595.38    349  365.0
##          triple(2L) 1329 1358  1778.60   1398 1469.5
##      max neval
##  3480250   100
##  2516758   100
##    21773   100
