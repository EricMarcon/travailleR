...
##  f1(X)  35.168  37.0420  60.86424  38.2640  40.3245  1925.429   100
##  f2(X)  43.018  44.9070  72.28034  45.8260  47.5140  2565.403   100
##  f3(X) 273.951 276.1265 342.94596 277.2490 284.0350  6029.356   100
##  f4(X) 407.031 409.4960 597.99885 412.8325 417.9690 15427.587   100
\end{verbatim}
...
##                                    expr   median
## 1                              sqrt(x1)   4.5785
## 2                lapply(x1, FUN = sqrt) 293.1035
## 3                sapply(x1, FUN = sqrt) 346.3305
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 291.1870
\end{verbatim}
...
\begin{verbatim}
##          expr   median
## 1  Boucle(x1) 787.2220
## 2 Boucle2(x1)  78.2525
\end{verbatim}
...
\begin{verbatim}
##                        expr  median
## 1 vapply(x1, FUN = sqrt, 0) 288.674
## 2                Boucle(x1)  78.036
\end{verbatim}
...
\begin{verbatim}
##                                               expr   median
## 1                        vapply(x1, FUN = sqrt, 0)  292.349
## 2 for (i in 1:length(x1)) Racine[i] <- sqrt(x1[i]) 3421.339
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 replicate(1000, runif(1)) 4085.065
## 2               runif(1000)   34.139
\end{verbatim}
...
\begin{verbatim}
##                              expr   median
## 1   BoucleSomme(diamonds[-(2:4)]) 3.472114
## 2 apply(diamonds[-(2:4)], 2, sum) 8.895450
## 3       colSums(diamonds[-(2:4)]) 2.366926
\end{verbatim}
...
## Unit: microseconds
##                                                      expr     min       lq
##  d <- TotalDistance(X$x, X$y)/NbPoints/(NbPoints - 1) * 2 874.296 1003.328
##      mean   median       uq      max neval
##  1324.355 1016.142 1312.104 5606.715   100
\end{verbatim}
...
Ce temps est à comparer à celui de la boucle for de référence, multiplié par 2500, soit \texttt{4582} secondes.
...
## Unit: nanoseconds
##                expr  min   lq     mean median     uq     max neval
##  triple.integer(2L)  322  338   387.74  354.5  401.0    1312   100
##   triple.numeric(2)  319  329 17887.32  346.5  400.5 1751846   100
##          triple(2L) 1332 1350 22169.95 1383.0 1432.0 2072818   100
\end{verbatim}
