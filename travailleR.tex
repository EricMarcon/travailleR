...
##  f1(X)  35.871  38.1645  52.97788  39.5485  41.3630
##  f2(X)  44.406  46.3110  62.23715  47.4505  50.8435
##  f3(X) 274.681 277.9815 296.64802 279.9975 285.7205
##  f4(X) 408.275 411.3005 435.11486 412.9820 419.5595
##       max neval
##  1292.633   100
##  1329.570   100
##  1599.519   100
...
##                                    expr   median
## 1                              sqrt(x1)   4.6565
## 2                lapply(x1, FUN = sqrt) 298.0075
## 3                sapply(x1, FUN = sqrt) 353.1345
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 299.6030
\end{verbatim}
...
\begin{verbatim}
##          expr   median
## 1  Boucle(x1) 807.9785
## 2 Boucle2(x1)  78.2160
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 vapply(x1, FUN = sqrt, 0) 292.1805
## 2                Boucle(x1)  77.3610
\end{verbatim}
...
\begin{verbatim}
##                                               expr   median
## 1                        vapply(x1, FUN = sqrt, 0)  298.229
## 2 for (i in 1:length(x1)) Racine[i] <- sqrt(x1[i]) 3445.041
\end{verbatim}
...
\begin{verbatim}
##                        expr    median
## 1 replicate(1000, runif(1)) 4085.9530
## 2               runif(1000)   35.2095
\end{verbatim}
...
\begin{verbatim}
##                              expr   median
## 1   BoucleSomme(diamonds[-(2:4)]) 3.946981
## 2 apply(diamonds[-(2:4)], 2, sum) 9.818953
## 3       colSums(diamonds[-(2:4)]) 2.527478
\end{verbatim}
...
##  777.984 853.318 932.2621 898.728 945.3415 2609.547   100
\end{verbatim}
...
Ce temps est à comparer à celui de la boucle for de référence, multiplié par 2500, soit \texttt{4744} secondes.
...
## Unit: nanoseconds
##                expr  min     lq     mean median     uq
##  triple.integer(2L)  315  323.5 21583.03  333.5  342.5
##   triple.numeric(2)  314  325.0 18918.14  335.0  348.0
##          triple(2L) 1322 1339.0  1447.45 1349.0 1401.0
##      max neval
##  2124904   100
##  1857311   100
##     5773   100
