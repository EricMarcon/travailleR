...
##  f1(X)  36.370  38.0915  56.26662  38.9820  40.8565 1573.095   100
##  f2(X)  46.482  48.0610  70.51292  48.8040  51.3240 1574.255   100
##  f3(X) 269.053 270.7225 295.47810 271.8545 278.1935 1527.485   100
##  f4(X) 399.800 401.4590 433.49891 402.3605 409.1460 2009.675   100
\end{verbatim}
...
##                                    expr   median
## 1                              sqrt(x1)   4.6835
## 2                lapply(x1, FUN = sqrt) 312.5685
## 3                sapply(x1, FUN = sqrt) 359.9025
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 301.7510
\end{verbatim}
...
\begin{verbatim}
##          expr   median
## 1  Boucle(x1) 792.1310
## 2 Boucle2(x1)  81.1695
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 vapply(x1, FUN = sqrt, 0) 296.8290
## 2                Boucle(x1)  79.7085
\end{verbatim}
...
\begin{verbatim}
##                                               expr    median
## 1                        vapply(x1, FUN = sqrt, 0)  301.1955
## 2 for (i in 1:length(x1)) Racine[i] <- sqrt(x1[i]) 3212.9420
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 replicate(1000, runif(1)) 4101.137
## 2               runif(1000)   34.901
\end{verbatim}
...
\begin{verbatim}
##                              expr   median
## 1   BoucleSomme(diamonds[-(2:4)]) 3.151980
## 2 apply(diamonds[-(2:4)], 2, sum) 7.886861
## 3       colSums(diamonds[-(2:4)]) 2.473121
\end{verbatim}
...
## Unit: microseconds
##                                                      expr     min       lq
##  d <- TotalDistance(X$x, X$y)/NbPoints/(NbPoints - 1) * 2 667.033 673.4135
##     mean  median      uq     max neval
##  774.923 688.072 803.138 2496.04   100
\end{verbatim}
...
Ce temps est à comparer à celui de la boucle for de référence, multiplié par 2500, soit \texttt{4612} secondes.
...
## Unit: nanoseconds
##                expr  min   lq     mean median     uq     max neval
##  triple.integer(2L)  309  321   360.89  332.0  355.5    1003   100
##   triple.numeric(2)  308  324 18002.35  332.5  354.5 1765475   100
##          triple(2L) 1283 1333 22341.91 1346.0 1404.0 2091471   100
\end{verbatim}
