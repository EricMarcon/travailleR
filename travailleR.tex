...
##  f1(X)  35.188  37.8635  52.38261  38.8285  40.8685 1280.162   100
##  f2(X)  42.166  45.1205  59.37738  46.0030  47.9620 1278.124   100
##  f3(X) 273.233 275.9045 294.05833 277.5185 285.6460 1576.425   100
##  f4(X) 406.074 408.7455 440.47585 412.8835 424.6525 1857.409   100
\end{verbatim}
...
##                                    expr   median
## 1                              sqrt(x1)   4.7510
## 2                lapply(x1, FUN = sqrt) 296.9820
## 3                sapply(x1, FUN = sqrt) 349.9680
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 293.4965
\end{verbatim}
...
\begin{verbatim}
##          expr   median
## 1  Boucle(x1) 765.4535
## 2 Boucle2(x1)  77.9470
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 vapply(x1, FUN = sqrt, 0) 288.0205
## 2                Boucle(x1)  77.7035
\end{verbatim}
...
\begin{verbatim}
##                                               expr   median
## 1                        vapply(x1, FUN = sqrt, 0)  300.702
## 2 for (i in 1:length(x1)) Racine[i] <- sqrt(x1[i]) 3409.250
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 replicate(1000, runif(1)) 3534.943
## 2               runif(1000)   32.901
\end{verbatim}
...
\begin{verbatim}
##                              expr   median
## 1   BoucleSomme(diamonds[-(2:4)]) 3.541247
## 2 apply(diamonds[-(2:4)], 2, sum) 9.039697
## 3       colSums(diamonds[-(2:4)]) 2.386312
\end{verbatim}
...
## Unit: microseconds
##                                                      expr     min       lq
##  d <- TotalDistance(X$x, X$y)/NbPoints/(NbPoints - 1) * 2 989.243 1935.355
##      mean   median       uq      max neval
##  2435.748 2068.547 2628.412 11349.41   100
\end{verbatim}
...
Ce temps est à comparer à celui de la boucle for de référence, multiplié par 2500, soit \texttt{4759} secondes.
...
## Unit: nanoseconds
##                expr  min     lq     mean median     uq     max neval
##  triple.integer(2L)  328  348.0   405.11  379.5  422.5    1146   100
##   triple.numeric(2)  319  345.0 18872.06  384.5  427.5 1847128   100
##          triple(2L) 1330 1365.5 23631.25 1391.0 1423.5 2216123   100
\end{verbatim}
