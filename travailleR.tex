...
##  f1(X)   1.681   2.2960   8.98597   6.4165   7.1545 368.016
##  f2(X)   4.141   4.5715  10.88755   8.2205   8.9380 369.574
##  f3(X)  92.496 100.9830 107.41016 103.1150 106.0875 475.600
##  f4(X) 120.376 133.7420 141.25279 135.8945 139.1130 595.894
##  neval
##    100
##    100
##    100
...
##                                    expr   median
## 1                              sqrt(x1)   1.3940
## 2                lapply(x1, FUN = sqrt) 125.2755
## 3                sapply(x1, FUN = sqrt) 148.1945
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 123.3280
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 vapply(x1, FUN = sqrt, 0) 134.7260
## 2                Boucle(x1)  42.1685
\end{verbatim}
...
\begin{verbatim}
##                                               expr   median
## 1                        vapply(x1, FUN = sqrt, 0)  133.906
## 2 for (i in 1:length(x1)) Racine[i] <- sqrt(x1[i]) 1100.583
\end{verbatim}
...
\begin{verbatim}
##                        expr  median
## 1 replicate(1000, runif(1)) 733.572
## 2               runif(1000)   6.232
\end{verbatim}
...
\begin{verbatim}
##                              expr   median
## 1   BoucleSomme(diamonds[-(2:4)]) 1164.052
## 2 apply(diamonds[-(2:4)], 2, sum) 2775.966
## 3       colSums(diamonds[-(2:4)]) 1064.237
\end{verbatim}
...
##  297.578 307.623 349.2815 309.4885 310.944 3516.816   100
\end{verbatim}
...
Ce temps est à comparer à celui de la boucle for de référence, multiplié par 2500, soit \texttt{2227} secondes.
...
## ✔ ended pipeline [854ms, 4 completed, 0 skipped]
\end{verbatim}
...
\begin{verbatim}
## ✔ skipped pipeline [38ms, 4 skipped]
\end{verbatim}
...
## ✔ ended pipeline [833ms, 4 completed, 0 skipped]
\end{verbatim}
...
##  triple.integer(2L)  82 123  143.50    123 164    451   100
##   triple.numeric(2) 123 123 8440.26    123 164 830045   100
##          triple(2L) 492 492 6988.45    533 533 645668   100
\end{verbatim}
