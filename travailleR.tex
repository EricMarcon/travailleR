...
##  f1(X)   3.608   6.724  11.48861   7.5440   8.4665 372.567
##  f2(X)   4.018   8.610  12.63866   9.1430  10.1065 342.186
##  f3(X)  99.015 105.124 117.96848 107.8915 112.3195 454.157
##  f4(X) 125.665 136.940 151.53395 141.1425 143.2130 595.853
##  neval
##    100
##    100
##    100
...
## 3                sapply(x1, FUN = sqrt) 175.4595
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 141.1015
\end{verbatim}
...
\begin{verbatim}
##          expr   median
## 1  Boucle(x1) 394.9325
## 2 Boucle2(x1)  45.1205
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 vapply(x1, FUN = sqrt, 0) 134.7875
## 2                Boucle(x1)  42.5375
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 replicate(1000, runif(1)) 756.6345
## 2               runif(1000)   7.1545
\end{verbatim}
...
\begin{verbatim}
##                              expr   median
## 1   BoucleSomme(diamonds[-(2:4)]) 1598.098
## 2 apply(diamonds[-(2:4)], 2, sum) 3762.550
## 3       colSums(diamonds[-(2:4)]) 1279.877
\end{verbatim}
...
##  300.038 310.8005 443.4363 316.9095 351.3905 3991.801   100
\end{verbatim}
...
Ce temps est à comparer à celui de la boucle for de référence, multiplié par 2500, soit \texttt{1982} secondes.
...
## ● completed target NbPoints [0.662 seconds, 53 bytes]
## ▶ dispatched target X
...
\begin{verbatim}
## ▶ dispatched target NbPoints
## ● completed target NbPoints [0.658 seconds, 53 bytes]
## ▶ dispatched target X
## ● completed target X [0.001 seconds, 11.058 kilobytes]
## ▶ dispatched target d
## ● completed target d [0.038 seconds, 55 bytes]
## ▶ dispatched target map
## ● completed target map [0.011 seconds, 187.39 kilobytes]
## ▶ ended pipeline [0.806 seconds]
\end{verbatim}
...
##  triple.integer(2L) 123 123  138.17    123 123    410   100
##   triple.numeric(2)  82 123 8266.42    123 123 813194   100
##          triple(2L) 492 492 6932.28    533 533 639559   100
\end{verbatim}
