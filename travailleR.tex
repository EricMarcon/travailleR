...
##  f1(X)  36.746  38.3145  53.64574  39.6650  42.4075
##  f2(X)  44.026  46.1970  64.67248  47.4745  52.6585
##  f3(X) 274.603 276.6855 303.68636 278.8060 288.9950
##  f4(X) 406.902 409.2105 439.39292 411.7955 425.7175
##       max neval
##  1259.640   100
##  1194.012   100
##  1450.817   100
...
##                                    expr   median
## 1                              sqrt(x1)   4.6325
## 2                lapply(x1, FUN = sqrt) 295.6045
## 3                sapply(x1, FUN = sqrt) 348.8280
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 307.1670
\end{verbatim}
...
\begin{verbatim}
##          expr   median
## 1  Boucle(x1) 852.6350
## 2 Boucle2(x1)  79.7485
\end{verbatim}
...
\begin{verbatim}
##                        expr  median
## 1 vapply(x1, FUN = sqrt, 0) 301.325
## 2                Boucle(x1)  78.758
\end{verbatim}
...
\begin{verbatim}
##                        expr    median
## 1 replicate(1000, runif(1)) 3976.5135
## 2               runif(1000)   34.7945
\end{verbatim}
...
\begin{verbatim}
##                              expr   median
## 1   BoucleSomme(diamonds[-(2:4)]) 3.504995
## 2 apply(diamonds[-(2:4)], 2, sum) 9.045284
## 3       colSums(diamonds[-(2:4)]) 2.380937
\end{verbatim}
...
##  820.199 1233.101 1761.095 1799.117 2155.446 3892.881   100
\end{verbatim}
...
Ce temps est à comparer à celui de la boucle for de référence, multiplié par 2500, soit \texttt{4752} secondes.
...
Les fonctions utilisées par les cibles sont déclarées dans ce type de bout de code: elles sont ajoutées à un fichier dans le dossier de travail \texttt{\_targets\_r} (différent du dossier \texttt{\_targets} qui contient les cibles).
...
\begin{center}\includegraphics[width=0.8\linewidth]{travailleR_files/figure-latex/unnamed-chunk-73-1} \end{center}
...
## Unit: nanoseconds
##                expr  min     lq     mean median     uq
##  triple.integer(2L)  318  329.5 21995.58  343.5  375.0
##   triple.numeric(2)  317  328.0 18835.48  335.5  369.0
##          triple(2L) 1321 1349.5  1455.77 1368.5 1425.5
##      max neval
##  2163598   100
##  1847141   100
##     5650   100
...
\begin{center}\includegraphics[width=0.8\linewidth]{travailleR_files/figure-latex/unnamed-chunk-105-1} \end{center}
...
\begin{center}\includegraphics[width=0.8\linewidth]{travailleR_files/figure-latex/unnamed-chunk-105-2} \end{center}
