...
##  f1(X)  35.973  39.0520  71.7438  40.5860  45.8385
##  f2(X)  43.235  46.5980 101.9562  48.3035  53.2040
##  f3(X) 274.708 278.1590 359.2396 283.7235 296.0250
##  f4(X) 405.062 409.7395 984.4271 422.0775 465.0235
##        max neval
##   2290.368   100
##   4662.877   100
##   3611.548   100
...
##                                    expr   median
## 1                              sqrt(x1)   4.6340
## 2                lapply(x1, FUN = sqrt) 305.7350
## 3                sapply(x1, FUN = sqrt) 357.9410
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 312.7325
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 vapply(x1, FUN = sqrt, 0) 319.5745
## 2                Boucle(x1)  78.0415
\end{verbatim}
...
\begin{verbatim}
##                        expr    median
## 1 replicate(1000, runif(1)) 4120.5985
## 2               runif(1000)   34.1215
\end{verbatim}
...
\begin{verbatim}
##                              expr   median
## 1   BoucleSomme(diamonds[-(2:4)]) 3.623145
## 2 apply(diamonds[-(2:4)], 2, sum) 9.483909
## 3       colSums(diamonds[-(2:4)]) 2.468891
\end{verbatim}
...
##  2.102378 2.134068 2.297498 2.167352 2.246771 3.860908
##  neval
##    100
\end{verbatim}
...
Ce temps est à comparer à celui de la boucle for de référence, multiplié par 2500, soit \texttt{5382} secondes.
...
## Unit: nanoseconds
##                expr  min     lq     mean median     uq
##  triple.integer(2L)  321  333.5 23454.95  339.0  370.5
##   triple.numeric(2)  319  334.0 20240.53  344.5  377.5
##          triple(2L) 1318 1347.0  1485.69 1368.0 1406.5
##      max neval
##  2310322   100
##  1987677   100
##     6811   100
