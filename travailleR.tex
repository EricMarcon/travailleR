...
##  f1(X)  36.113  37.7985  53.10134  39.0610  41.4605
##  f2(X)  44.063  45.3715  63.48860  46.9130  49.9925
##  f3(X) 274.005 276.3775 300.97578 279.9245 286.3770
##  f4(X) 405.724 409.4795 439.69035 416.2265 428.0330
##       max neval
##  1328.578   100
##  1502.912   100
##  1641.959   100
...
##                                    expr   median
## 1                              sqrt(x1)   4.9165
## 2                lapply(x1, FUN = sqrt) 303.6735
## 3                sapply(x1, FUN = sqrt) 362.5925
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 319.7570
\end{verbatim}
...
\begin{verbatim}
##          expr   median
## 1  Boucle(x1) 865.8975
## 2 Boucle2(x1)  81.3925
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 vapply(x1, FUN = sqrt, 0) 305.4105
## 2                Boucle(x1)  79.3565
\end{verbatim}
...
\begin{verbatim}
##                                               expr   median
## 1                        vapply(x1, FUN = sqrt, 0)  317.718
## 2 for (i in 1:length(x1)) Racine[i] <- sqrt(x1[i]) 3353.247
\end{verbatim}
...
\begin{verbatim}
##                        expr    median
## 1 replicate(1000, runif(1)) 4385.2350
## 2               runif(1000)   34.0535
\end{verbatim}
...
\begin{verbatim}
##                              expr    median
## 1   BoucleSomme(diamonds[-(2:4)])  4.170376
## 2 apply(diamonds[-(2:4)], 2, sum) 10.283693
## 3       colSums(diamonds[-(2:4)])  2.695606
\end{verbatim}
...
La mise en place de la parallélisation a un coût d'environ \texttt{0.01} secondes ici.
...
##  773.609 958.896 1020.037 993.9785 1028.367 2814.616   100
\end{verbatim}
...
Ce temps est à comparer à celui de la boucle for de référence, multiplié par 2500, soit \texttt{4552} secondes.
...
## Unit: nanoseconds
##                expr  min   lq     mean median     uq
##  triple.integer(2L)  321  328   370.80  343.0  364.5
##   triple.numeric(2)  319  331 18620.36  340.0  364.0
##          triple(2L) 1270 1301 21972.53 1322.5 1397.5
##      max neval
##     1082   100
##  1826050   100
##  2056995   100
