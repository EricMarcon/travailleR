...
##  f1(X)  36.185  37.8070  54.15777  38.7085  40.0905
##  f2(X)  44.055  45.8630  60.72092  46.4785  48.5655
##  f3(X) 274.269 275.9485 293.36622 277.1145 281.7405
##  f4(X) 406.292 408.6035 429.44898 410.9705 416.8540
##       max neval
##  1453.438   100
##  1282.990   100
##  1689.222   100
...
##                                    expr   median
## 1                              sqrt(x1)   4.8095
## 2                lapply(x1, FUN = sqrt) 304.1305
## 3                sapply(x1, FUN = sqrt) 352.3250
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 302.6150
\end{verbatim}
...
\begin{verbatim}
##          expr   median
## 1  Boucle(x1) 782.3355
## 2 Boucle2(x1)  78.1295
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 vapply(x1, FUN = sqrt, 0) 297.7925
## 2                Boucle(x1)  77.6355
\end{verbatim}
...
\begin{verbatim}
##                        expr    median
## 1 replicate(1000, runif(1)) 4243.5390
## 2               runif(1000)   34.0095
\end{verbatim}
...
\begin{verbatim}
##                              expr   median
## 1   BoucleSomme(diamonds[-(2:4)]) 3.582678
## 2 apply(diamonds[-(2:4)], 2, sum) 9.182220
## 3       colSums(diamonds[-(2:4)]) 2.409010
\end{verbatim}
...
##  751.917 767.9015 806.1511 775.3875 777.6945 2545.453   100
\end{verbatim}
...
Ce temps est à comparer à celui de la boucle for de référence, multiplié par 2500, soit \texttt{5232} secondes.
...
## Unit: nanoseconds
##                expr  min     lq     mean median     uq
##  triple.integer(2L)  319  327.5 22352.79    337  357.5
##   triple.numeric(2)  317  328.0 20664.15    342  358.5
##          triple(2L) 1310 1346.0  1514.59   1381 1462.5
##      max neval
##  2198579   100
##  2030519   100
##     6480   100
