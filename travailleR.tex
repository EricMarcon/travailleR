...
##  f1(X)   1.927   6.437  12.52673   8.5895  10.5985 383.063
##  f2(X)   4.223   8.323  14.66734  10.8855  13.4275 362.932
##  f3(X)  95.981  99.097 107.80130 102.3770 107.3585 489.909
##  f4(X) 125.870 131.200 140.74480 134.1315 136.7965 710.776
##  neval
##    100
##    100
##    100
...
##                                    expr   median
## 1                              sqrt(x1)   1.3940
## 2                lapply(x1, FUN = sqrt) 126.7720
## 3                sapply(x1, FUN = sqrt) 150.6955
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 124.4965
\end{verbatim}
...
\begin{verbatim}
##          expr   median
## 1  Boucle(x1) 340.7715
## 2 Boucle2(x1)  39.2985
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 vapply(x1, FUN = sqrt, 0) 134.6645
## 2                Boucle(x1)  42.5990
\end{verbatim}
...
\begin{verbatim}
##                                               expr   median
## 1                        vapply(x1, FUN = sqrt, 0)  140.999
## 2 for (i in 1:length(x1)) Racine[i] <- sqrt(x1[i]) 1175.450
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 replicate(1000, runif(1)) 687.0575
## 2               runif(1000)   6.0680
\end{verbatim}
...
\begin{verbatim}
##                              expr   median
## 1   BoucleSomme(diamonds[-(2:4)]) 1496.479
## 2 apply(diamonds[-(2:4)], 2, sum) 3361.877
## 3       colSums(diamonds[-(2:4)]) 1180.452
\end{verbatim}
...
##  220.826 223.6755 283.3424 232.388 234.315 4799.05   100
\end{verbatim}
...
Ce temps est à comparer à celui de la boucle for de référence, multiplié par 2500, soit \texttt{2142} secondes.
...
## ● completed target NbPoints [0.645 seconds, 53 bytes]
## ▶ dispatched target X
...
\begin{verbatim}
## ▶ dispatched target NbPoints
## ● completed target NbPoints [0.619 seconds, 53 bytes]
## ▶ dispatched target X
...
## Unit: nanoseconds
##                expr min  lq    mean median    uq    max
##  triple.integer(2L)  82 123  138.99    123 164.0    451
##   triple.numeric(2)  82 123 8375.48    123 164.0 823977
##          triple(2L) 492 492 7193.45    533 553.5 665143
##  neval
##    100
##    100
##    100
