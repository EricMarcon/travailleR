...
##  f1(X)  39.499  42.270  155.55297  45.3530  50.1520
##  f2(X)  47.659  50.097   72.12884  51.7100  57.9895
##  f3(X) 281.097 289.106 1174.80471 296.0945 317.1605
##  f4(X) 415.837 426.555  702.75601 434.1105 466.1590
##        max neval
##   9394.739   100
##   1737.873   100
##  21641.207   100
...
##                                    expr   median
## 1                              sqrt(x1)   4.7285
## 2                lapply(x1, FUN = sqrt) 305.1525
## 3                sapply(x1, FUN = sqrt) 382.8110
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 298.1385
\end{verbatim}
...
\begin{verbatim}
##          expr   median
## 1  Boucle(x1) 835.0535
## 2 Boucle2(x1)  85.5465
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 vapply(x1, FUN = sqrt, 0) 289.2220
## 2                Boucle(x1)  83.0115
\end{verbatim}
...
\begin{verbatim}
##                                               expr   median
## 1                        vapply(x1, FUN = sqrt, 0)  298.045
## 2 for (i in 1:length(x1)) Racine[i] <- sqrt(x1[i]) 3836.833
\end{verbatim}
...
\begin{verbatim}
##                        expr    median
## 1 replicate(1000, runif(1)) 5646.1840
## 2               runif(1000)   25.1535
\end{verbatim}
...
\begin{verbatim}
##                              expr    median
## 1   BoucleSomme(diamonds[-(2:4)])  4.029596
## 2 apply(diamonds[-(2:4)], 2, sum) 11.606096
## 3       colSums(diamonds[-(2:4)])  2.550223
\end{verbatim}
...
La mise en place de la parallélisation a un coût d'environ \texttt{0.074} secondes ici.
...
##  780.063 887.538 1120.632 1112.017 1274.555 2981.919   100
\end{verbatim}
...
Ce temps est à comparer à celui de la boucle for de référence, multiplié par 2500, soit \texttt{4545} secondes.
...
## ● built target NbPoints [1.997 seconds]
## ▶ start target X
## ● built target X [0.004 seconds]
## ▶ start target d
## ● built target d [0.022 seconds]
## ▶ start target map
## ● built target map [0.102 seconds]
## ▶ end pipeline [3.427 seconds]
\end{verbatim}
...
\begin{verbatim}
## ▶ start target NbPoints
## ● built target NbPoints [1.888 seconds]
## ▶ start target X
## ● built target X [0.004 seconds]
## ▶ start target d
## ● built target d [0.022 seconds]
## ▶ start target map
## ● built target map [0.099 seconds]
## ▶ end pipeline [3.017 seconds]
\end{verbatim}
...
## Unit: nanoseconds
##                expr  min     lq     mean median   uq
##  triple.integer(2L)  333  341.5 24027.69    361  407
##   triple.numeric(2)  331  344.0 21304.72    372  426
##          triple(2L) 1391 1430.5  1634.90   1455 1520
##      max neval
##  2364045   100
##  2086889   100
##     6951   100
