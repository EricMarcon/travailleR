...
##  f1(X)  36.772  39.0965  98.32040  43.2205 140.668  1818.760   100
##  f2(X)  44.338  46.6855  99.16445  51.3515 135.428  1433.416   100
##  f3(X) 283.877 286.7485 343.26255 296.9145 391.442  1503.050   100
##  f4(X) 424.825 428.3570 589.86151 434.0675 506.858 11229.560   100
\end{verbatim}
...
##                                    expr   median
## 1                              sqrt(x1)   4.8950
## 2                lapply(x1, FUN = sqrt) 412.7290
## 3                sapply(x1, FUN = sqrt) 533.5945
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 470.2290
\end{verbatim}
...
\begin{verbatim}
##          expr   median
## 1  Boucle(x1) 885.0005
## 2 Boucle2(x1)  80.2460
\end{verbatim}
...
\begin{verbatim}
##                        expr  median
## 1 vapply(x1, FUN = sqrt, 0) 285.070
## 2                Boucle(x1)  77.245
\end{verbatim}
...
\begin{verbatim}
##                                               expr    median
## 1                        vapply(x1, FUN = sqrt, 0)  296.3035
## 2 for (i in 1:length(x1)) Racine[i] <- sqrt(x1[i]) 3634.3610
\end{verbatim}
...
\begin{verbatim}
##                        expr    median
## 1 replicate(1000, runif(1)) 4225.3065
## 2               runif(1000)   35.3665
\end{verbatim}
...
\begin{verbatim}
##                              expr    median
## 1   BoucleSomme(diamonds[-(2:4)])  4.018536
## 2 apply(diamonds[-(2:4)], 2, sum) 10.961635
## 3       colSums(diamonds[-(2:4)])  2.660320
\end{verbatim}
...
La mise en place de la parallélisation a un coût d'environ \texttt{0.081} secondes ici.
...
## Unit: microseconds
##                                                      expr     min      lq
##  d <- TotalDistance(X$x, X$y)/NbPoints/(NbPoints - 1) * 2 682.643 795.772
##      mean  median      uq      max neval
##  927.2638 817.529 895.699 2756.883   100
\end{verbatim}
...
## Unit: nanoseconds
##                expr  min     lq     mean median     uq     max neval
##  triple.integer(2L)  332  351.0   401.61  380.0  409.5    1125   100
##   triple.numeric(2)  323  343.5 18030.59  369.0  411.5 1764175   100
##          triple(2L) 1361 1409.0 23071.47 1440.5 1509.5 2155431   100
\end{verbatim}
