...
##  f1(X)  38.024  43.4915  68.00214  50.3995  55.7365
##  f2(X)  46.620  49.9625  73.17964  55.4115  64.9500
##  f3(X) 287.463 290.3065 367.75319 324.8345 428.5615
##  f4(X) 415.501 431.5920 535.56395 472.8000 635.9705
##       max neval
##  1522.727   100
##  1408.806   100
##  1652.894   100
...
##                                    expr   median
## 1                              sqrt(x1)   4.9990
## 2                lapply(x1, FUN = sqrt) 535.4160
## 3                sapply(x1, FUN = sqrt) 632.2415
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 532.5960
\end{verbatim}
...
\begin{verbatim}
##          expr   median
## 1  Boucle(x1) 909.3630
## 2 Boucle2(x1)  80.5275
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 vapply(x1, FUN = sqrt, 0) 308.3760
## 2                Boucle(x1)  78.0615
\end{verbatim}
...
\begin{verbatim}
##                                               expr   median
## 1                        vapply(x1, FUN = sqrt, 0)  361.783
## 2 for (i in 1:length(x1)) Racine[i] <- sqrt(x1[i]) 3870.533
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 replicate(1000, runif(1)) 4269.648
## 2               runif(1000)   36.628
\end{verbatim}
...
\begin{verbatim}
##                              expr    median
## 1   BoucleSomme(diamonds[-(2:4)])  3.834469
## 2 apply(diamonds[-(2:4)], 2, sum) 10.395636
## 3       colSums(diamonds[-(2:4)])  2.555097
\end{verbatim}
...
##  2.052825 2.106254 3.011528 2.137924 2.249141 12.45196
##  neval
##    100
\end{verbatim}
...
Ce temps est à comparer à celui de la boucle for de référence, multiplié par 2500, soit \texttt{10397} secondes.
...
## Unit: nanoseconds
##                expr  min   lq     mean median     uq
##  triple.integer(2L)  325  333 24447.04    342  382.0
##   triple.numeric(2)  324  331 21108.44    338  352.0
##          triple(2L) 1330 1355  1499.15   1372 1425.5
##      max neval
##  2408194   100
##  2075071   100
##     6861   100
