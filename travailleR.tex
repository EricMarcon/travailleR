...
##  f1(X)  36.115  37.313  51.52918  38.6395  39.7705 1252.813
##  f2(X)  44.149  45.559  59.67894  46.4670  47.8250 1216.829
##  f3(X) 275.372 276.863 295.06125 278.1515 283.4895 1443.766
##  f4(X) 408.555 410.517 429.37272 412.0900 418.2170 1857.541
##  neval
##    100
##    100
##    100
...
##                                    expr   median
## 1                              sqrt(x1)   4.6710
## 2                lapply(x1, FUN = sqrt) 295.4260
## 3                sapply(x1, FUN = sqrt) 346.9825
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 299.9955
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 vapply(x1, FUN = sqrt, 0) 289.5735
## 2                Boucle(x1)  76.7545
\end{verbatim}
...
\begin{verbatim}
##                                               expr   median
## 1                        vapply(x1, FUN = sqrt, 0)  297.354
## 2 for (i in 1:length(x1)) Racine[i] <- sqrt(x1[i]) 3303.815
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 replicate(1000, runif(1)) 4077.325
## 2               runif(1000)   34.441
\end{verbatim}
...
\begin{verbatim}
##                              expr   median
## 1   BoucleSomme(diamonds[-(2:4)]) 3.615229
## 2 apply(diamonds[-(2:4)], 2, sum) 9.235526
## 3       colSums(diamonds[-(2:4)]) 2.445276
\end{verbatim}
...
La mise en place de la parallélisation a un coût d'environ \texttt{0.016} secondes ici.
...
##  1.105261 1.116837 1.206784 1.224944 1.244429 2.377263
##  neval
##    100
\end{verbatim}
...
Ce temps est à comparer à celui de la boucle for de référence, multiplié par 2500, soit \texttt{4642} secondes.
...
##  triple.integer(2L)  319  328 21734.90    338  354.5
##   triple.numeric(2)  320  330 19480.19    339  357.0
##          triple(2L) 1324 1336  1488.92   1353 1434.5
##      max neval
##  2138203   100
##  1911915   100
##     6069   100
