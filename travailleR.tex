...
##  f1(X)  35.894  37.879  52.73077  38.7965  40.4815 1308.366   100
##  f2(X)  46.391  47.802  65.05056  48.8210  51.5110 1459.366   100
##  f3(X) 269.190 270.548 294.72167 271.8560 277.3190 1617.054   100
##  f4(X) 398.521 401.698 424.67304 406.1635 416.3625 1961.405   100
\end{verbatim}
...
##                                    expr   median
## 1                              sqrt(x1)   4.6275
## 2                lapply(x1, FUN = sqrt) 305.9235
## 3                sapply(x1, FUN = sqrt) 362.1460
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 303.3590
\end{verbatim}
...
\begin{verbatim}
##                        expr  median
## 1 vapply(x1, FUN = sqrt, 0) 297.973
## 2                Boucle(x1)  79.463
\end{verbatim}
...
\begin{verbatim}
##                                               expr   median
## 1                        vapply(x1, FUN = sqrt, 0)  302.106
## 2 for (i in 1:length(x1)) Racine[i] <- sqrt(x1[i]) 3395.595
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 replicate(1000, runif(1)) 3288.382
## 2               runif(1000)   33.823
\end{verbatim}
...
\begin{verbatim}
##                              expr   median
## 1   BoucleSomme(diamonds[-(2:4)]) 3.241137
## 2 apply(diamonds[-(2:4)], 2, sum) 8.052840
## 3       colSums(diamonds[-(2:4)]) 2.522188
\end{verbatim}
...
## Unit: microseconds
##                                                      expr   min       lq
##  d <- TotalDistance(X$x, X$y)/NbPoints/(NbPoints - 1) * 2 997.2 1014.475
##      mean   median       uq      max neval
##  1294.725 1040.745 1286.345 3359.163   100
\end{verbatim}
...
Ce temps est à comparer à celui de la boucle for de référence, multiplié par 2500, soit \texttt{4814} secondes.
...
## Unit: nanoseconds
##                expr  min   lq     mean median     uq     max neval
##  triple.integer(2L)  298  309   355.09  329.5  347.5     935   100
##   triple.numeric(2)  305  315 17134.87  327.5  345.0 1679064   100
##          triple(2L) 1266 1285 21154.34 1305.0 1341.0 1978317   100
\end{verbatim}
