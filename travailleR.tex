...
##  f1(X)  41.133  46.6400  80.93205  50.656  56.8225
##  f2(X)  49.221  52.9860  85.24623  56.387  63.0955
##  f3(X) 275.615 288.3715 942.65081 304.683 624.3390
##  f4(X) 401.959 423.5030 633.99075 460.602 755.2420
##        max neval
##   1369.284   100
##   1574.427   100
##  31433.035   100
...
##                                    expr   median
## 1                              sqrt(x1)   4.6790
## 2                lapply(x1, FUN = sqrt) 317.1440
## 3                sapply(x1, FUN = sqrt) 382.3295
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 303.9265
\end{verbatim}
...
\begin{verbatim}
##                        expr  median
## 1 vapply(x1, FUN = sqrt, 0) 308.284
## 2                Boucle(x1)  82.893
\end{verbatim}
...
\begin{verbatim}
##                        expr    median
## 1 replicate(1000, runif(1)) 4778.1060
## 2               runif(1000)   22.1935
\end{verbatim}
...
\begin{verbatim}
##                              expr    median
## 1   BoucleSomme(diamonds[-(2:4)])  4.988696
## 2 apply(diamonds[-(2:4)], 2, sum) 13.701539
## 3       colSums(diamonds[-(2:4)])  3.284046
\end{verbatim}
...
La mise en place de la parallélisation a un coût d'environ \texttt{0.091} secondes ici.
...
##  754.147 776.3455 1549.978 2046.01 2072.327 3828.31   100
\end{verbatim}
...
Ce temps est à comparer à celui de la boucle for de référence, multiplié par 2500, soit \texttt{5347} secondes.
...
## ● built target NbPoints [2.221 seconds]
## ▶ start target X
...
\begin{verbatim}
## ▶ start target NbPoints
## ● built target NbPoints [1.947 seconds]
## ▶ start target X
## ● built target X [0.004 seconds]
## ▶ start target d
## ● built target d [0.022 seconds]
## ▶ start target map
## ● built target map [0.026 seconds]
## ▶ end pipeline [2.221 seconds]
\end{verbatim}
...
## Unit: nanoseconds
##                expr  min     lq     mean median     uq
##  triple.integer(2L)  334  341.0 24563.80  352.0  382.5
##   triple.numeric(2)  330  343.5 21242.25  357.5  390.5
##          triple(2L) 1403 1436.5  1577.58 1455.0 1516.5
##      max neval
##  2419797   100
##  2086594   100
##     6665   100
