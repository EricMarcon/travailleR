...
##  f1(X)  34.526  37.5550  55.72699  38.5350  40.6595
##  f2(X)  41.341  44.6695  61.17571  45.7785  48.8925
##  f3(X) 265.978 269.0000 307.30724 272.1950 281.5760
##  f4(X) 395.414 398.9040 439.59785 408.3445 417.7025
##       max neval
##  1247.089   100
##  1332.701   100
##  3291.498   100
...
##                                    expr   median
## 1                              sqrt(x1)   4.4680
## 2                lapply(x1, FUN = sqrt) 286.8270
## 3                sapply(x1, FUN = sqrt) 338.7355
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 298.2945
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 vapply(x1, FUN = sqrt, 0) 297.0035
## 2                Boucle(x1)  76.4915
\end{verbatim}
...
\begin{verbatim}
##                        expr    median
## 1 replicate(1000, runif(1)) 3541.9445
## 2               runif(1000)   32.4555
\end{verbatim}
...
\begin{verbatim}
##                              expr   median
## 1   BoucleSomme(diamonds[-(2:4)]) 3.527706
## 2 apply(diamonds[-(2:4)], 2, sum) 8.968898
## 3       colSums(diamonds[-(2:4)]) 2.347378
\end{verbatim}
...
##  770.51 864.703 1664.758 962.3625 2251.681 9845.1   100
\end{verbatim}
...
Ce temps est à comparer à celui de la boucle for de référence, multiplié par 2500, soit \texttt{4527} secondes.
...
## Unit: nanoseconds
##                expr  min     lq     mean median     uq
##  triple.integer(2L)  318  326.5 26443.65  334.5  364.5
##   triple.numeric(2)  320  330.5 20409.18  347.5  373.5
##          triple(2L) 1285 1307.0  1436.53 1331.5 1394.0
##      max neval
##  2609554   100
##  2004048   100
##     6021   100
