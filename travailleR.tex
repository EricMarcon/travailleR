...
##  f1(X)   1.558   1.9680   7.45421   2.1730   5.9655 366.089
##  f2(X)   3.854   3.9770   9.20655   4.3255   7.5645 349.484
##  f3(X)  91.922  94.4640 100.11011  96.3910  98.0515 460.225
##  f4(X) 123.861 126.3825 133.43860 128.2070 130.6260 603.110
##  neval
##    100
##    100
##    100
...
##                                    expr   median
## 1                              sqrt(x1)   1.5580
## 2                lapply(x1, FUN = sqrt) 140.7120
## 3                sapply(x1, FUN = sqrt) 169.5760
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 138.8055
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 vapply(x1, FUN = sqrt, 0) 120.8475
## 2                Boucle(x1)  38.7040
\end{verbatim}
...
\begin{verbatim}
##                                               expr   median
## 1                        vapply(x1, FUN = sqrt, 0) 125.1320
## 2 for (i in 1:length(x1)) Racine[i] <- sqrt(x1[i]) 961.3065
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 replicate(1000, runif(1)) 704.6465
## 2               runif(1000)   5.9245
\end{verbatim}
...
\begin{verbatim}
##                              expr   median
## 1   BoucleSomme(diamonds[-(2:4)]) 1526.943
## 2 apply(diamonds[-(2:4)], 2, sum) 3512.900
## 3       colSums(diamonds[-(2:4)]) 1178.320
\end{verbatim}
...
##  230.912 238.292 292.5453 249.3825 250.223 4326.238   100
\end{verbatim}
...
Ce temps est à comparer à celui de la boucle for de référence, multiplié par 2500, soit \texttt{2252} secondes.
...
## ● completed target NbPoints [0.656 seconds]
## ▶ dispatched target X
## ● completed target X [0.001 seconds]
## ▶ dispatched target d
## ● completed target d [0.007 seconds]
## ▶ dispatched target map
## ● completed target map [0.014 seconds]
## ▶ ended pipeline [0.776 seconds]
\end{verbatim}
...
\begin{verbatim}
## ▶ dispatched target NbPoints
## ● completed target NbPoints [0.584 seconds]
## ▶ dispatched target X
## ● completed target X [0.001 seconds]
## ▶ dispatched target d
...
##  triple.integer(2L) 123 123 6737.94    123 164 654483   100
##   triple.numeric(2) 123 123 8591.96    123 246 839024   100
##          triple(2L) 492 533  769.98    615 779   3116   100
\end{verbatim}
