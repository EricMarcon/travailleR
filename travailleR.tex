...
##  f1(X)  36.451  39.1270  58.31655  40.8350  45.8750 1194.479   100
##  f2(X)  46.092  48.5325  69.32692  51.4065  56.1005 1214.796   100
##  f3(X) 262.632 270.9545 341.95633 278.5075 334.7640 1390.297   100
##  f4(X) 390.063 397.3895 469.93489 406.2695 436.3000 1764.962   100
\end{verbatim}
...
##                                    expr   median
## 1                              sqrt(x1)   4.7430
## 2                lapply(x1, FUN = sqrt) 314.3525
## 3                sapply(x1, FUN = sqrt) 372.3600
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 311.4575
\end{verbatim}
...
\begin{verbatim}
##          expr   median
## 1  Boucle(x1) 808.2845
## 2 Boucle2(x1)  81.1070
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 vapply(x1, FUN = sqrt, 0) 296.0120
## 2                Boucle(x1)  79.8225
\end{verbatim}
...
\begin{verbatim}
##                                               expr   median
## 1                        vapply(x1, FUN = sqrt, 0)  319.911
## 2 for (i in 1:length(x1)) Racine[i] <- sqrt(x1[i]) 3324.170
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 replicate(1000, runif(1)) 2723.170
## 2               runif(1000)   32.627
\end{verbatim}
...
\begin{verbatim}
##                              expr   median
## 1   BoucleSomme(diamonds[-(2:4)]) 3.192017
## 2 apply(diamonds[-(2:4)], 2, sum) 8.015637
## 3       colSums(diamonds[-(2:4)]) 2.500960
\end{verbatim}
...
La mise en place de la parallélisation a un coût de l'ordre du temps de calcul au-delà du quart de seconde attendu: environ \texttt{0.34} secondes ici.
...
## Unit: microseconds
##                                                      expr     min       lq
##  d <- TotalDistance(X$x, X$y)/NbPoints/(NbPoints - 1) * 2 673.899 778.6615
##      mean  median       uq      max neval
##  846.4291 816.765 853.7985 2510.279   100
\end{verbatim}
...
## Unit: nanoseconds
##                expr  min     lq     mean median     uq     max neval
##  triple.integer(2L)  311  322.0 21807.68    337  369.5 2142522   100
##   triple.numeric(2)  306  322.5 23271.30    331  359.5 2292283   100
##          triple(2L) 1311 1346.5  1759.74   1375 1501.5   19925   100
\end{verbatim}
