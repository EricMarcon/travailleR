...
##  f1(X)  35.729  37.6185  52.48643  38.3950  40.9395 1235.644   100
##  f2(X)  45.876  47.4280  62.09079  48.3990  49.8390 1198.213   100
##  f3(X) 262.476 266.6185 287.06888 270.9775 277.2045 1426.103   100
##  f4(X) 389.301 396.3550 425.64601 402.5085 408.4910 1794.392   100
\end{verbatim}
...
##                                    expr   median
## 1                              sqrt(x1)   4.7725
## 2                lapply(x1, FUN = sqrt) 317.5765
## 3                sapply(x1, FUN = sqrt) 369.0690
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 303.6675
\end{verbatim}
...
\begin{verbatim}
##          expr   median
## 1  Boucle(x1) 827.5160
## 2 Boucle2(x1)  81.8625
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 vapply(x1, FUN = sqrt, 0) 302.4430
## 2                Boucle(x1)  80.3965
\end{verbatim}
...
\begin{verbatim}
##                                               expr    median
## 1                        vapply(x1, FUN = sqrt, 0)  310.5665
## 2 for (i in 1:length(x1)) Racine[i] <- sqrt(x1[i]) 3272.9405
\end{verbatim}
...
\begin{verbatim}
##                        expr    median
## 1 replicate(1000, runif(1)) 3737.1750
## 2               runif(1000)   33.3835
\end{verbatim}
...
\begin{verbatim}
##                              expr   median
## 1   BoucleSomme(diamonds[-(2:4)]) 3.165585
## 2 apply(diamonds[-(2:4)], 2, sum) 7.962569
## 3       colSums(diamonds[-(2:4)]) 2.445855
\end{verbatim}
...
La mise en place de la parallélisation a un coût d'environ \texttt{0.095} secondes ici.
...
## Unit: microseconds
##                                                      expr     min      lq
##  d <- TotalDistance(X$x, X$y)/NbPoints/(NbPoints - 1) * 2 700.341 864.844
##    mean   median       uq      max neval
##  2433.6 1935.941 1975.947 27465.94   100
\end{verbatim}
...
Ce temps est à comparer à celui de la boucle for de référence, multiplié par 2500, soit \texttt{4637} secondes.
...
## Unit: nanoseconds
##                expr  min     lq     mean median     uq     max neval
##  triple.integer(2L)  303  308.0   360.08  328.5  354.0     993   100
##   triple.numeric(2)  302  315.5 18240.89  325.0  354.5 1789161   100
##          triple(2L) 1249 1288.0 66631.23 1307.0 1408.0 6496149   100
\end{verbatim}
