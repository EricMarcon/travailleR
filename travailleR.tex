...
Afficher les options globales de RStudio (menu \enquote{Tools \textgreater{} Global Options\ldots{}}): sélectionner \emph{Git/SVN} puis cliquer sur le bouton \enquote{Create SSH Key\ldots{}} et choisir le type de clé \enquote{ed25519}.
...
La clé, dite privée, est enregistrée dans le dossier \texttt{.ssh} du répertoire personnel de l'utilisateur.
La clé publique correspondante doit être déposée sur GitHub: cliquer sur le lien \enquote{View public key} et copier la clé dans le presse-papier.

Sur GitHub, afficher les réglages de son compte (menu \enquote{Settings}), sélectionner \enquote{SSH and GPG Keys}, cliquer sur \enquote{New SSH Key} et coller la clé publique dans le champ \enquote{Key}.
...
##  f1(X)   1.886   6.5805  12.39963   7.4210   8.9175 449.565
##  f2(X)   4.223   8.3435  15.33482   9.0815  11.1315 579.576
##  f3(X)  97.785 102.9510 113.56918 105.9440 108.5885 543.373
##  f4(X) 130.175 136.7145 153.58026 138.9285 144.2585 742.264
##  neval
##    100
##    100
##    100
...
##                                    expr   median
## 1                              sqrt(x1)   1.5580
## 2                lapply(x1, FUN = sqrt) 140.6505
## 3                sapply(x1, FUN = sqrt) 171.2775
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 138.8260
\end{verbatim}
...
\begin{verbatim}
##          expr   median
## 1  Boucle(x1) 369.0000
## 2 Boucle2(x1)  44.1775
\end{verbatim}
...
\begin{verbatim}
##                        expr  median
## 1 vapply(x1, FUN = sqrt, 0) 135.628
## 2                Boucle(x1)  42.435
\end{verbatim}
...
\begin{verbatim}
##                                               expr   median
## 1                        vapply(x1, FUN = sqrt, 0)  136.940
## 2 for (i in 1:length(x1)) Racine[i] <- sqrt(x1[i]) 1143.552
\end{verbatim}
...
\begin{verbatim}
##                        expr  median
## 1 replicate(1000, runif(1)) 758.377
## 2               runif(1000)   6.396
\end{verbatim}
...
\begin{verbatim}
##                              expr   median
## 1   BoucleSomme(diamonds[-(2:4)]) 1326.145
## 2 apply(diamonds[-(2:4)], 2, sum) 3118.316
## 3       colSums(diamonds[-(2:4)]) 1190.209
\end{verbatim}
...
##  230.707 235.381 283.3473 240.342 250.715 3636.577   100
\end{verbatim}
...
Ce temps est à comparer à celui de la boucle for de référence, multiplié par 2500, soit \texttt{2249} secondes.
...
\begin{verbatim}
## + NbPoints dispatched
## ✔ NbPoints completed [699ms, 53 B]
## + X dispatched
## ✔ X completed [1ms, 11.06 kB]
## + d dispatched
## ✔ d completed [3ms, 55 B]
## + map dispatched
## ✔ map completed [11ms, 187.83 kB]
## ✔ ended pipeline [852ms, 4 completed, 0 skipped]
\end{verbatim}
...
## ✔ ended pipeline [835ms, 4 completed, 0 skipped]
\end{verbatim}
...
##  triple.integer(2L) 123 123  143.50    123 164    533   100
##   triple.numeric(2) 123 123 8550.55    123 164 841074   100
##          triple(2L) 492 492 7129.90    533 533 659403   100
\end{verbatim}
...
Une organisation GitHub contient essentiellement des membres (titulaires d'un compte GitHub) et des dépôts accessibles à l'adresse \texttt{https://github.com/\textless{}Organisation\textgreater{}/\textless{}Depot\textgreater{}}.
