...
##  f1(X)  35.267  37.6560  52.57122  38.7195  40.3360 1342.490   100
##  f2(X)  43.597  45.2455  61.43196  46.0000  47.2020 1498.188   100
##  f3(X) 274.845 276.6190 295.50762 278.0210 283.4995 1643.436   100
##  f4(X) 408.159 409.5420 432.49668 411.8010 417.4145 1977.226   100
\end{verbatim}
...
##                                    expr   median
## 1                              sqrt(x1)   4.6510
## 2                lapply(x1, FUN = sqrt) 293.6310
## 3                sapply(x1, FUN = sqrt) 347.4445
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 291.7890
\end{verbatim}
...
\begin{verbatim}
##          expr   median
## 1  Boucle(x1) 781.5565
## 2 Boucle2(x1)  79.6785
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 vapply(x1, FUN = sqrt, 0) 286.5865
## 2                Boucle(x1)  77.5635
\end{verbatim}
...
\begin{verbatim}
##                                               expr    median
## 1                        vapply(x1, FUN = sqrt, 0)  291.0645
## 2 for (i in 1:length(x1)) Racine[i] <- sqrt(x1[i]) 3332.6835
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 replicate(1000, runif(1)) 2812.084
## 2               runif(1000)   32.232
\end{verbatim}
...
\begin{verbatim}
##                              expr   median
## 1   BoucleSomme(diamonds[-(2:4)]) 3.559818
## 2 apply(diamonds[-(2:4)], 2, sum) 9.093706
## 3       colSums(diamonds[-(2:4)]) 2.410272
\end{verbatim}
...
## Unit: microseconds
##                                                      expr     min      lq
##  d <- TotalDistance(X$x, X$y)/NbPoints/(NbPoints - 1) * 2 654.271 667.752
##      mean   median       uq      max neval
##  713.4082 682.4825 692.2675 2345.459   100
\end{verbatim}
...
Ce temps est à comparer à celui de la boucle for de référence, multiplié par 2500, soit \texttt{4297} secondes.
...
## Unit: nanoseconds
##                expr  min     lq     mean median     uq     max neval
##  triple.integer(2L)  336  354.0   555.92  383.0  416.5   14710   100
##   triple.numeric(2)  329  348.5 18023.98  370.5  410.5 1763825   100
##          triple(2L) 1378 1425.5 23872.57 1461.5 1541.5 2232821   100
\end{verbatim}
