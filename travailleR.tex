...
##  f1(X)  38.290  43.0105 185.37278  45.039  51.3865
##  f2(X)  46.899  51.4450  72.58178  53.415  59.8990
##  f3(X) 283.949 290.2100 646.41441 295.978 313.4310
##  f4(X) 415.535 427.9065 832.61949 437.473 538.6755
##        max neval
##   9252.753   100
##   1410.516   100
##  11110.892   100
...
##                                    expr   median
## 1                              sqrt(x1)   4.7930
## 2                lapply(x1, FUN = sqrt) 316.8755
## 3                sapply(x1, FUN = sqrt) 375.2565
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 303.3440
\end{verbatim}
...
\begin{verbatim}
##          expr   median
## 1  Boucle(x1) 949.3835
## 2 Boucle2(x1)  80.5315
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 vapply(x1, FUN = sqrt, 0) 312.1975
## 2                Boucle(x1)  79.0190
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 replicate(1000, runif(1)) 3449.566
## 2               runif(1000)   33.357
\end{verbatim}
...
\begin{verbatim}
##                              expr    median
## 1   BoucleSomme(diamonds[-(2:4)])  5.082759
## 2 apply(diamonds[-(2:4)], 2, sum) 21.770381
## 3       colSums(diamonds[-(2:4)])  3.241742
\end{verbatim}
...
La mise en place de la parallélisation a un coût d'environ \texttt{0.23} secondes ici.
...
##  772.316 776.798 830.4311 780.3055 787.4435 3109.066   100
\end{verbatim}
...
Ce temps est à comparer à celui de la boucle for de référence, multiplié par 2500, soit \texttt{6260} secondes.
...
## • built target NbPoints [2.422 seconds]
## • start target X
...
\begin{verbatim}
## • start target NbPoints
## • built target NbPoints [2.319 seconds]
## • start target X
## • built target X [0.005 seconds]
## • start target d
...
## Unit: nanoseconds
##                expr  min     lq     mean median     uq
##  triple.integer(2L)  325  330.0 33032.94    342  371.0
##   triple.numeric(2)  323  333.0 28012.99    344  369.5
##          triple(2L) 1365 1389.5  1597.53   1411 1482.5
##      max neval
##  3267146   100
##  2763702   100
##     9350   100
