...
##  f1(X)  37.109  38.694  54.88039  39.9340  43.5390
##  f2(X)  44.645  46.523 105.89563  47.7965  53.2485
##  f3(X) 275.034 278.351 573.11458 283.8320 328.2300
##  f4(X) 407.623 410.561 973.53198 417.0425 466.7105
##        max neval
##   1315.832   100
##   5010.279   100
##  13376.607   100
...
##                                    expr   median
## 1                              sqrt(x1)   4.6840
## 2                lapply(x1, FUN = sqrt) 298.8650
## 3                sapply(x1, FUN = sqrt) 352.9385
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 307.7510
\end{verbatim}
...
\begin{verbatim}
##          expr   median
## 1  Boucle(x1) 864.3275
## 2 Boucle2(x1)  81.0900
\end{verbatim}
...
\begin{verbatim}
##                        expr  median
## 1 vapply(x1, FUN = sqrt, 0) 335.628
## 2                Boucle(x1)  80.873
\end{verbatim}
...
\begin{verbatim}
##                                               expr   median
## 1                        vapply(x1, FUN = sqrt, 0)  328.849
## 2 for (i in 1:length(x1)) Racine[i] <- sqrt(x1[i]) 3593.682
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 replicate(1000, runif(1)) 3744.374
## 2               runif(1000)   32.594
\end{verbatim}
...
\begin{verbatim}
##                              expr   median
## 1   BoucleSomme(diamonds[-(2:4)]) 3.641863
## 2 apply(diamonds[-(2:4)], 2, sum) 9.331699
## 3       colSums(diamonds[-(2:4)]) 2.453391
\end{verbatim}
...
##  1.126359 2.061871 2.013385 2.103522 2.21437 3.986847   100
\end{verbatim}
...
Ce temps est à comparer à celui de la boucle for de référence, multiplié par 2500, soit \texttt{4675} secondes.
...
\caption{Clonage d'un dépôt à partir de GitHub.}\label{fig:git-Access}
\end{figure}
...
## Unit: nanoseconds
##                expr  min     lq     mean median     uq
##  triple.integer(2L)  317  332.0   376.01  354.0  375.0
##   triple.numeric(2)  320  330.5 18791.82  340.0  371.5
##          triple(2L) 1287 1314.5 24502.39 1334.5 1393.0
##      max neval
##     1078   100
##  1842951   100
##  2308896   100
