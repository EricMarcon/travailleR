...
##  f1(X)  35.144  36.7245  53.64754  37.6935  40.0815  1221.321   100
##  f2(X)  42.022  44.2285  67.19333  45.4340  49.2470  1169.351   100
##  f3(X) 268.199 275.7450 336.88440 277.4140 285.5380  3298.852   100
##  f4(X) 395.460 399.7685 909.81557 408.1660 415.4510 25164.660   100
\end{verbatim}
...
##                                    expr   median
## 1                              sqrt(x1)   4.6065
## 2                lapply(x1, FUN = sqrt) 293.9895
## 3                sapply(x1, FUN = sqrt) 347.0570
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 291.8350
\end{verbatim}
...
\begin{verbatim}
##          expr   median
## 1  Boucle(x1) 760.4920
## 2 Boucle2(x1)  79.7095
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 vapply(x1, FUN = sqrt, 0) 279.5595
## 2                Boucle(x1)  78.1830
\end{verbatim}
...
\begin{verbatim}
##                                               expr   median
## 1                        vapply(x1, FUN = sqrt, 0)  284.700
## 2 for (i in 1:length(x1)) Racine[i] <- sqrt(x1[i]) 3082.208
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 replicate(1000, runif(1)) 3889.598
## 2               runif(1000)   34.716
\end{verbatim}
...
\begin{verbatim}
##                              expr   median
## 1   BoucleSomme(diamonds[-(2:4)]) 3.513390
## 2 apply(diamonds[-(2:4)], 2, sum) 9.138697
## 3       colSums(diamonds[-(2:4)]) 2.366887
\end{verbatim}
...
La mise en place de la parallélisation a un coût d'environ \texttt{0.035} secondes ici.
...
## Unit: milliseconds
##                                                      expr      min       lq
##  d <- TotalDistance(X$x, X$y)/NbPoints/(NbPoints - 1) * 2 1.086931 1.154161
##     mean   median       uq      max neval
##  1.67626 1.829016 2.080199 3.672229   100
\end{verbatim}
...
Ce temps est à comparer à celui de la boucle for de référence, multiplié par 2500, soit \texttt{4832} secondes.
...
## Unit: nanoseconds
##                expr  min   lq     mean median     uq     max neval
##  triple.integer(2L)  295  312   359.57  324.5  368.5    1221   100
##   triple.numeric(2)  293  311 18317.62  321.5  373.0 1797464   100
##          triple(2L) 1285 1320 22352.43 1340.5 1396.0 2085982   100
\end{verbatim}
