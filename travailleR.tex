...
##  f1(X)  40.521  43.3415  60.85403  44.6750  48.1620
##  f2(X)  49.170  51.2890  71.62341  52.3990  55.2720
##  f3(X) 280.856 283.7600 308.18557 285.4355 295.3845
##  f4(X) 411.265 415.7865 443.22138 420.4685 426.6085
##       max neval
##  1314.204   100
##  1389.629   100
##  1695.222   100
...
##                                    expr   median
## 1                              sqrt(x1)   4.6685
## 2                lapply(x1, FUN = sqrt) 298.0965
## 3                sapply(x1, FUN = sqrt) 349.7435
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 308.8420
\end{verbatim}
...
\begin{verbatim}
##          expr   median
## 1  Boucle(x1) 809.6650
## 2 Boucle2(x1)  77.8375
\end{verbatim}
...
\begin{verbatim}
##                        expr  median
## 1 vapply(x1, FUN = sqrt, 0) 303.729
## 2                Boucle(x1)  77.459
\end{verbatim}
...
\begin{verbatim}
##                                               expr   median
## 1                        vapply(x1, FUN = sqrt, 0)  311.769
## 2 for (i in 1:length(x1)) Racine[i] <- sqrt(x1[i]) 3394.682
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 replicate(1000, runif(1)) 4460.756
## 2               runif(1000)   34.779
\end{verbatim}
...
\begin{verbatim}
##                              expr   median
## 1   BoucleSomme(diamonds[-(2:4)]) 3.773492
## 2 apply(diamonds[-(2:4)], 2, sum) 9.776792
## 3       colSums(diamonds[-(2:4)]) 2.610888
\end{verbatim}
...
##  2.080646 2.123753 3.47048 2.224111 2.398504 59.64358   100
\end{verbatim}
...
Ce temps est à comparer à celui de la boucle for de référence, multiplié par 2500, soit \texttt{5777} secondes.
...
\begin{center}\includegraphics[width=0.8\linewidth]{travailleR_files/figure-latex/unnamed-chunk-74-1} \end{center}
...
\begin{center}\includegraphics[width=0.8\linewidth]{travailleR_files/figure-latex/unnamed-chunk-75-1} \end{center}
...
## Unit: nanoseconds
##                expr  min     lq     mean median     uq
##  triple.integer(2L)  324  337.0 23562.03  346.0  368.0
##   triple.numeric(2)  320  336.5 20368.67  349.5  400.5
##          triple(2L) 1315 1357.5  1755.77 1394.5 1523.5
##      max neval
##  2318814   100
##  1997642   100
##    21738   100
...
\begin{center}\includegraphics[width=0.8\linewidth]{travailleR_files/figure-latex/unnamed-chunk-107-1} \end{center}
...
\begin{center}\includegraphics[width=0.8\linewidth]{travailleR_files/figure-latex/unnamed-chunk-107-2} \end{center}
