...
##  f1(X)  106.964  111.3765  174.7442  117.3205  129.3805  3845.640   100
##  f2(X)  135.517  139.6935  219.1478  144.2475  157.8075  4032.110   100
##  f3(X)  804.050  812.6600 1133.9641  825.8905  865.7735 23923.537   100
##  f4(X) 1193.631 1208.4505 1353.6844 1224.5255 1266.9905  6041.384   100
\end{verbatim}
...
##                                    expr    median
## 1                              sqrt(x1)   14.3420
## 2                lapply(x1, FUN = sqrt)  929.4870
## 3                sapply(x1, FUN = sqrt) 1103.3850
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0)  918.3435
\end{verbatim}
...
\begin{verbatim}
##          expr    median
## 1  Boucle(x1) 2409.0620
## 2 Boucle2(x1)  248.4315
\end{verbatim}
...
\begin{verbatim}
##                        expr  median
## 1 vapply(x1, FUN = sqrt, 0) 908.959
## 2                Boucle(x1) 247.309
\end{verbatim}
...
\begin{verbatim}
##                                               expr     median
## 1                        vapply(x1, FUN = sqrt, 0)   915.4205
## 2 for (i in 1:length(x1)) Racine[i] <- sqrt(x1[i]) 10053.7885
\end{verbatim}
...
\begin{verbatim}
##                        expr    median
## 1 replicate(1000, runif(1)) 10720.724
## 2               runif(1000)   102.948
\end{verbatim}
...
\begin{verbatim}
##                              expr    median
## 1   BoucleSomme(diamonds[-(2:4)])  9.408297
## 2 apply(diamonds[-(2:4)], 2, sum) 23.831142
## 3       colSums(diamonds[-(2:4)])  7.254361
\end{verbatim}
...
La mise en place de la parallélisation a un coût d'environ \texttt{0.17} secondes ici.
...
## Unit: milliseconds
##                                                      expr      min       lq
##  d <- TotalDistance(X$x, X$y)/NbPoints/(NbPoints - 1) * 2 2.007467 2.450438
##      mean   median       uq     max neval
##  2.680966 2.672852 2.784396 7.03584   100
\end{verbatim}
...
Ce temps est à comparer à celui de la boucle for de référence, multiplié par 2500, soit \texttt{15865} secondes.
...
## Unit: nanoseconds
##                expr  min     lq     mean median     uq     max neval
##  triple.integer(2L)  920  941.0  1051.00  988.5 1068.5    2510   100
##   triple.numeric(2)  920  963.5 57771.30  984.0 1050.0 5675004   100
##          triple(2L) 3877 3977.0 62464.22 4028.5 4120.5 5826077   100
\end{verbatim}
