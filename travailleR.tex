...
##  f1(X)  26.722  27.8325  37.15331  28.4890  29.6705
##  f2(X)  37.350  38.3705  48.96823  39.2235  40.4590
##  f3(X) 229.371 236.9100 258.06153 238.6425 242.3960
##  f4(X) 285.561 301.1920 318.58923 302.8745 309.7925
##       max neval
##   824.500   100
##   811.155   100
##  1012.294   100
...
##                                    expr   median
## 1                              sqrt(x1)   7.5720
## 2                lapply(x1, FUN = sqrt) 284.8245
## 3                sapply(x1, FUN = sqrt) 328.8235
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 291.7895
\end{verbatim}
...
\begin{verbatim}
##          expr   median
## 1  Boucle(x1) 624.8360
## 2 Boucle2(x1)  73.8685
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 vapply(x1, FUN = sqrt, 0) 282.1725
## 2                Boucle(x1)  71.3530
\end{verbatim}
...
\begin{verbatim}
##                                               expr   median
## 1                        vapply(x1, FUN = sqrt, 0)  282.648
## 2 for (i in 1:length(x1)) Racine[i] <- sqrt(x1[i]) 2263.648
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 replicate(1000, runif(1)) 2590.345
## 2               runif(1000)   16.598
\end{verbatim}
...
\begin{verbatim}
##                              expr   median
## 1   BoucleSomme(diamonds[-(2:4)]) 2.915655
## 2 apply(diamonds[-(2:4)], 2, sum) 7.248747
## 3       colSums(diamonds[-(2:4)]) 2.048280
\end{verbatim}
...
##  272.999 280.189 331.814 283.2065 297.057 2169.826   100
\end{verbatim}
...
Ce temps est à comparer à celui de la boucle for de référence, multiplié par 2500, soit \texttt{4030} secondes.
...
## ● built target NbPoints [3.327 seconds]
## ▶ start target X
## ● built target X [0.005 seconds]
## ▶ start target d
## ● built target d [0.084 seconds]
## ▶ start target map
## ● built target map [0.034 seconds]
## ▶ end pipeline [3.629 seconds]
\end{verbatim}
...
\begin{verbatim}
## ▶ start target NbPoints
## ● built target NbPoints [2.482 seconds]
## ▶ start target X
## ● built target X [0.005 seconds]
## ▶ start target d
## ● built target d [0.086 seconds]
## ▶ start target map
## ● built target map [0.029 seconds]
## ▶ end pipeline [2.772 seconds]
\end{verbatim}
...
## Unit: nanoseconds
##                expr  min     lq     mean median     uq
##  triple.integer(2L)  286  299.5   318.47  305.0  312.5
##   triple.numeric(2)  289  300.5 14460.80  313.0  322.0
##          triple(2L) 1040 1052.0 17586.98 1067.5 1120.0
##      max neval
##      594   100
##  1413747   100
##  1647833   100
