...
##  f1(X)  36.449  37.163  51.93533  38.1400  39.9165 1251.245
##  f2(X)  43.417  44.860  60.24013  45.7100  47.7440 1232.690
##  f3(X) 276.917 278.796 307.44695 280.1885 288.7680 1558.417
##  f4(X) 413.566 415.425 450.55278 418.4995 430.5805 1819.167
##  neval
##    100
##    100
##    100
...
##                                    expr   median
## 1                              sqrt(x1)   4.8600
## 2                lapply(x1, FUN = sqrt) 311.4780
## 3                sapply(x1, FUN = sqrt) 350.1835
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 312.2715
\end{verbatim}
...
\begin{verbatim}
##          expr   median
## 1  Boucle(x1) 787.6825
## 2 Boucle2(x1)  76.4480
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 vapply(x1, FUN = sqrt, 0) 291.2225
## 2                Boucle(x1)  74.3370
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 replicate(1000, runif(1)) 2833.133
## 2               runif(1000)   31.715
\end{verbatim}
...
\begin{verbatim}
##                              expr   median
## 1   BoucleSomme(diamonds[-(2:4)]) 3.404965
## 2 apply(diamonds[-(2:4)], 2, sum) 8.797289
## 3       colSums(diamonds[-(2:4)]) 2.294092
\end{verbatim}
...
##  740.871 745.5615 790.8584 756.3255 771.1985 2360.029   100
\end{verbatim}
...
Ce temps est à comparer à celui de la boucle for de référence, multiplié par 2500, soit \texttt{4884} secondes.
...
##  triple.integer(2L)  323  332.5 21575.56    340  365.0
##   triple.numeric(2)  321  335.0 18532.53    340  365.5
##          triple(2L) 1269 1312.0  1432.20   1327 1377.0
##      max neval
##  2122903   100
##  1817571   100
##     6268   100
