...
##  f1(X)  35.052  36.7805  52.24804  37.6000  38.6540 1252.867   100
##  f2(X)  42.134  43.9985  59.41777  44.8555  46.7335 1254.119   100
##  f3(X) 267.500 270.0685 294.19139 275.7950 279.4460 1485.102   100
##  f4(X) 394.764 397.6700 427.35154 405.6470 413.4290 1856.017   100
\end{verbatim}
...
##                                    expr   median
## 1                              sqrt(x1)   4.6160
## 2                lapply(x1, FUN = sqrt) 290.1225
## 3                sapply(x1, FUN = sqrt) 342.3295
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 289.1875
\end{verbatim}
...
\begin{verbatim}
##          expr   median
## 1  Boucle(x1) 773.9025
## 2 Boucle2(x1)  80.2650
\end{verbatim}
...
\begin{verbatim}
##                        expr  median
## 1 vapply(x1, FUN = sqrt, 0) 285.966
## 2                Boucle(x1)  78.696
\end{verbatim}
...
\begin{verbatim}
##                                               expr    median
## 1                        vapply(x1, FUN = sqrt, 0)  287.7195
## 2 for (i in 1:length(x1)) Racine[i] <- sqrt(x1[i]) 3087.2925
\end{verbatim}
...
\begin{verbatim}
##                        expr    median
## 1 replicate(1000, runif(1)) 4035.5510
## 2               runif(1000)   34.2315
\end{verbatim}
...
\begin{verbatim}
##                              expr   median
## 1   BoucleSomme(diamonds[-(2:4)]) 3.377490
## 2 apply(diamonds[-(2:4)], 2, sum) 8.811097
## 3       colSums(diamonds[-(2:4)]) 2.300615
\end{verbatim}
...
La mise en place de la parallélisation a un coût d'environ \texttt{0.038} secondes ici.
...
## Unit: microseconds
##                                                      expr     min       lq
##  d <- TotalDistance(X$x, X$y)/NbPoints/(NbPoints - 1) * 2 740.986 745.5435
##      mean   median       uq      max neval
##  791.2576 749.8235 766.8635 2665.603   100
\end{verbatim}
...
Ce temps est à comparer à celui de la boucle for de référence, multiplié par 2500, soit \texttt{4562} secondes.
...
## Unit: nanoseconds
##                expr  min     lq     mean median   uq     max neval
##  triple.integer(2L)  293  316.5   366.87    337  388     998   100
##   triple.numeric(2)  302  317.5 17895.01    329  388 1753894   100
##          triple(2L) 1301 1339.5 22856.23   1364 1403 2131321   100
\end{verbatim}
