...
##  f1(X)  39.569  43.6440  166.1230  47.8945   52.0935
##  f2(X)  48.243  51.5565  108.1863  55.6390   65.8715
##  f3(X) 282.590 290.1160  743.9669 385.2380  607.8770
##  f4(X) 411.813 450.9150 1049.6824 652.2785 1164.0885
##       max neval
##  5518.122   100
##  1820.120   100
##  8334.706   100
...
##                                    expr   median
## 1                              sqrt(x1)   4.7300
## 2                lapply(x1, FUN = sqrt) 315.7950
## 3                sapply(x1, FUN = sqrt) 366.5305
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 304.7585
\end{verbatim}
...
\begin{verbatim}
##          expr   median
## 1  Boucle(x1) 835.0965
## 2 Boucle2(x1)  78.2420
\end{verbatim}
...
\begin{verbatim}
##                        expr  median
## 1 vapply(x1, FUN = sqrt, 0) 314.821
## 2                Boucle(x1)  79.067
\end{verbatim}
...
\begin{verbatim}
##                        expr    median
## 1 replicate(1000, runif(1)) 4591.4330
## 2               runif(1000)   34.5725
\end{verbatim}
...
\begin{verbatim}
##                              expr   median
## 1   BoucleSomme(diamonds[-(2:4)]) 3.804489
## 2 apply(diamonds[-(2:4)], 2, sum) 9.923653
## 3       colSums(diamonds[-(2:4)]) 2.610592
\end{verbatim}
...
##  1.09271 1.159367 1.732037 1.31126 2.126414 12.86092   100
\end{verbatim}
...
Ce temps est à comparer à celui de la boucle for de référence, multiplié par 2500, soit \texttt{7035} secondes.
...
## Unit: nanoseconds
##                expr  min   lq     mean median     uq
##  triple.integer(2L)  347  356 25456.94  362.0  379.5
##   triple.numeric(2)  341  356 21713.78  362.0  397.0
##          triple(2L) 1352 1380  1527.81 1392.5 1449.5
##      max neval
##  2507579   100
##  2132042   100
##     7225   100
