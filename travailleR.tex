...
##  f1(X)  36.994  39.2355  54.72178  41.2190  43.5075
##  f2(X)  45.111  46.9635  62.74108  48.9830  52.8195
##  f3(X) 275.643 280.1725 302.96269 291.0075 293.5460
##  f4(X) 408.948 418.3620 439.44996 425.5095 429.7320
##       max neval
##  1255.215   100
##  1204.571   100
##  1553.225   100
...
##                                    expr   median
## 1                              sqrt(x1)   4.6505
## 2                lapply(x1, FUN = sqrt) 303.1825
## 3                sapply(x1, FUN = sqrt) 359.8465
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 306.3140
\end{verbatim}
...
\begin{verbatim}
##          expr   median
## 1  Boucle(x1) 755.6825
## 2 Boucle2(x1)  75.8235
\end{verbatim}
...
\begin{verbatim}
##                        expr  median
## 1 vapply(x1, FUN = sqrt, 0) 305.065
## 2                Boucle(x1)  80.368
\end{verbatim}
...
\begin{verbatim}
##                        expr    median
## 1 replicate(1000, runif(1)) 4066.6945
## 2               runif(1000)   34.6605
\end{verbatim}
...
\begin{verbatim}
##                              expr   median
## 1   BoucleSomme(diamonds[-(2:4)]) 3.568269
## 2 apply(diamonds[-(2:4)], 2, sum) 9.145195
## 3       colSums(diamonds[-(2:4)]) 2.413821
\end{verbatim}
...
##  810.212 1235.832 1453.412 1441.527 1605.863 2942.99   100
\end{verbatim}
...
Ce temps est à comparer à celui de la boucle for de référence, multiplié par 2500, soit \texttt{4797} secondes.
...
## Unit: nanoseconds
##                expr  min   lq     mean median     uq
##  triple.integer(2L)  320  328 22650.44    336  347.5
##   triple.numeric(2)  318  327 20949.16    334  349.0
##          triple(2L) 1319 1343  1475.50   1353 1399.5
##      max neval
##  2230916   100
##  2060504   100
##     7383   100
