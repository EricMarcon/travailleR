...
##  f1(X)  37.298  38.6075  53.50288  39.4785  41.6130
##  f2(X)  45.303  46.4560  62.57225  47.2935  49.9105
##  f3(X) 274.795 277.6540 308.23572 281.4715 290.8835
##  f4(X) 407.384 409.9140 434.54516 414.1385 424.0245
##       max neval
##  1335.740   100
##  1408.808   100
##  1654.026   100
...
##                                    expr   median
## 1                              sqrt(x1)   4.6000
## 2                lapply(x1, FUN = sqrt) 294.7835
## 3                sapply(x1, FUN = sqrt) 347.9525
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 305.1365
\end{verbatim}
...
\begin{verbatim}
##          expr   median
## 1  Boucle(x1) 827.4355
## 2 Boucle2(x1)  79.3540
\end{verbatim}
...
\begin{verbatim}
##                        expr  median
## 1 vapply(x1, FUN = sqrt, 0) 298.872
## 2                Boucle(x1)  78.741
\end{verbatim}
...
\begin{verbatim}
##                                               expr   median
## 1                        vapply(x1, FUN = sqrt, 0)  308.096
## 2 for (i in 1:length(x1)) Racine[i] <- sqrt(x1[i]) 3299.160
\end{verbatim}
...
\begin{verbatim}
##                        expr    median
## 1 replicate(1000, runif(1)) 4200.1950
## 2               runif(1000)   35.2565
\end{verbatim}
...
\begin{verbatim}
##                              expr   median
## 1   BoucleSomme(diamonds[-(2:4)]) 3.649467
## 2 apply(diamonds[-(2:4)], 2, sum) 9.287880
## 3       colSums(diamonds[-(2:4)]) 2.480059
\end{verbatim}
...
##  1.08261 1.102101 1.199906 1.189745 1.239743 2.462482   100
\end{verbatim}
...
Ce temps est à comparer à celui de la boucle for de référence, multiplié par 2500, soit \texttt{4504} secondes.
...
\NormalTok{knitr}\OperatorTok{::}\KeywordTok{kable}\NormalTok{(}\KeywordTok{head}\NormalTok{(iris), }\DataTypeTok{caption =} \StringTok{"Tableau créé par R"}\NormalTok{, }\DataTypeTok{longtable =} \OtherTok{TRUE}\NormalTok{, }
...
## Unit: nanoseconds
##                expr  min     lq     mean median     uq
##  triple.integer(2L)  315  329.0   371.24  345.0  371.5
##   triple.numeric(2)  320  334.0 18713.96  344.5  368.5
##          triple(2L) 1294 1321.5 22089.01 1341.0 1391.0
##      max neval
##     1051   100
##  1835923   100
##  2055895   100
