...
##  f1(X)  39.158  41.7820  61.00912  43.3690  49.6020
##  f2(X)  47.544  49.6860  67.41903  51.0075  55.0050
##  f3(X) 277.737 280.6285 311.75218 286.0985 301.6400
##  f4(X) 410.708 414.4230 456.33617 421.8310 443.2305
##       max neval
##  1425.046   100
##  1410.647   100
##  1987.076   100
...
##                                    expr   median
## 1                              sqrt(x1)   4.6560
## 2                lapply(x1, FUN = sqrt) 306.6700
## 3                sapply(x1, FUN = sqrt) 370.9440
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 300.1085
\end{verbatim}
...
\begin{verbatim}
##          expr   median
## 1  Boucle(x1) 823.3660
## 2 Boucle2(x1)  77.3045
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 vapply(x1, FUN = sqrt, 0) 309.4625
## 2                Boucle(x1)  77.9700
\end{verbatim}
...
\begin{verbatim}
##                        expr    median
## 1 replicate(1000, runif(1)) 3406.9410
## 2               runif(1000)   33.6485
\end{verbatim}
...
\begin{verbatim}
##                              expr    median
## 1   BoucleSomme(diamonds[-(2:4)])  4.004901
## 2 apply(diamonds[-(2:4)], 2, sum) 10.319459
## 3       colSums(diamonds[-(2:4)])  2.658103
\end{verbatim}
...
##  778.174 887.279 1085.17 914.5235 1051.795 2447.865   100
\end{verbatim}
...
Ce temps est à comparer à celui de la boucle for de référence, multiplié par 2500, soit \texttt{4959} secondes.
...
## Unit: nanoseconds
##                expr  min     lq    mean median     uq
##  triple.integer(2L)  343  352.0 24010.3  361.0  391.0
##   triple.numeric(2)  334  347.5 20818.6  363.5  394.5
##          triple(2L) 1337 1367.5  1641.0 1407.0 1478.0
##      max neval
##  2363482   100
##  2043058   100
##     9683   100
