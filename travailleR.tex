...
##  f1(X)  37.450  39.0250  53.99802  40.0435  41.4785
##  f2(X)  45.003  46.7270  60.97601  47.6795  49.7575
##  f3(X) 283.734 286.0610 307.71911 287.8610 301.7070
##  f4(X) 424.242 426.4985 460.71097 440.3100 443.5595
##       max neval
##  1312.638   100
##  1227.320   100
##  1566.600   100
...
##                                    expr   median
## 1                              sqrt(x1)   4.7590
## 2                lapply(x1, FUN = sqrt) 303.0615
## 3                sapply(x1, FUN = sqrt) 363.6210
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 317.3080
\end{verbatim}
...
\begin{verbatim}
##          expr   median
## 1  Boucle(x1) 833.1705
## 2 Boucle2(x1)  80.1960
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 vapply(x1, FUN = sqrt, 0) 305.1375
## 2                Boucle(x1)  78.6535
\end{verbatim}
...
\begin{verbatim}
##                        expr    median
## 1 replicate(1000, runif(1)) 4625.2430
## 2               runif(1000)   38.4105
\end{verbatim}
...
\begin{verbatim}
##                              expr   median
## 1   BoucleSomme(diamonds[-(2:4)]) 3.659378
## 2 apply(diamonds[-(2:4)], 2, sum) 9.287829
## 3       colSums(diamonds[-(2:4)]) 2.490732
\end{verbatim}
...
##  780.686 823.526 1105.217 1119.962 1255.331 3112.187   100
\end{verbatim}
...
Ce temps est à comparer à celui de la boucle for de référence, multiplié par 2500, soit \texttt{4942} secondes.
...
## Unit: nanoseconds
##                expr  min     lq     mean median   uq
##  triple.integer(2L)  394  625.5   689.16  664.0  701
##   triple.numeric(2)  326  618.0 30856.83  655.5  676
##          triple(2L) 1660 2305.5 33398.82 2378.0 2459
##      max neval
##     1327   100
##  3020283   100
##  3061677   100
