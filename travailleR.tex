...
##  f1(X)  30.397  34.1160  46.87934  35.907  37.8335  998.234
##  f2(X)  40.854  45.9355  60.60061  49.046  51.0680 1035.449
##  f3(X) 249.841 263.6675 295.61313 286.358 298.2515 1399.640
##  f4(X) 307.218 330.0935 366.14327 356.284 373.1280 1679.458
##  neval
##    100
##    100
##    100
...
##                                    expr   median
## 1                              sqrt(x1)   7.5705
## 2                lapply(x1, FUN = sqrt) 287.9715
## 3                sapply(x1, FUN = sqrt) 327.8300
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 288.5980
\end{verbatim}
...
\begin{verbatim}
##          expr   median
## 1  Boucle(x1) 642.3255
## 2 Boucle2(x1)  71.0485
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 vapply(x1, FUN = sqrt, 0) 278.5305
## 2                Boucle(x1)  70.5325
\end{verbatim}
...
\begin{verbatim}
##                                               expr   median
## 1                        vapply(x1, FUN = sqrt, 0)  285.258
## 2 for (i in 1:length(x1)) Racine[i] <- sqrt(x1[i]) 2204.890
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 replicate(1000, runif(1)) 2759.863
## 2               runif(1000)   17.106
\end{verbatim}
...
\begin{verbatim}
##                              expr   median
## 1   BoucleSomme(diamonds[-(2:4)]) 3.043849
## 2 apply(diamonds[-(2:4)], 2, sum) 7.673815
## 3       colSums(diamonds[-(2:4)]) 2.187419
\end{verbatim}
...
##  278.056 781.8485 771.9181 797.8845 808.712 1633.808   100
\end{verbatim}
...
Ce temps est à comparer à celui de la boucle for de référence, multiplié par 2500, soit \texttt{3900} secondes.
...
## ● built target NbPoints [1.506 seconds]
## ▶ start target X
## ● built target X [0.005 seconds]
## ▶ start target d
## ● built target d [0.016 seconds]
## ▶ start target map
## ● built target map [0.028 seconds]
## ▶ end pipeline [1.697 seconds]
\end{verbatim}
...
\begin{verbatim}
## ▶ start target NbPoints
## ● built target NbPoints [1.502 seconds]
## ▶ start target X
...
##  triple.integer(2L)  293  306.5   325.19  314.0  323.0
##   triple.numeric(2)  288  309.0 14549.69  319.5  329.0
##          triple(2L) 1062 1083.0 17722.45 1098.0 1185.5
##      max neval
##      620   100
##  1421887   100
##  1634874   100
