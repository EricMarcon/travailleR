...
##  f1(X)  35.610  37.2960  55.90065  38.268  39.997 1256.945   100
##  f2(X)  46.119  47.4580  61.98446  48.381  50.193 1248.262   100
##  f3(X) 268.348 270.5195 292.46117 271.316 275.781 1585.474   100
##  f4(X) 399.304 400.8760 421.99333 402.611 408.777 1903.107   100
\end{verbatim}
...
##                                    expr  median
## 1                              sqrt(x1)   4.521
## 2                lapply(x1, FUN = sqrt) 296.703
## 3                sapply(x1, FUN = sqrt) 352.769
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 295.545
\end{verbatim}
...
\begin{verbatim}
##          expr   median
## 1  Boucle(x1) 760.5495
## 2 Boucle2(x1)  78.5490
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 vapply(x1, FUN = sqrt, 0) 296.9030
## 2                Boucle(x1)  79.7745
\end{verbatim}
...
\begin{verbatim}
##                                               expr    median
## 1                        vapply(x1, FUN = sqrt, 0)  296.3765
## 2 for (i in 1:length(x1)) Racine[i] <- sqrt(x1[i]) 3116.6850
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 replicate(1000, runif(1)) 3767.149
## 2               runif(1000)   34.460
\end{verbatim}
...
\begin{verbatim}
##                              expr   median
## 1   BoucleSomme(diamonds[-(2:4)]) 3.096375
## 2 apply(diamonds[-(2:4)], 2, sum) 7.777131
## 3       colSums(diamonds[-(2:4)]) 2.399179
\end{verbatim}
...
La mise en place de la parallélisation a un coût d'environ \texttt{0.054} secondes ici.
...
## Unit: microseconds
##                                                      expr     min      lq
##  d <- TotalDistance(X$x, X$y)/NbPoints/(NbPoints - 1) * 2 666.294 673.864
##      mean   median      uq      max neval
##  850.6593 687.9105 874.176 2526.099   100
\end{verbatim}
...
Ce temps est à comparer à celui de la boucle for de référence, multiplié par 2500, soit \texttt{4597} secondes.
...
## Unit: nanoseconds
##                expr  min     lq     mean median     uq     max neval
##  triple.integer(2L)  308  322.5   363.80  332.5  355.5    1004   100
##   triple.numeric(2)  310  321.0 18184.39  332.0  352.0 1783411   100
##          triple(2L) 1294 1322.5 22673.46 1352.0 1419.5 2122752   100
\end{verbatim}
