...
##  f1(X)   2.173   8.2615  23.07890  11.8285  15.7440
##  f2(X)   5.084  10.1270  19.39669  13.5095  16.3180
##  f3(X) 103.935 109.5110 125.18571 114.6565 119.3100
##  f4(X) 135.423 144.7710 165.07174 149.4245 159.4285
##       max neval
##   994.947   100
##   543.865   100
##   869.036   100
...
##                                    expr   median
## 1                              sqrt(x1)   1.6605
## 2                lapply(x1, FUN = sqrt) 144.1970
## 3                sapply(x1, FUN = sqrt) 177.8170
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 140.8145
\end{verbatim}
...
\begin{verbatim}
##          expr   median
## 1  Boucle(x1) 376.4210
## 2 Boucle2(x1)  42.9065
\end{verbatim}
...
\begin{verbatim}
##                        expr  median
## 1 vapply(x1, FUN = sqrt, 0) 135.464
## 2                Boucle(x1)  43.050
\end{verbatim}
...
\begin{verbatim}
##                                               expr   median
## 1                        vapply(x1, FUN = sqrt, 0)  145.591
## 2 for (i in 1:length(x1)) Racine[i] <- sqrt(x1[i]) 1250.726
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 replicate(1000, runif(1)) 678.3655
## 2               runif(1000)   5.9040
\end{verbatim}
...
\begin{verbatim}
##                              expr   median
## 1   BoucleSomme(diamonds[-(2:4)]) 1640.923
## 2 apply(diamonds[-(2:4)], 2, sum) 3674.686
## 3       colSums(diamonds[-(2:4)]) 1280.676
\end{verbatim}
...
##  219.391 233.331 291.5461 249.444 250.51 4490.73   100
\end{verbatim}
...
Ce temps est à comparer à celui de la boucle for de référence, multiplié par 2500, soit \texttt{2034} secondes.
...
## ● completed target NbPoints [0.692 seconds]
## ▶ dispatched target X
## ● completed target X [0.003 seconds]
## ▶ dispatched target d
## ● completed target d [0.012 seconds]
## ▶ dispatched target map
## ● completed target map [0.017 seconds]
...
\begin{verbatim}
## ▶ dispatched target NbPoints
## ● completed target NbPoints [0.69 seconds]
## ▶ dispatched target X
...
##  triple.integer(2L)  82 123 6744.91    123 123 661617   100
##   triple.numeric(2)  82 123 9256.16    123 123 912496   100
##          triple(2L) 492 533  594.91    533 574   3649   100
\end{verbatim}
