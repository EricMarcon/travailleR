...
##  f1(X)   1.886   8.9585  27.12970  13.5915  19.9260 862.927
##  f2(X)   4.633  11.8900  24.99729  15.5595  20.8895 863.911
##  f3(X) 101.229 113.0985 126.77487 118.5515 125.1935 576.583
##  f4(X) 135.710 147.1695 164.66092 154.6315 160.9250 825.781
##  neval
##    100
##    100
##    100
...
##                                    expr  median
## 1                              sqrt(x1)   1.558
## 2                lapply(x1, FUN = sqrt) 142.065
## 3                sapply(x1, FUN = sqrt) 172.979
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 139.687
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 vapply(x1, FUN = sqrt, 0) 121.8725
## 2                Boucle(x1)  38.7450
\end{verbatim}
...
\begin{verbatim}
##                        expr  median
## 1 replicate(1000, runif(1)) 684.126
## 2               runif(1000)   5.904
\end{verbatim}
...
\begin{verbatim}
##                              expr   median
## 1   BoucleSomme(diamonds[-(2:4)]) 1670.648
## 2 apply(diamonds[-(2:4)], 2, sum) 3764.128
## 3       colSums(diamonds[-(2:4)]) 1285.473
\end{verbatim}
...
La mise en place de la parallélisation a un coût d'environ \texttt{0.058} secondes ici.
...
##  302.293 308.607 394.1515 312.8095 317.7295 6968.565   100
\end{verbatim}
...
Ce temps est à comparer à celui de la boucle for de référence, multiplié par 2500, soit \texttt{2210} secondes.
...
\begin{verbatim}
## ▶ dispatched target NbPoints
## ● completed target NbPoints [0.68 seconds, 53 bytes]
## ▶ dispatched target X
## ● completed target X [0.001 seconds, 11.058 kilobytes]
## ▶ dispatched target d
## ● completed target d [0.032 seconds, 55 bytes]
## ▶ dispatched target map
## ● completed target map [0.013 seconds, 187.39 kilobytes]
## ▶ ended pipeline [0.828 seconds]
\end{verbatim}
...
## Unit: nanoseconds
##                expr min  lq     mean median  uq     max
##  triple.integer(2L) 123 123  7366.47    164 164  721723
##   triple.numeric(2) 123 123 10217.20    164 164 1007042
##          triple(2L) 533 533   639.19    574 615    6109
##  neval
##    100
##    100
##    100
