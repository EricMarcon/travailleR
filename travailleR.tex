...
##  f1(X)  35.934  37.9345  59.74965  38.8685  42.6045
##  f2(X)  43.779  45.7405  69.64439  46.8660  49.6725
##  f3(X) 268.886 277.9420 327.32980 280.0910 293.6710
##  f4(X) 399.453 410.8260 505.50017 416.5305 453.7245
##       max neval
##  1586.488   100
##  1676.611   100
##  2645.673   100
...
##                                    expr   median
## 1                              sqrt(x1)   4.6270
## 2                lapply(x1, FUN = sqrt) 295.2340
## 3                sapply(x1, FUN = sqrt) 345.8210
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 305.7085
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 vapply(x1, FUN = sqrt, 0) 302.6375
## 2                Boucle(x1)  78.2480
\end{verbatim}
...
\begin{verbatim}
##                                               expr   median
## 1                        vapply(x1, FUN = sqrt, 0)  314.497
## 2 for (i in 1:length(x1)) Racine[i] <- sqrt(x1[i]) 3244.424
\end{verbatim}
...
\begin{verbatim}
##                        expr    median
## 1 replicate(1000, runif(1)) 4105.7575
## 2               runif(1000)   35.0075
\end{verbatim}
...
\begin{verbatim}
##                              expr   median
## 1   BoucleSomme(diamonds[-(2:4)]) 3.579442
## 2 apply(diamonds[-(2:4)], 2, sum) 9.182076
## 3       colSums(diamonds[-(2:4)]) 2.432539
\end{verbatim}
...
La mise en place de la parallélisation a un coût d'environ \texttt{0.079} secondes ici.
...
##  1.084734 1.151835 1.393225 1.24819 1.363841 2.786645   100
\end{verbatim}
...
Ce temps est à comparer à celui de la boucle for de référence, multiplié par 2500, soit \texttt{4592} secondes.
...
## Unit: nanoseconds
##                expr  min     lq     mean median     uq
##  triple.integer(2L)  318  326.0   373.04    338  373.5
##   triple.numeric(2)  316  329.5 18721.70    340  370.0
##          triple(2L) 1282 1318.0 22155.01   1336 1385.0
##      max neval
##     1121   100
##  1836189   100
##  2074275   100
