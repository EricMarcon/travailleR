...
##  f1(X)  36.321  38.3055  54.61705  39.0870  42.4180 1252.242   100
##  f2(X)  44.171  46.0145  63.56525  46.9195  49.4560 1229.711   100
##  f3(X) 275.336 276.9725 301.61694 278.0425 282.9725 1527.080   100
##  f4(X) 408.442 410.3040 436.20962 412.1590 418.3940 1855.526   100
\end{verbatim}
...
##                                    expr   median
## 1                              sqrt(x1)   4.6715
## 2                lapply(x1, FUN = sqrt) 292.9015
## 3                sapply(x1, FUN = sqrt) 350.3790
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 292.5905
\end{verbatim}
...
\begin{verbatim}
##          expr   median
## 1  Boucle(x1) 794.5715
## 2 Boucle2(x1)  79.6065
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 vapply(x1, FUN = sqrt, 0) 286.3035
## 2                Boucle(x1)  77.2370
\end{verbatim}
...
\begin{verbatim}
##                                               expr   median
## 1                        vapply(x1, FUN = sqrt, 0)  292.954
## 2 for (i in 1:length(x1)) Racine[i] <- sqrt(x1[i]) 3329.738
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 replicate(1000, runif(1)) 3785.722
## 2               runif(1000)   33.300
\end{verbatim}
...
\begin{verbatim}
##                              expr   median
## 1   BoucleSomme(diamonds[-(2:4)]) 3.620960
## 2 apply(diamonds[-(2:4)], 2, sum) 9.419663
## 3       colSums(diamonds[-(2:4)]) 2.462820
\end{verbatim}
...
## Unit: microseconds
##                                                      expr     min       lq
##  d <- TotalDistance(X$x, X$y)/NbPoints/(NbPoints - 1) * 2 651.371 671.0475
##      mean   median       uq      max neval
##  1585.924 1956.394 2010.073 8872.174   100
\end{verbatim}
...
Ce temps est à comparer à celui de la boucle for de référence, multiplié par 2500, soit \texttt{4854} secondes.
...
## Unit: nanoseconds
##                expr  min     lq     mean median     uq     max neval
##  triple.integer(2L)  334  353.0   404.91    390  410.5    1205   100
##   triple.numeric(2)  323  345.5 22060.88    381  405.5 2167463   100
##          triple(2L) 1349 1394.0 23745.32   1419 1464.5 2223631   100
\end{verbatim}
