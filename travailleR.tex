...
##  f1(X)  42.042  45.102  63.04498  47.974  52.8730 1405.779
##  f2(X)  50.121  53.138  74.63938  55.088  60.4700 1631.101
##  f3(X) 288.973 295.830 320.19837 300.596 310.2230 1771.748
##  f4(X) 424.002 435.929 460.05913 442.931 451.0385 1967.840
##  neval
##    100
##    100
##    100
...
##                                    expr   median
## 1                              sqrt(x1)   4.8390
## 2                lapply(x1, FUN = sqrt) 305.4335
## 3                sapply(x1, FUN = sqrt) 379.8555
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 299.9775
\end{verbatim}
...
\begin{verbatim}
##          expr   median
## 1  Boucle(x1) 895.9755
## 2 Boucle2(x1)  86.9790
\end{verbatim}
...
\begin{verbatim}
##                        expr  median
## 1 vapply(x1, FUN = sqrt, 0) 295.193
## 2                Boucle(x1)  86.478
\end{verbatim}
...
\begin{verbatim}
##                        expr    median
## 1 replicate(1000, runif(1)) 5602.6190
## 2               runif(1000)   24.5645
\end{verbatim}
...
\begin{verbatim}
##                              expr    median
## 1   BoucleSomme(diamonds[-(2:4)])  4.098076
## 2 apply(diamonds[-(2:4)], 2, sum) 17.388267
## 3       colSums(diamonds[-(2:4)])  2.827571
\end{verbatim}
...
La mise en place de la parallélisation a un coût d'environ \texttt{0.19} secondes ici.
...
##  2.054186 2.111125 2.182715 2.141266 2.184913 3.921465
##  neval
##    100
\end{verbatim}
...
Ce temps est à comparer à celui de la boucle for de référence, multiplié par 2500, soit \texttt{8962} secondes.
...
## ● built target NbPoints [3.633 seconds]
## ▶ start target X
## ● built target X [0.004 seconds]
## ▶ start target d
## ● built target d [0.025 seconds]
## ▶ start target map
## ● built target map [0.036 seconds]
## ▶ end pipeline [3.932 seconds]
\end{verbatim}
...
\begin{verbatim}
## ▶ start target NbPoints
## ● built target NbPoints [2.975 seconds]
## ▶ start target X
## ● built target X [0.004 seconds]
## ▶ start target d
...
##  triple.integer(2L)  330  341.5 24889.51  350.5  386.5
##   triple.numeric(2)  326  335.0 21340.31  350.5  385.0
##          triple(2L) 1389 1429.5  1893.60 1453.5 1525.0
##      max neval
##  2445305   100
##  2095892   100
##    25744   100
