...
##  f1(X)  34.753  36.7830  56.39001  38.1765  40.4765
##  f2(X)  41.389  44.1200  60.26348  45.6370  48.3600
##  f3(X) 275.225 278.3160 309.35428 284.7490 294.4340
##  f4(X) 409.626 414.7945 442.94478 420.4520 433.8900
##       max neval
##  1211.460   100
##  1254.915   100
##  1516.828   100
...
##                                    expr   median
## 1                              sqrt(x1)   4.8060
## 2                lapply(x1, FUN = sqrt) 306.5725
## 3                sapply(x1, FUN = sqrt) 351.8685
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 311.2705
\end{verbatim}
...
\begin{verbatim}
##          expr   median
## 1  Boucle(x1) 867.0265
## 2 Boucle2(x1)  80.3835
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 vapply(x1, FUN = sqrt, 0) 294.9220
## 2                Boucle(x1)  77.4245
\end{verbatim}
...
\begin{verbatim}
##                                               expr   median
## 1                        vapply(x1, FUN = sqrt, 0)  309.435
## 2 for (i in 1:length(x1)) Racine[i] <- sqrt(x1[i]) 3339.074
\end{verbatim}
...
\begin{verbatim}
##                        expr    median
## 1 replicate(1000, runif(1)) 4164.8180
## 2               runif(1000)   34.2095
\end{verbatim}
...
\begin{verbatim}
##                              expr   median
## 1   BoucleSomme(diamonds[-(2:4)]) 3.638139
## 2 apply(diamonds[-(2:4)], 2, sum) 9.673288
## 3       colSums(diamonds[-(2:4)]) 2.546464
\end{verbatim}
...
##  742.33 749.2215 794.6553 757.213 778.3335 2318.581   100
\end{verbatim}
...
Ce temps est à comparer à celui de la boucle for de référence, multiplié par 2500, soit \texttt{4324} secondes.
...
## Unit: nanoseconds
##                expr  min     lq     mean median     uq
##  triple.integer(2L)  310  322.5   371.98  335.5  366.0
##   triple.numeric(2)  314  327.5 18101.28  341.0  362.5
##          triple(2L) 1273 1318.0 21593.16 1346.0 1403.0
##      max neval
##      981   100
##  1762700   100
##  2016029   100
