...
##  f1(X)  36.052  38.0665  52.30807  38.6625  40.1445
##  f2(X)  43.844  45.5410  59.96853  46.3730  47.7250
##  f3(X) 274.234 276.2820 292.87469 277.4575 281.7165
##  f4(X) 407.457 409.3040 434.47894 411.3795 417.2255
##       max neval
##  1284.904   100
##  1337.716   100
##  1585.436   100
...
##                                    expr   median
## 1                              sqrt(x1)   4.5725
## 2                lapply(x1, FUN = sqrt) 289.3095
## 3                sapply(x1, FUN = sqrt) 343.7540
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 302.2675
\end{verbatim}
...
\begin{verbatim}
##          expr   median
## 1  Boucle(x1) 866.2205
## 2 Boucle2(x1)  79.5055
\end{verbatim}
...
\begin{verbatim}
##                        expr  median
## 1 vapply(x1, FUN = sqrt, 0) 303.573
## 2                Boucle(x1)  78.902
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 replicate(1000, runif(1)) 4334.816
## 2               runif(1000)   35.593
\end{verbatim}
...
\begin{verbatim}
##                              expr   median
## 1   BoucleSomme(diamonds[-(2:4)]) 3.866382
## 2 apply(diamonds[-(2:4)], 2, sum) 9.699490
## 3       colSums(diamonds[-(2:4)]) 2.566546
\end{verbatim}
...
##  1.15823 1.299616 1.890759 1.498897 2.141954 12.73012   100
\end{verbatim}
...
Ce temps est à comparer à celui de la boucle for de référence, multiplié par 2500, soit \texttt{4609} secondes.
...
## Unit: nanoseconds
##                expr  min     lq     mean median     uq
##  triple.integer(2L)  319  327.5   376.03  338.0  369.5
##   triple.numeric(2)  316  329.0 19156.63  336.5  357.5
##          triple(2L) 1329 1374.0 23347.25 1396.0 1436.0
##      max neval
##     1243   100
##  1880043   100
##  2186860   100
