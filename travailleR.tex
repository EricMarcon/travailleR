...
##  f1(X)  27.743  28.8385  38.98033  29.7045  30.7405
##  f2(X)  38.945  39.9965  49.53838  40.4980  41.5150
##  f3(X) 239.584 245.6185 256.12842 246.2060 247.2460
##  f4(X) 297.520 314.6235 326.89111 315.3775 316.8890
##       max neval
##   854.948   100
##   845.380   100
##  1076.143   100
...
##                                    expr   median
## 1                              sqrt(x1)   7.3645
## 2                lapply(x1, FUN = sqrt) 275.2160
## 3                sapply(x1, FUN = sqrt) 324.7095
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 287.0285
\end{verbatim}
...
\begin{verbatim}
##          expr   median
## 1  Boucle(x1) 629.9540
## 2 Boucle2(x1)  70.3995
\end{verbatim}
...
\begin{verbatim}
##                        expr  median
## 1 vapply(x1, FUN = sqrt, 0) 279.859
## 2                Boucle(x1)  70.423
\end{verbatim}
...
\begin{verbatim}
##                        expr    median
## 1 replicate(1000, runif(1)) 2703.0155
## 2               runif(1000)   16.9715
\end{verbatim}
...
\begin{verbatim}
##                              expr   median
## 1   BoucleSomme(diamonds[-(2:4)]) 2.873696
## 2 apply(diamonds[-(2:4)], 2, sum) 7.235010
## 3       colSums(diamonds[-(2:4)]) 2.045317
\end{verbatim}
...
##  460.426 793.8415 808.4153 795.47 799.504 1609.973   100
\end{verbatim}
...
Ce temps est à comparer à celui de la boucle for de référence, multiplié par 2500, soit \texttt{3609} secondes.
...
## ● completed target NbPoints [1.338 seconds]
## ▶ dispatched target X
## ● completed target X [0.002 seconds]
## ▶ dispatched target d
## ● completed target d [0.014 seconds]
## ▶ dispatched target map
## ● completed target map [0.03 seconds]
## ▶ ended pipeline [1.551 seconds]
\end{verbatim}
...
\NormalTok{kableExtra}\SpecialCharTok{::}\FunctionTok{kbl}\NormalTok{(mes\_iris, }\AttributeTok{caption =} \StringTok{"Tableau créé par kable"}\NormalTok{,}
...
\begin{verbatim}
## ▶ dispatched target NbPoints
## ● completed target NbPoints [1.295 seconds]
## ▶ dispatched target X
## ● completed target X [0.002 seconds]
## ▶ dispatched target d
## ● completed target d [0.015 seconds]
## ▶ dispatched target map
## ● completed target map [0.028 seconds]
## ▶ ended pipeline [1.503 seconds]
\end{verbatim}
...
## Unit: nanoseconds
##                expr  min     lq     mean median     uq
##  triple.integer(2L)  293  302.0 14694.17  309.0  318.5
##   triple.numeric(2)  293  309.5 16504.40  320.5  328.0
##          triple(2L) 1056 1076.5  1149.26 1087.5 1134.0
##      max neval
##  1437416   100
##  1618157   100
##     4557   100
