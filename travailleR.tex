...
##  f1(X)  43.690  46.3120  69.58079  48.7575  55.0755
##  f2(X)  50.850  54.4105  75.10515  56.7350  65.2605
##  f3(X) 281.189 285.5180 315.12981 296.9235 307.5675
##  f4(X) 414.164 422.5040 460.92277 434.0615 451.4390
##       max neval
##  1626.157   100
##  1393.425   100
##  1605.524   100
...
##                                    expr   median
## 1                              sqrt(x1)   4.8840
## 2                lapply(x1, FUN = sqrt) 315.6435
## 3                sapply(x1, FUN = sqrt) 376.4515
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 305.7650
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 vapply(x1, FUN = sqrt, 0) 287.7855
## 2                Boucle(x1)  73.8980
\end{verbatim}
...
\begin{verbatim}
##                                               expr   median
## 1                        vapply(x1, FUN = sqrt, 0)  311.849
## 2 for (i in 1:length(x1)) Racine[i] <- sqrt(x1[i]) 3703.711
\end{verbatim}
...
\begin{verbatim}
##                        expr    median
## 1 replicate(1000, runif(1)) 3193.1290
## 2               runif(1000)   33.9465
\end{verbatim}
...
\begin{verbatim}
##                              expr    median
## 1   BoucleSomme(diamonds[-(2:4)])  3.970376
## 2 apply(diamonds[-(2:4)], 2, sum) 10.562131
## 3       colSums(diamonds[-(2:4)])  2.766328
\end{verbatim}
...
##  788.056 846.0815 905.3077 867.3725 892.2035 2618.973   100
\end{verbatim}
...
Ce temps est à comparer à celui de la boucle for de référence, multiplié par 2500, soit \texttt{5174} secondes.
...
Appliquer la procédure de la section \ref{sec:secrets-ci} pour créer un secret nommé \enquote{RSA} et coller le contenu du fichier \texttt{NomDuProjet.rsa} dans le champ \enquote{Value} du formulaire.
...
## Unit: nanoseconds
##                expr  min     lq     mean median     uq
##  triple.integer(2L)  336  344.5 27153.64  353.0  372.0
##   triple.numeric(2)  331  345.0 22799.39  364.0  384.5
##          triple(2L) 1359 1384.5  1560.35 1412.5 1496.5
##      max neval
##  2678418   100
##  2241833   100
##     7025   100
