...
##  f1(X)  35.858  38.2940  54.74420  39.400  44.2860 1329.491   100
##  f2(X)  45.624  48.7805  69.42876  50.558  56.0085 1307.653   100
##  f3(X) 268.500 271.4220 312.02837 275.178 295.4100 1653.269   100
##  f4(X) 398.934 402.2990 460.80187 406.483 445.5180 2104.042   100
\end{verbatim}
...
##                                    expr   median
## 1                              sqrt(x1)   4.7015
## 2                lapply(x1, FUN = sqrt) 302.3760
## 3                sapply(x1, FUN = sqrt) 358.5325
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 303.5100
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 vapply(x1, FUN = sqrt, 0) 310.7590
## 2                Boucle(x1)  82.8965
\end{verbatim}
...
\begin{verbatim}
##                                               expr    median
## 1                        vapply(x1, FUN = sqrt, 0)  302.2225
## 2 for (i in 1:length(x1)) Racine[i] <- sqrt(x1[i]) 3363.6365
\end{verbatim}
...
\begin{verbatim}
##                        expr    median
## 1 replicate(1000, runif(1)) 2745.9415
## 2               runif(1000)   34.0015
\end{verbatim}
...
\begin{verbatim}
##                              expr   median
## 1   BoucleSomme(diamonds[-(2:4)]) 3.308415
## 2 apply(diamonds[-(2:4)], 2, sum) 8.116986
## 3       colSums(diamonds[-(2:4)]) 2.542559
\end{verbatim}
...
La mise en place de la parallélisation a un coût d'environ \texttt{0.03} secondes ici.
...
## Unit: microseconds
##                                                      expr     min      lq
##  d <- TotalDistance(X$x, X$y)/NbPoints/(NbPoints - 1) * 2 666.838 672.769
##      mean  median       uq      max neval
##  1268.874 721.762 1949.113 5867.867   100
\end{verbatim}
...
Ce temps est à comparer à celui de la boucle for de référence, multiplié par 2500, soit \texttt{4487} secondes.
...
## Unit: nanoseconds
##                expr  min     lq     mean median   uq     max neval
##  triple.integer(2L)  313  318.5   363.18    330  368     971   100
##   triple.numeric(2)  310  323.0 21946.64    329  362 2159447   100
##          triple(2L) 1368 1383.5 23792.38   1409 1450 2230427   100
\end{verbatim}
