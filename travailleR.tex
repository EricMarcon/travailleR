...
\usepackage{fontspec}
% Main font
\setmainfont[Extension=.otf,UprightFont=*-regular,BoldFont=*-bold,BoldItalicFont=*-bolditalic]{texgyretermes}
...
##  f1(X)  36.206  38.2215  54.64782  39.3525  42.5585
##  f2(X)  44.031  45.8435  67.64459  46.8940  48.9510
##  f3(X) 275.845 277.8090 302.41424 280.2305 293.5675
##  f4(X) 409.330 410.6775 438.23556 413.0420 423.3025
##       max neval
##  1365.942   100
##  1346.689   100
##  1578.011   100
...
##                                    expr  median
## 1                              sqrt(x1)   4.728
## 2                lapply(x1, FUN = sqrt) 298.345
## 3                sapply(x1, FUN = sqrt) 363.686
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 304.236
\end{verbatim}
...
\begin{verbatim}
##          expr   median
## 1  Boucle(x1) 805.2975
## 2 Boucle2(x1)  78.1715
\end{verbatim}
...
\begin{verbatim}
##                        expr  median
## 1 vapply(x1, FUN = sqrt, 0) 296.421
## 2                Boucle(x1)  78.142
\end{verbatim}
...
\begin{verbatim}
##                                               expr   median
## 1                        vapply(x1, FUN = sqrt, 0)  297.705
## 2 for (i in 1:length(x1)) Racine[i] <- sqrt(x1[i]) 3373.035
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 replicate(1000, runif(1)) 4075.701
## 2               runif(1000)   33.863
\end{verbatim}
...
\begin{verbatim}
##                              expr   median
## 1   BoucleSomme(diamonds[-(2:4)]) 3.661493
## 2 apply(diamonds[-(2:4)], 2, sum) 9.348074
## 3       colSums(diamonds[-(2:4)]) 2.516616
\end{verbatim}
...
La mise en place de la parallélisation a un coût d'environ \texttt{0.083} secondes ici.
...
##  774.929 789.722 846.0242 804.05 825.611 2603.508   100
\end{verbatim}
...
Ce temps est à comparer à celui de la boucle for de référence, multiplié par 2500, soit \texttt{4870} secondes.
...
\begin{center}\includegraphics[width=0.8\linewidth]{travailleR_files/figure-latex/unnamed-chunk-76-1} \end{center}
...
## Unit: nanoseconds
##                expr  min     lq     mean median   uq
##  triple.integer(2L)  319  325.0 23724.13    335  349
##   triple.numeric(2)  317  324.5 20639.85    336  352
##          triple(2L) 1295 1321.0  1461.52   1331 1384
##      max neval
##  2337718   100
##  2028906   100
##     6510   100
...
\begin{center}\includegraphics[width=0.8\linewidth]{travailleR_files/figure-latex/unnamed-chunk-108-1} \end{center}
...
\begin{center}\includegraphics[width=0.8\linewidth]{travailleR_files/figure-latex/unnamed-chunk-108-2} \end{center}
