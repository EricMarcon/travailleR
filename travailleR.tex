...
##  f1(X)  37.248  38.6330  53.45040  39.8170  41.409 1227.162
##  f2(X)  45.409  46.4585  61.77604  47.1475  50.986 1187.792
##  f3(X) 275.286 276.8925 297.10776 278.5690 284.253 1440.150
##  f4(X) 407.522 409.6520 429.22055 410.8725 416.625 1803.084
##  neval
##    100
##    100
##    100
...
##                                    expr   median
## 1                              sqrt(x1)   4.8550
## 2                lapply(x1, FUN = sqrt) 304.9520
## 3                sapply(x1, FUN = sqrt) 358.6900
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 307.9855
\end{verbatim}
...
\begin{verbatim}
##          expr   median
## 1  Boucle(x1) 835.6205
## 2 Boucle2(x1)  79.3305
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 vapply(x1, FUN = sqrt, 0) 299.9750
## 2                Boucle(x1)  78.1645
\end{verbatim}
...
\begin{verbatim}
##                                               expr   median
## 1                        vapply(x1, FUN = sqrt, 0)  304.298
## 2 for (i in 1:length(x1)) Racine[i] <- sqrt(x1[i]) 3205.122
\end{verbatim}
...
\begin{verbatim}
##                        expr    median
## 1 replicate(1000, runif(1)) 4182.8890
## 2               runif(1000)   32.6605
\end{verbatim}
...
\begin{verbatim}
##                              expr   median
## 1   BoucleSomme(diamonds[-(2:4)]) 3.616883
## 2 apply(diamonds[-(2:4)], 2, sum) 9.228221
## 3       colSums(diamonds[-(2:4)]) 2.420815
\end{verbatim}
...
La mise en place de la parallélisation a un coût d'environ \texttt{0.011} secondes ici.
...
##  2.088087 2.149492 2.979104 2.209188 2.362252 44.5001   100
\end{verbatim}
...
Ce temps est à comparer à celui de la boucle for de référence, multiplié par 2500, soit \texttt{4680} secondes.
...
##  triple.integer(2L)  320  327.0 26051.84  338.0  397
##   triple.numeric(2)  318  325.0 20615.77  340.5  401
##          triple(2L) 1337 1361.5  1512.40 1379.0 1419
##      max neval
##  2569051   100
##  2024308   100
##     7307   100
