...
La mise en place de la parallélisation a un coût de l'ordre du temps de calcul au-delà du quart de seconde attendu: environ \texttt{0.11} secondes ici.
...
La performance reste très inférieure à celle d'une simple boucle for.
...
Ce temps est à comparer à celui de la boucle for de référence, multiplié par 2500, soit \texttt{4554} secondes.
