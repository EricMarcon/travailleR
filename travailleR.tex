...
##  f1(X)  40.487  42.8680  57.45628  43.7645  45.3825
##  f2(X)  48.761  50.4045  67.30099  51.5625  53.5780
##  f3(X) 277.214 283.2680 301.50265 284.5800 289.6905
##  f4(X) 403.229 414.4580 433.07611 415.9845 420.3635
##       max neval
##  1305.940   100
##  1423.930   100
##  1711.957   100
...
##                                    expr  median
## 1                              sqrt(x1)   4.623
## 2                lapply(x1, FUN = sqrt) 299.600
## 3                sapply(x1, FUN = sqrt) 352.261
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 301.039
\end{verbatim}
...
\begin{verbatim}
##          expr   median
## 1  Boucle(x1) 812.0060
## 2 Boucle2(x1)  78.9485
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 vapply(x1, FUN = sqrt, 0) 294.3375
## 2                Boucle(x1)  76.3565
\end{verbatim}
...
\begin{verbatim}
##                        expr    median
## 1 replicate(1000, runif(1)) 2880.0805
## 2               runif(1000)   32.2365
\end{verbatim}
...
\begin{verbatim}
##                              expr   median
## 1   BoucleSomme(diamonds[-(2:4)]) 3.728036
## 2 apply(diamonds[-(2:4)], 2, sum) 9.672621
## 3       colSums(diamonds[-(2:4)]) 2.602394
\end{verbatim}
...
La mise en place de la parallélisation a un coût d'environ \texttt{0.018} secondes ici.
...
##  1.014941 2.103101 3.094128 2.359673 2.738062 43.70594
##  neval
##    100
\end{verbatim}
...
Ce temps est à comparer à celui de la boucle for de référence, multiplié par 2500, soit \texttt{5462} secondes.
...
## Unit: nanoseconds
##                expr  min     lq      mean median     uq
##  triple.integer(2L)  319  326.0  25925.74  339.5  361.0
##   triple.numeric(2)  319  328.5 176648.37  342.0  356.5
##          triple(2L) 1307 1348.0   1749.26 1364.5 1450.5
##       max neval
##   2528102   100
##  17628588   100
##     15149   100
