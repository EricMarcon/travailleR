...
La clé privée `NomDuProjet.rsa` ne doit être diffusée qu'aux ayant-droits du projet.
...
Appliquer la procédure de la section \@ref(sec:secrets-ci) pour créer un secret nommé "RSA" et coller le contenu du fichier `NomDuProjet.rsa` dans le champ "Value" du formulaire.
