...
Le fichier peut être placé dans le dossier `docs` pour fournir à fois la page d'accueil du dépôt et de son site web ou bien dupliqué par le script `GitHubPages.R` dans les projets de documents.
