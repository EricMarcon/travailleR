...
Un dépôt contenant un mémo écrit en RMarkdown (voir section \@ref(sec:memo)) est utilisé comme exemple [^306].
...
Le site web est accessible à une adresse du domaine *github.io* [^307].
