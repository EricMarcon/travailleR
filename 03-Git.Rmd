...
Cliquer sur le bouton violet à côté de "master": une fenêtre (habituellement utilisée pour la création d'une nouvelle branche, voir section \@ref(sec:branches)).
