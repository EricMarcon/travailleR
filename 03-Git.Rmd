...
L'adresse du fichier image correspond à la position dans le cycle de vie: il suffit de copier l'adresse de l'image du badge désiré sur le site du Tidyverse pour l'obtenir.
