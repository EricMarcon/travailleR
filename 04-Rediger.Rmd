...
### Modèle memo {#sec:memo}

Le modèle mémo produit un document HTML simple avec une table des matières flottante (voir l'exemple [^430]).
...
Sélectionner le modèle Mémo du package **EcoFoG**.
...
La construction du site web en production peut être confiée à Travis-CI (chapitre \@ref(sec:blogdown-ci)).
