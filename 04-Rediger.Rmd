...
Le package ne permet pas de tricot HTML parce qu'il utilise la syntaxe LaTeX dans le document RMarkdown au lieu d'utiliser **bookdown** pour gérer les références bibliographique et les références croisées.
...
Un billet est placé dans un dossier (`/content/fr/post/`\break`densite`) qui contient son code Rmarkdown et éventuellement des images, des données pour alimenter le code et d'autres éléments appelés par le code.
