...
Une formation rapide et complète est proposée par RStudio[^402].
...
knitr::kable(head(iris), caption="Tableau créé par R", longtable = TRUE, booktabs = TRUE, escape = FALSE) %>%
...
Plus d'un millier de styles sont disponibles [^41].

[^41]: <https://github.com/citation-style-language/styles>
