...
knitr::kable(head(iris), caption="Tableau créé par kable", booktabs = TRUE, escape = FALSE) %>%
...
datasets::iris %>%
  ...
  flextable %>%
  # Légende
  set_caption("Tableau créé par flextable")
  # Titre des colonnes
...
Il ne supporte pas les légendes courtes.
