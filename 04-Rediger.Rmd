...
Les équations sont écrites au format LaTeX[^450].

[^450]: https://fr.wikibooks.org/wiki/LaTeX/%C3%89crire_des_math%C3%A9matiques
...
[^425]: https://rstudio.github.io/learnr/ par exemple.
...
Chaque changement de version peut nécessiter des adaptations du contenu du site, référencées dans la documentation en ligne du thème[^428].

[^428]: https://wowchemy.com/updates/
...
Le package **ragg**[^460] améliore la qualité des fichiers PNG, JPEG et TIFF.
Les fonctions optimisées sont `agg_png()`, `agg_jpeg()`et `agg_tiff()`.
Leur usage est le même que celui des fonctions de **grDevices**.

[^460]: https://ragg.r-lib.org/
