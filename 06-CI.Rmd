...
Les étapes `Install dependencies` et `Check` utilisent `Rscript` comme environnement de commande, ce qui leur permet d'exécuter directement des commandes R (à comparer à l'utilisation de `R -e` dans les exemples précédents).
