...
notifications:
  email:
    recipients:
      - adresse@domaine.com
```
Le comportement par défaut est d'envoyer un message au propriétaire du compte GitHub seulement quand le statut change: en cas d'échec d'un script qui fonctionnait ou inversement.
