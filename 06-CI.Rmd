...
## Principes {#sec:principes-ci}

### Objectifs {#sec:objectifs-ci}
...
Tous les packages utilisés dans les fichiers RMarkdown du site doivent être déclarés dans le fichier `DESCRIPTION`.
...
Exemple: la page qui affiche la bibliométrie du site web [^605] de l'auteur interroge Google Scholar pour afficher les citations des publications.
