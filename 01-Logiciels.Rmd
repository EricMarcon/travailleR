...
Elle se trouve dans un sous-répertoire du programme d'installation (`C:\Program Files\R\R-4.0.0\`\break`library` pour R version 4.0.0 sous Windows 10).
...
Le bouton *Update* dans la fente *Packages* de RStudio permet de mettre à jour tous les packages installés.
