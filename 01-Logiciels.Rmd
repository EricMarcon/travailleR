...
Télécharger le fichier zip et coller tout le contenu du dossier `bin` dans le dossier `bin` de `Rtools` (`C:\Rtools40\usr\bin` pour la version 4.0).
...
Copier ensuite le contenu du dossier `bin` dans le dossier `bin` de `Rtools`.
