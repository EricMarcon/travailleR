...
Packages <- c("compiler", "doParallel", "entropart", "foreach", "gridExtra", "htmlwidgets", "magrittr", "microbenchmark", "parallel", "profvis", "pryr", "ragg", "R6", "Rcpp", "RcppParallel", "spatstat", "testthat", "tidyverse")
