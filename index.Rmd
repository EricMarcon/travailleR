...
Le chapitres 5 montre comment rédiger des documents simples (mémos) ou complexes (ouvrages) avec RMarkdown, intégrant les données, le code pour les traiter et le texte pour les présenter. Le chapitre 6 présente une méthode pas à pas pour créer efficacement un package. Enfin, le chapitre 7 introduit l'utilisation de l'intégration continue pour produire automatiquement des documents, vérifier le code des packages et produire leurs vignettes. 
