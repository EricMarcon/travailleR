...
Packages <- c("compiler", "dbmss", "doParallel", "entropart", "foreach", "gridExtra", "htmlwidgets", "magrittr", "microbenchmark", "parallel", "profvis", "pryr", "ragg", "R6", "Rcpp", "RcppParallel", "spatstat", "targets", "testthat", "tidyverse", "usethis", "visNetwork")
