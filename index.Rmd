...
Packages <- c("tidyverse", "magrittr", "gridExtra", "testthat", "microbenchmark", "profvis", "htmlwidgets", "parallel", "foreach", "doParallel", "spatstat", "entropart", "compiler", "Rcpp", "RcppParallel")
